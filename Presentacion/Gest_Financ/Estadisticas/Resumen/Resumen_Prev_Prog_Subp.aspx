<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Resumen_Prev_Prog_Subp.aspx.vb" Inherits="Presentacion.Resumen_Prev_Prog_Subp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <script>
        ...
        function Ajax_LugarTM() {
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp.aspx/Llenar_Ddl_LugarTM",
        ...
        function Ajax_Preve() {
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp.aspx/Llenar_Ddl_Prevision",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    let json_receiver = response.d;
        ...
        function Ajax_Progra() {
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp.aspx/Llenar_Ddl_Programa",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    let json_receiver = response.d;
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "success": function (response) {
                    let json_receiver = response.d;
        ...
        function Fill_DataTable() {
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                $("#DataTable tbody").append(
                    $("<tr>", {
                        "onclick": `Ajax_ONCLICK("` + Mx_Dtt[i].ID_PROCEDENCIA + `","` + Mx_Dtt[i].ID_PREVE + `","` + Mx_Dtt[i].ID_PROGRA + `",)`,
                        "class": "manito"
                    }).append(
        ...
        function Ajax_ONCLICK(_PROC, _PREV, _PROG) {
            ...
            window.open(loc + "/Gest_Financ/Estadisticas/Detalle/Det_Proc_Prev_Prog.aspx?D=" + $("#fecha").val() + "&H=" + $("#fecha2").val() + "&P1=" + _PROC + "&P2=" + _PREV + "&P3=" + _PROG);
        }
        ...
        function do_chart() {
            ...
            Highcharts.chart('graph', {
                ...
                title: {
                    text: 'Valorización Procedencia-Previsión-Programa'
                },
                series: [{
                    type: "sunburst",
                    data: data,
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp.aspx/PDFF",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
