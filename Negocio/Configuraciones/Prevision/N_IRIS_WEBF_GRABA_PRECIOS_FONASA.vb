...
Public Class N_IRIS_WEBF_GRABA_PRECIOS_FONASA
    ...
    Function IRIS_WEBF_GRABA_PRECIOS_FONASA_BONIFICACION(ByVal ID_PREVI As Integer, ByVal ID_CF As Integer, ByVal ID_ANO As Integer, ByVal ID_USUARO As Integer, ByVal V_AMB As Integer, ByVal BONIFICACION As Integer) As Integer
        Return DD_Data.IRIS_WEBF_CMVM_GRABA_PRECIOS_FONASA_BONIFICACION(ID_PREVI, ID_CF, ID_ANO, ID_USUARO, V_AMB, BONIFICACION)
