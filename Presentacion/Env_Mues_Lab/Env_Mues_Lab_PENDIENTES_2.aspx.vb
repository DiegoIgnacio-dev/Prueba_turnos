        ...
        If selected.Length > 0 Then
            For i = 0 To selected.Length - 1
                If selected(i).length > 2 Then
                    ...
                    Data_Register = NN_ExamenDet.IRIS_WEBF_CMVM_GRABA_REGISTRO_PENDIENTES(ID_USER, elemento(0), elemento(1), elemento(2), elemento(5), elemento(6), Date.Now, USU_ID_PROC)
