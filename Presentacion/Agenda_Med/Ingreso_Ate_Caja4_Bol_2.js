...
objAJAX_Proc.success = (resp) => {
    ...
    let str_Error = `La impresión de Voucher se ha completado exitosamente. `;
...
function HOLAAAAAAAAAAA() {
    ...
    $(`.td_valorapagar`).each(function () {
        ...
        if (tipo == 1 || tipo == "1" || tipo == 20 || tipo == "20" || tipo == 2 || tipo == "2") {
...
function ddl_Change_onTable(index, idcodfona, idtppago) {
    ...
    if (Mx_Dtt_examcof.length == 0) {
        ...
        } else if (fuck2 == 1 || fuck2 == 20 || fuck2 == 2) {                                                             //CAMBIAMOS VALORES POR EFECTIVO O PARTICULAR
            var findet = 0;
            for (i = 0; i < Mx_Dtt_examcof.length; i++) {
...
$(document).ready(function () {
    //$("#btnInstructivos").html("<p style='font-size:16px;'>Instructivos </p>");

    $("#btnInstructivos").click(() => {
        window.open("http://www.laboratorioaleman.cl/examenesprestaciones/examenes/indicaciones/", '_blank');
    });

    $("#btnguardar_revisa").click(() => {
        Ajax_guardar();
    });

    $("#chkRevisa2").prop("checked") == false;



    $("#chkRevisa2").change(() => {
        console.log("change check !!!");
        if ($("#chkRevisa2").prop("checked") == true) {
            $('#btnguardar_revisa').removeAttr("disabled");
        } else {
            $('#btnguardar_revisa').attr("disabled", "disabled");
        }
    });
    ...
    $("input[name=inlineMaterialRadiosExample]").change(function () {
        ...
        if (Mx_Dtt_examcof.length == 0) {
            ...
            for (i = 0; i < Mx_Dtt_examcof.length; i++) {
                if (Mx_Dtt_examcof[i]["ATE_DET_TP_1"] == undefined || Mx_Dtt_examcof[i]["CF_TP_PAGO"] == 0) {
                    Mx_Dtt_examcof[i]["ATE_DET_TP_1"] = $("input[name=inlineMaterialRadiosExample]:checked").val();
                } else {
                    Mx_Dtt_examcof[i].CF_TP_PAGO = $("input[name=inlineMaterialRadiosExample]:checked").val();
                    Mx_Dtt_examcof[i].ATE_DET_TP_1 = $("input[name=inlineMaterialRadiosExample]:checked").val();
            ...
            } else if (fuck == 1 || fuck == 20 || fuck == 2) {                                                             //CAMBIAMOS VALORES POR EFECTO O PARTICULAR
                for (i = 0; i < Mx_Dtt_examcof.length; i++) {
                    for (x = 0; x < Mx_Dtt_exam02_Particular.length; x++) {
            ...
            } else if (fuck == 18 || fuck == 5 || fuck == 19 || fuck == 6) {
                for (i = 0; i < Mx_Dtt_examcof.length; i++) {
    ...
    $("#button_modal_pagoNuevoSeleccion").click(function () {
        var sum = 0;
        ...
        if (sum == 10) {
            ...
            //Ajax_guardar();
            $("#Lbl_revisa_copa").val($("#Lbl_tot_copa_fonasa").val());
            $("#Lbl_revisa_parti").val($("#Lbl_tot_copa_particular").val());
            $("#Lbl_revisa_total").val($("#Lbl_tot_a_pagar").val());
...
function Ajax_guardar() {
    ...
    for (x = 0; x < Mx_Dtt_examcof.length; x++) {
        ...
        var objId = {
            ...
            "ID_DET_PREVE": Mx_Dtt_examcof[x].ID_DET_PREVE,                                         //7
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol_2.aspx/Guardar_TodoByVal",
        //"url": "Ingreso_Ate_Caja4_Bol_2.aspx/TEST_GUARDAR",  
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
            ...
            if (json_receiver != null) {
                ...
                //---------------- AQUI ------------
                if (Mx_Dt023.Boleta != 0) {
                    var loc = location.origin;
                    window.open(loc + "/B_Elect/Boleta_Electronica.aspx?AN=" + Mx_Dt023.Boleta, '_blank');
                } else {
...
function Ajax_DataTable_examen02() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol_2.aspx/Llenar_tabla_exam2",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen02_Particular() {
    ...
    var Data_Par = JSON.stringify({
        "ID_PREVE": 69,//$("#Prevision").val(),
        "Fecha": f
    });

    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol_2.aspx/Llenar_tabla_exam2_particular",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3_preve(xxid_preve, select_id_3, xx_pos_table, xx_tp_pagoxcs) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol_2.aspx/Llenar_tabla_exam2_ID_CF",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3_tp_pago(xxid_index, pos_02, valor_02) {
    for (i = 0; i < Mx_Dtt_examcof.length; i++) {
        if (Mx_Dtt_examcof[i].ID_CODIGO_FONASA == xxid_index) {
            ...
            Mx_Dtt_examcof[i].ATE_DET_TP_1 = valor_02;
            if (valor_02 == 3 || valor_02 == 4) {
                ...
                if (valor_02 == 20 || valor_02 == 1 || valor_02 == 2) {                                          //ASIGNAR PRECIO EFECTIVO O/Y PARTICULAR, TRANSFERENCIA
                    //Ajax_DataTable_examen02_Particular();
    ...
    for (aa = 0; aa < Mx_Dtt_examcof.length; aa++) {
        ...
        if (Mx_Dtt_examcof[aa].ATE_DET_TP_1 == 18 || Mx_Dtt_examcof[aa].ATE_DET_TP_1 == 5 || Mx_Dtt_examcof[aa].ATE_DET_TP_1 == 19 || Mx_Dtt_examcof[aa].ATE_DET_TP_1 == 3 || Mx_Dtt_examcof[aa].ATE_DET_TP_1 == 11 || Mx_Dtt_examcof[aa].ATE_DET_TP_1 == 6) {
            GLOBAL_TOT_BENEFICIARIO += parseInt(Mx_Dtt_examcof[aa].CF_BONIFICACION);
            GLOBAL_TOT_FONASA += parseInt(Mx_Dtt_examcof[aa].CF_PRECIO_AMB);
        } else if (Mx_Dtt_examcof[aa].ATE_DET_TP_1 == 1 || Mx_Dtt_examcof[aa].ATE_DET_TP_1 == 20 || Mx_Dtt_examcof[aa].ATE_DET_TP_1 == 2) {
            GLOBAL_TOT_COPA_PART += parseInt(Mx_Dtt_examcof[aa].CF_PRECIO_AMB);
        }
    }
...
function Ajax_DataTable_examen3(cod_fonasa, id, cod, txis) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol_2.aspx/IRIS_WEBF_CMVM_BUSCA_ATENCION_CODIGO_FONASA_NO_ESTADO_AGENDA_BONIFICACION",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3_Desc(cod_fonasa, id, cod, txis) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol_2.aspx/IRIS_WEBF_CMVM_BUSCA_ATENCION_CODIGO_FONASA_NO_ESTADO_AGENDA_DESC",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Call_AJAX_Ddl() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol_2.aspx/IRIS_WEBF_CMVM_BUSCA_PROCEDENCIA_ACTIVO_BY_REL_USU_PROC_TABLE",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function fn_Req_Prev() {
    ...
    objAJAX_Prev = $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol_2.aspx/Request_Prevision",
        "data": objParam,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
...
function fn_Req_Pago() {
    objAJAX_Prev = $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol_2.aspx/tipo_pago",          //"2do PA, que excluye el Tp pago efecto, y mantiene "particular"
        //"data": objParam,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
        ...
        $("#DataTable_pac2 tbody").append(
            $("<tr>", {
                ...
                $("<td>", {                                                         //CF DESC
                    ...
                    $("<select>", {
                        class: "form-control textoReducido tp_previsiontable negrita",
...
function fill_confirma() {
    let revisa_valor = 0;
    let revisa_sc = 0;
    let revisa_bonifi = 0;

    $("#Div_Tabla_Revisa").empty();
    $("<table>", {
        "id": "DataTable_revisa",
        "class": "display",
        "width": "100%",
        "cellspacing": "0"
    }).appendTo("#Div_Tabla_Revisa");

    $("#DataTable_revisa").append(
        $("<thead>"),
        $("<tbody>")
    );
    $("#DataTable_revisa").attr("class", "table table-hover table-striped table-iris");
    $("#DataTable_revisa thead").attr("class", "cabzera");
    $("#DataTable_revisa thead").append(
        $("<tr>").append(
            ...
            $("<th>", { "class": "textoReducido" }).text("S. Complementario"),
            $("<th>", { "class": "textoReducido" }).text("Bonificación"),
            $("<th>", { "class": "textoReducido" }).text("Valor a Pagar")

        )
    );
    for (i = 0; i < Mx_Dtt_examcof.length; i++) {

        revisa_valor += parseInt(Mx_Dtt_examcof[i].CF_PRECIO_AMB);
        revisa_sc += parseInt(Mx_Dtt_examcof[i].ATE_DET_VALOR_CS);
        revisa_bonifi += parseInt(Mx_Dtt_examcof[i].ATE_DET_VALOR_BENEF);

        $("#DataTable_revisa tbody").append(
            $("<tr>", {
                "class": "textoReducido manito",
                "padding": "1px !important",
            }).append(
                $("<td>", { "align": "left", "class": "textoReducido" }).text(i + 1),
                $("<td>", { "align": "left", "class": "textoReducido" }).text(Mx_Dtt_examcof[i].CF_COD),
                $("<td>", { "align": "left", "class": "textoReducido" }).text(Mx_Dtt_examcof[i].CF_DESC),
                $("<td>", { "align": "left", "class": "textoReducido" }).text(function () {
                    if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 1) {
                        return "Efectivo";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 2) {
                        return "Cheque";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 3) {
                        return "Pendiente";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 4) {
                        return "Bono";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 5) {
                        return "Bono Electrónico";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 6) {
                        return "Carta de resguardo";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 8) {
                        return "Garantía";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 9) {
                        return "Tarjeta crédito";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 11) {
                        return "Sin costo";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 18) {
                        return "Abono";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 19) {
                        return "Excedente";
                    } else if (Mx_Dtt_examcof[i].ATE_DET_TP_1 == 20) {
                ...
                $("<td>", { "align": "right", "class": "textoReducido" }).text(Mx_Dtt_examcof[i].CF_PRECIO_AMB),
                $("<td>", { "align": "right", "class": "textoReducido" }).text(Mx_Dtt_examcof[i].ATE_DET_VALOR_CS),
                $("<td>", { "align": "right", "class": "textoReducido" }).text(Mx_Dtt_examcof[i].ATE_DET_VALOR_BENEF),
                $("<td>", { "align": "right", "class": "textoReducido" }).text(parseInt(Mx_Dtt_examcof[i].CF_PRECIO_AMB) - parseInt(Mx_Dtt_examcof[i].ATE_DET_VALOR_CS) - parseInt(Mx_Dtt_examcof[i].ATE_DET_VALOR_BENEF))
            )
        )
...
$("<tr>", {
    ...
    $("<td>", { "align": "left", "class": "textoReducido" }).text(""),
    $("<td>", { "align": "left", "class": "textoReducido" }).text(""),
    $("<td>", { "align": "right", "class": "textoReducido" }).text(""),
    $("<td>", { "align": "right", "class": "textoReducido" }).text(""),
    $("<td>", { "align": "right", "class": "textoReducido" }).text(""),
    $("<td>", { "align": "right", "class": "textoReducido" }).text("")
)
...
$("<tr>", {
    ...
    $("<td>", { "align": "left", "class": "oscurito" }).text("TOTALES"),
    $("<td>", { "align": "left", "class": "oscurito" }).text(""),
    $("<td>", { "align": "left", "class": "oscurito" }).text(""),
    $("<td>", { "align": "left", "class": "oscurito" }).text(""),
    $("<td>", { "align": "right", "class": "oscurito" }).text(parseInt(revisa_valor)),
    $("<td>", { "align": "right", "class": "oscurito" }).text(parseInt(revisa_sc)),
    $("<td>", { "align": "right", "class": "oscurito" }).text(parseInt(revisa_bonifi)),
    $("<td>", { "align": "right", "class": "oscurito" }).text(parseInt(revisa_valor) - parseInt(revisa_sc) - parseInt(revisa_bonifi))
)
)
