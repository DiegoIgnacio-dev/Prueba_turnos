<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master_MINDS.Master" CodeBehind="Grafico_MINDS_Examenes_Monts.aspx.vb" Inherits="Presentacion.Grafico_MINDS_Examenes_Monts" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Grafico_MINDS_Examenes_Monts.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Grafico_MINDS_Examenes_Monts.aspx/Llenar_Ddl",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Grafico_MINDS_Examenes_Monts.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Grafico_MINDS_Examenes_Monts.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Grafico_MINDS_Examenes_Monts.aspx/PDFF",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
    ...
    <script>
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>").css("text-align", "center").text("Total Pagado")
            ...
            for (i = 0; i < Mx_Dtt.length; ++i) {
                $("#DataTable tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "center" }).text("$" + addCommas(parseInt(Mx_Dtt[i].PREVI))),
                        $("<td>", { "align": "center" }).text("$" + addCommas(parseInt(Mx_Dtt[i].PAGADO)))
        ...
        function grafico_2() {
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                ...
                arr.push(fecha);
                arr1.push(parseFloat(Mx_Dtt[i].PREVI));
                arr2.push(parseFloat(Mx_Dtt[i].PAGADO));
            }
