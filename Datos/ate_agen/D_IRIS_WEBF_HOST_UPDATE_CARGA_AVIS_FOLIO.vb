...
Public Class D_IRIS_WEBF_HOST_UPDATE_CARGA_AVIS_FOLIO
    ...
    Function IRIS_WEBF_HOST_UPDATE_CARGA_AVIS_FOLIO(ByVal HO_CC As String, ByVal PRE_INGRESO As String) As Integer
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_HOST_UPDATE_CARGA_AVIS_FOLIO"
    ...
    Function IRIS_WEBF_HOST_UPDATE_CARGA_SAYDEX_FOLIO(ByVal HO_CC As String, ByVal PRE_INGRESO As String) As Integer
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_HOST_UPDATE_CARGA_SAYDEX_FOLIO"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
    ...
    Function IRIS_WEBF_HOST_UPDATE_CARGA_SAYDEX(ByVal Rut As String, ByVal PRE_INGRESO As String) As Integer
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_HOST_UPDATE_CARGA_AVIS"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
    ...
    Function IRIS_WEBF_HOST_UPDATE_CARGA_SIDRA_FOLIO_ID_ATENCION(ByVal HO_CC As String, ByVal ATENCION As String) As Integer
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_HOST_UPDATE_CARGA_SIDRA_FOLIO_ID_ATENCION"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@Rut", OleDbType.VarChar).Value = HO_CC
            .Add("@ID_ATENCION", OleDbType.Numeric).Value = ATENCION
        End With
        'Conectar con la Base de Datos
        Select Case CC_ConnBD.Oledbconexion.State
            Case ConnectionState.Open
