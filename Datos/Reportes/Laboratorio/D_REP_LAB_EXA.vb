...
Public Class D_REP_LAB_EXA
    ...
    Function IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS(ByVal DESDE As Date, ByVal HASTA As Date, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS)
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_CODIGO_FONASA_TODOS_3"
    ...
    Function IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID(ByVal DESDE As Date, ByVal HASTA As Date, ID_CF As Long, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_CODIGO_FONASA_POR_ID_2"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
    ...
    Function IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2(ByVal DESDE As Date, ByVal HASTA As Date, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2)
        ...
        'Declaraciones 'lista'
        Dim E_Proc_Item As E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2)
        'Configuración general
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_CODIGO_FONASA_TODOS_3_2"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
        ...
        Obj_Reader = Cmd_SQL.ExecuteReader
        While Obj_Reader.Read
            E_Proc_Item = New E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2
            'E_Proc_Item.ID_ATENCION = DD_GEN.DB_NULL(Obj_Reader, 0, "")
            E_Proc_Item.ATE_NUM = DD_GEN.DB_NULL(Obj_Reader, 0, "")
            E_Proc_Item.ATE_FECHA = DD_GEN.DB_NULL(Obj_Reader, 1, "")
            'E_Proc_Item.ID_PACIENTE = DD_GEN.DB_NULL(Obj_Reader, 3, "")
            E_Proc_Item.PAC_NOMBRE = DD_GEN.DB_NULL(Obj_Reader, 2, "")
            E_Proc_Item.PAC_APELLIDO = DD_GEN.DB_NULL(Obj_Reader, 3, "")
            E_Proc_Item.SEXO_DESC = DD_GEN.DB_NULL(Obj_Reader, 4, "")
            'E_Proc_Item.ID_SEXO = DD_GEN.DB_NULL(Obj_Reader, 8, "")
            'E_Proc_Item.ID_PROCEDENCIA = DD_GEN.DB_NULL(Obj_Reader, 9, "")
            'E_Proc_Item.ID_ESTADO = DD_GEN.DB_NULL(Obj_Reader, 10, "")
            ...
            'E_Proc_Item.ID_CODIGO_FONASA = DD_GEN.DB_NULL(Obj_Reader, 16, "")
            E_Proc_Item.FECHA_NAC = DD_GEN.DB_NULL(Obj_Reader, 7, "")
            E_Proc_Item.DNI = DD_GEN.DB_NULL(Obj_Reader, 8, "")
            E_Proc_Item.NACIONALIDAD = DD_GEN.DB_NULL(Obj_Reader, 9, "")
            E_Proc_Item.PROGRAMA = DD_GEN.DB_NULL(Obj_Reader, 10, "")
            'E_Proc_Item.SECTOR = DD_GEN.DB_NULL(Obj_Reader, 21, "")
            'E_Proc_Item.NUMERO_INTERNO = DD_GEN.DB_NULL(Obj_Reader, 22, "")
            'E_Proc_Item.MEDICO_SOLICITANTE = DD_GEN.DB_NULL(Obj_Reader, 23, "")
            'E_Proc_Item.MEDICO_SOLICITANTE_2 = DD_GEN.DB_NULL(Obj_Reader, 24, "")
            E_Proc_Item.PAC_RUT = DD_GEN.DB_NULL(Obj_Reader, 11, "")
            E_Proc_Item.SUBPROGRAMA = DD_GEN.DB_NULL(Obj_Reader, 12, "")
            E_Proc_Item.DETER = DD_GEN.DB_NULL(Obj_Reader, 13, "")
            E_Proc_Item.RESULTADO = DD_GEN.DB_NULL(Obj_Reader, 14, "")
            E_Proc_Item.PREVISION = DD_GEN.DB_NULL(Obj_Reader, 15, "")
            E_Proc_Item.ATE_AÑO = DD_GEN.DB_NULL(Obj_Reader, 16, "")
            'Agregar items a la lista
            E_Proc_List.Add(E_Proc_Item)
        End While
        CC_ConnBD.Oledbconexion.Close()
    ...
    Function IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_2(ByVal DESDE As Date, ByVal HASTA As Date, ID_CF As Long, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_CODIGO_FONASA_POR_ID_2_2"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
