<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Lis_Pac_TDM_COPIA.aspx.vb" Inherits="Presentacion.Lis_Pac_TDM_COPIA" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Call_AJAX_Ddl() {
            ...
            var AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "Lis_Pac_TDM_COPIA.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Ajax_N_PACIENTE() {
            ...
            var ajax_tabla = $.ajax({
                "type": "POST",
                "url": "Lis_Pac_TDM_COPIA.aspx/Llenar_PAC",
                "data": Data_Par_tabla,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Pac_TDM_COPIA.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_modal_exa(preingreso_paciente, atencion_paciente, ATE_NUM_ATENCION_MODAL) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Pac_TDM_COPIA.aspx/MODAL_PAC",
                "data": Data_Par_modal,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function ajax_grabar(ATE_PAC_ID, PRE_PAC_ID) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Pac_TDM_COPIA.aspx/MODAL_update",
                "data": Data_Par44,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function ajax_Actualizar(ATE_PAC_ID_5, PRE_PAC_ID_5) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Lis_Pac_TDM_COPIA.aspx/MODAL_Actualizar",
                "data": Data_Par44,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data_ATENDIDO => {
    ...
    <script>
        ...
        function Fill_Ddl() {
            ...
            if (procee == 0) {
                ...
                //            "value": 0
                //        }
                //    ).text("toditos").appendTo("#Ddl_LugarTM");
                Mx_Ddl.forEach(aaa => {
                    $("<option>",
                        {
