<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master_PROVEE.Master" CodeBehind="REP_LAB_CANT_PROVEE_EXA_SECC.aspx.vb" Inherits="Presentacion.REP_LAB_CANT_PROVEE_EXA_SECC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function AJAX_Ddl() {
            ...
            obj_AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_PROVEE_EXA_SECC.aspx/Llenar_Ddl",
                //"data": '{}',
        ...
        function AJAX_Dtt() {
            ...
            obj_AJAX_Dtt = $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_PROVEE_EXA_SECC.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_Xls() {
            ...
            obj_AJAX_Xls = $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_PROVEE_EXA_SECC.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
