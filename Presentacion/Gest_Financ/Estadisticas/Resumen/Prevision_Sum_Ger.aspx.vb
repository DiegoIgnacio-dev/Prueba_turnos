...
Public Class Prevision_Sum_Ger
    ...
    Public Shared Function Llenar_DataTable(ByVal ID_PREV As Long, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_PREVISION)
        ...
        Data_Prev = NN_Prev.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_PREVISION_GER(ID_PREV, DATE_str01, DATE_str02)
        Return Data_Prev
    ...
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable_TOTIS(ByVal ID_PREV As Long, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_PREVISION)
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        'Declaraciones internas
        ...
        Dim NN_Prev As New N_Prevision_Sum
        Dim Data_Prev As New List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_PREVISION)
        Data_Prev = NN_Prev.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_PREVISION_VALIDADOS(ID_PREV, DATE_str01, DATE_str02)
        Return Data_Prev
        'If (Data_Prev.Count > 0) Then
        '    'Serializar con JSON
        '    Serializer.MaxJsonLength = 999999999
    ...
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String, ByVal ID_PREV As Long, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As String
        Dim NN_Prev As New N_Prevision_Sum
        Return NN_Prev.Excel_Ger(DOMAIN_URL, ID_PREV, DATE_str01, DATE_str02)
    End Function
