...
Public Class Ingreso_Ate_Sidra
        ...
        If (data_examen.Count > 0) Then
            For i = 0 To data_examen.Count - 1
                If (data_examen(i).ATE_NUM_AVIS <> 0) Then
                    exa_avis = NN_ExamenDet.IRIS_WEBF_CMVM_UPDATE_ESTADO_EXAMEN_INTEGRACION_SIDRA(data_examen(i).ATE_NUM_AVIS, data_examen(i).HO_ExamenCodigo)
                End If
            Next i
        End If
    ...
    Public Shared Function Llenar_DataTable_Ate(ByVal ID_PRE As String, ByVal ID_ATE As String) As String
        ...
        If (ID_ATE = 0) Then
            ...
            If (data_ate.Count > 0) Then
                data_ate_2 = NN_Ate_2.IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES_2_SIDRA_AGENDA(data_ate(0).ID_ATENCION)
            ...
            End If
        Else
            data_ate_2 = NN_Ate_2.IRIS_WEBF_BUSCA_MUESTRA_ANTECEDENTES_PACIENTES_2_SIDRA_ATE(ID_ATE)
            If (data_ate_2.Count > 0) Then
                'Serializar con JSON
                Serializer.MaxJsonLength = 999999999
                Serializer.Serialize(data_ate_2, str_Builder)
    ...
    Public Shared Function Llenar_AVIS(ByVal AVIS As String) As String
        ...
        data_paciente = NN.IRIS_WEBF_HOST_BUSCA_DATOS_PACIENTE_Y_EXAMENES_POR_FOLIO_SIDRA_2_GLOBAL(AVIS)
    ...
    Public Shared Function crearDoc(ByVal AVIS As String) As String
        ...
        Data_LugarTM = NN_LugarTM.IRIS_WEBF_AGREGAR_MEDICOS_CON_SIDRA(AVIS)
    ...
    Public Shared Function Guardar_TodoByVal(ByVal RUT_PAC As String,
        ...
        Else
            If (RUT_PAC = "") Then
                ...
                PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_SIDRA_3_NEW(correlativo,
                                                                         Rpaciente,
                                                                         CInt(S_Id_User),
                                                                         FUR,
                                                                         Procedencia,
                                                                         ...
                                                                         FECHA_PRE,
                                                                         Programa,
                                                                         Sector, ATE_SAYDEX, DIAG1, DIAG2, sub_atencion, vih, 1, 1, "SIN HORARIO")
            Else
                ...
                Else
                    ...
                    PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_SIDRA_3_NEW(correlativo,
                                                                             ...
                                                                             Programa,
                                                                             Sector,
                                                                                     ATE_SAYDEX, DIAG1, DIAG2, sub_atencion, vih, 1, 1, "SIN HORARIO")
            ...
            For i = 0 To ids.Count - 1
                examun = exex.IRIS_WEBF_GRABA_DETALLE_PREINGRESO_SIDRA(PREINGRESO2_PRO_SEC, CInt(S_Id_User), ids(i).id_CF, ids(i).id_PER, 1, 0, ids(i).Valor, ids(i).Valor, 0, ids(i).HO_CC)
            Next i
            ...
            id_atencion = ddx.IRIS_WEBF_CMVM_GRABA_ATENCION_PROGRA2_PRO_SECTOR_SIDRA(correlativo2,
            ...
            If (Paridad = 1) Then
                For x = 0 To ids.Count - 1
                    zz.IRIS_WEBF_HOST_UPDATE_CARGA_SIDRA_FOLIO_ID_ATENCION(ids(x).HO_CC, id_atencion)
                Next x
            Else
            ...
            For i = 0 To data_examen.Count - 1
                id = jj.IRIS_WEBF_GRABA_DETALLE_ATENCION_INTERFAZ_SIDRA(id_atencion,
                                                                   CInt(S_Id_User),
                    ...
                    If (IsNothing(ids(i).HO_CC) = False Or ids(i).HO_CC <> 0) Then
                        For ss = 0 To DataExamenDet_2.Count - 1
                            If (DataExamenDet_2(ss).ID_CODIGO_FONASA = ids(i).id_CF) Then
                                exa_avis = NN_ExamenDet.IRIS_WEBF_CMVM_UPDATE_ESTADO_EXAMEN_INTEGRACION_SIDRA(ids(i).HO_CC, DataExamenDet_2(ss).CF_AVIS)
                            End If
                        Next ss
                    End If
                End If
