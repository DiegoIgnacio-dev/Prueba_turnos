...
function Ajax_VtaBonInterfaz() {
    Mx_Dtt_VtaBonInterfaz = 0;
    var ListPrestAut = new Array();

    var objId = {
        "CodPrestacion": "0301007",
        "CodItem": "0",
        "Cantidad": "1",
        "RecargoHora": "N",
        "MtoTotal": "0",
    ...
    var Data_Par = JSON.stringify({
        "CodUsuario": "0070614000-K",//"0017047947-5",//"0070614000-K",
        "CodClave": "70614000-K",//"17047",//"70614000-K",
        "CodFinanciador": 1,
        "CodLugar": 13930,
        "RutConvenio": "0070614000-K",
        "CorrConvenio": 1,
        "RutTratante": "0000001111-8",
        "RutSolic": "0000001111-8",
        "NomSolic": "DR",
        "CodEspecia": "0",
        "RutBenef": "0015535615-4",
        "RutCajero": "0017047947-5",
        "IndUrgencia": "N",
        "CodTipoTratamiento": 1,
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/VtaBonInterfaz",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_VerResulEmi() {
    console.log("Ajax_VerResulEmi 2do");
    var Data_Par = JSON.stringify({
        "CodUsuario": "0017047947-5",//"17047",//"0017047947-5",//Mx_Dtt_VtaBonInterfaz.CodUsuario,//"0070614000-K",
        "CodClave": "17047",//Mx_Dtt_VtaBonInterfaz.CodClave,//"70614000-K"
        "NumTransac": Mx_Dtt_VtaBonInterfaz.NumTransac
    });
    console.log(Data_Par);
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/VerResulEmi",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_ObtBonInterfaz() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/ObtBonInterfaz",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_guardar() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/Guardar_TodoByVal",
        //"url": "Ingreso_Ate_Caja6_Boleta.aspx/TEST_GUARDAR",  
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen02() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/Llenar_tabla_exam2",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen02_Particular() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/Llenar_tabla_exam2_particular",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3_preve(xxid_preve, select_id_3, Xid_cod_01, pos_01) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/Llenar_tabla_exam",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3(cod_fonasa, id, cod, txis) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/IRIS_WEBF_CMVM_BUSCA_ATENCION_CODIGO_FONASA_NO_ESTADO_AGENDA_BONIFICACION",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3_Desc(cod_fonasa, id, cod, txis) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/IRIS_WEBF_CMVM_BUSCA_ATENCION_CODIGO_FONASA_NO_ESTADO_AGENDA_DESC",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3_PACK(cod_fonasa_2, id_2, cod_2, txis_2) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/Llenar_tabla_exam_pack",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Call_AJAX_Ddl() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/IRIS_WEBF_CMVM_BUSCA_PROCEDENCIA_ACTIVO_BY_REL_USU_PROC_TABLE",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function fn_Req_Pago() {
    objAJAX_Prev = $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja6_Boleta.aspx/tipo_pago",          //"2do PA, que excluye el Tp pago efecto, y mantiene "particular"
        //"data": objParam,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
