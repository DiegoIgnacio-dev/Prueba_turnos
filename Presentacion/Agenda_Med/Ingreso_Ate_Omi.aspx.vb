...
Public Class Ingreso_Ate_Omi
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_rut(ByVal AVIS As String) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        AVIS = AVIS.Replace(".", "")
        data_paciente = NN.IRIS_GRABA_ATE_DOCUMENTO_PAGO_RUT(AVIS)
        If (data_paciente.Count > 0) Then
            'Serializar con JSON
            Serializer.MaxJsonLength = 999999999
            Serializer.Serialize(data_paciente, str_Builder)
    ...
    <Services.WebMethod()>
    Public Shared Function Llenar_DNI(ByVal AVIS As String) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        Dim data_paciente As List(Of E_IRIS_WEBF_OBTENER_INFO)
        Dim NN As N_IRIS_OBTENER_INFO = New N_IRIS_OBTENER_INFO
        data_paciente = NN.IRIS_GRABA_ATE_DOCUMENTO_PAGO_DNI(AVIS)
        If (data_paciente.Count > 0) Then
            'Serializar con JSON
            Serializer.MaxJsonLength = 999999999
            Serializer.Serialize(data_paciente, str_Builder)
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function IRIS_WEBF_BUSCA_examenes_paciente(ByVal examenes As List(Of examens_avis_2)) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        For x = 0 To examenes.Count - 1
            ...
            If (data_paciente.Count > 0) Then
                ...
                Item_Exam.CF_MULTIPLICADOS = examenes(x).CF_MULTIPLICADOS
    ...
    <Services.WebMethod()>
    Public Shared Function crearDoc(ByVal nombre As String, ByVal Apellido As String, ByVal RUT As String) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        'Declaraciones internas
        ...
        Data_LugarTM = NN_LugarTM.IRIS_WEBF_AGREGAR_MEDICOS_CON_OMI(nombre, Apellido, RUT)
    ...
    Public Shared Function Guardar_TodoByVal(ByVal RUT_PAC As String,
        ...
        Else
            If (RUT_PAC = "") Then
                data_paciente2222 = NNv.IRIS_WEBF_BUSCA_PACIENTE_POR_dni(DNI)
            Else
            ...
            If (data_paciente2222.Count = 0) Then
                ...
                PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_OMI_NEW(correlativo,
                                                                                 ...
                                                                                 FECHA_PRE,
                                                                                 Programa,
                                                                                 Sector, hocc, DIAG1, DIAG2, sub_atencion, vih)
            Else
            ...
            id_atencion = ddx.IRIS_WEBF_GRABA_ATENCION_PROGRA2_PRO_SECTOR_OMI(correlativo2,
                                                                       ...
                                                                       hocc,
                                                                          interno,
                                                                          data_atencion(0).ID_DIAGNOSTICO, data_atencion(0).ID_DIAGNOSTICO2, data_atencion(0).VIH, data_pac(0).DNI, ID_SUBP)
    ...
    Public Shared Function Llenar_tabla_exam2_particular(ByVal ID_PREVE As Integer, ByVal Fecha As String) As String
        ...
        data_particular = NN_particular.IRIS_WEBF_CMVM_BUSCA_CODIGO_FONASA_PARA_CARGA_ATENCION_PENA_PARTICULAR(Format(ANO, "yyyy"), 185)
...
Public Class ids55
    ...
    End Property
End Class
Public Class examens_avis_2
    Dim E_examen As String
    Dim E_HO_CC As String
    Dim E_CF_MULTIPLICADOS As String
