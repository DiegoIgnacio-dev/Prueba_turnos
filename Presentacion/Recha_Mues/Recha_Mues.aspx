        ...
        function Fill_DataTable_Load() {
            ...
            for (i = 0; i < Mx_Dtt_Load.length; i++) {
                $("#DataTable_Load tbody").append(
                    $("<tr>", {
                        "onclick": `Ajax_Get_values_to_Pendiente("` + Mx_Dtt_Load[i].CB_DESC + `","` + Mx_Dtt_Load[i].ATE_NUM + `","` + Mx_Dtt_Load[i].ID_RECEP_ETI_RECHAZO + `")`,
        ...
        <div class="modal-dialog modal-md">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg">
                        <label for="Txt_Motivo">Observación de Rechazo:</label>
                        <textarea id="Txt_Motivo" class="form-control"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
