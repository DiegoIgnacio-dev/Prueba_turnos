<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Ingreso_Ate_Sidra.aspx.vb" Inherits="Presentacion.Ingreso_Ate_Sidra" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function ajax_eliminar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Sidra.aspx/MODAL_elimanar",
                "data": Data_Par44,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
    ...
    <script>
        ...
        function Ajax_guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Sidra.aspx/Guardar_TodoByVal",
        ...
        function Ajax_N_PACIENTE_3() {
            ...
            var ajax_tabla = $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Sidra.aspx/Llenar_AVIS",
                "data": Data_Par_tabla,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_modal_exa_3(preingreso_paciente, atencion_paciente, ATE_NUM_ATENCION_MODAL) {
            ...
            if ((preingreso_paciente == 0 || preingreso_paciente == "null" || preingreso_paciente == null) && atencion_paciente == 0) {
                ...
                $.ajax({
                    "type": "POST",
                    "url": "Ingreso_Ate_Sidra.aspx/Llenar_DataTable_Ate",
                    "data": Data_Par_modal,
                    "contentType": "application/json;  charset=utf-8",
                    "dataType": "json",
                    "success":function (response) {
    ...
    "CF_DIAS": 0,
        ...
        var Mx_Dtt_exam02_respaldo_global = [
      {
        ...
        function Ajax_DataTable_examen0GObal() {
           $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Sidra.aspx/Llenar_tabla_exam2_global",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Ddl = [
     {
        ...
        function creardoctor(doc) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Sidra.aspx/crearDoc",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-lg checkbox checkbox-success">
                               ...
                               <input id="checkBox999" value="rutee" type="checkbox"/> <label class="textoReducido" style="padding-left: 0px !important;" for="checkBox999">N° Sidra</label><input id="checkBox8887" value="DNI" type="checkbox"/><label style="margin-left: 15px; padding-left: 0px !important;" class="textoReducido" for="checkBox8887">N° Atención:</label>
                                <div class="input-group" style="height: 31.75px;" id="avusg">
                                    <input type="text" id="Avis" class="form-control textoReducido" placeholder="Numero SIDRA" />
