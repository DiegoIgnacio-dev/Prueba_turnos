<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Prev_TM_Exa_Mult_TCMD_New.aspx.vb" Inherits="Presentacion.Prev_TM_Exa_Mult_TCMD_New" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_TCMD_New.aspx/PDFF",
                "data": Data_Par,
        ...
        var Mx_Ddl_Medi = [
   {
       ...
       "DOC_MOVIL1": "asdf"
        ...
        function Ajax_Ddl_Prev() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_TCMD_New.aspx/Llenar_Ddl_Prev",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Ajax_Ddl_Proce() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_TCMD_New.aspx/Llenar_Ddl_Proce",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ddl_Exa() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_TCMD_New.aspx/Llenar_Ddl_Exa",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ddl_Medi() {
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_TCMD_New.aspx/Llenar_Ddl_Medi",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_TCMD_New.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_2() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_TCMD_New.aspx/Llenar_DataTable_2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_TCMD_New.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Progra() {
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_TCMD_New.aspx/Llenar_Ddl_Programa",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>").text("Examen"),
                    //$("<th>", { "class": "text-right" }).text("Cant. Atenciones"),
                    $("<th>", { "class": "text-right" }).text("Cant. Exámenes"),
                    $("<th>", { "class": "text-right" }).text("Valor Total")
                )
            );
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                $("#DataTable tbody").append(
                    $("<tr>").append(
                        ...
                        //$("<td>", { "align": "right" }).text(Mx_Dtt[i].TOTAL_ATE),
                        $("<td>", { "align": "right" }).text(Mx_Dtt[i].TOT_FONASA),
                        $("<td>", { "align": "right" }).text("$ " + cFormat.numToString(Mx_Dtt[i].TOTA_SIS, 0, ".", ","))
                    )
                );
            }
            ...
            $("#DataTableTotal tbody").append(
                    $("<tr>").append(
                        $("<td>", { "align": "center" }).text(Mx_Dtt[0].TOTAL_ATE),
        ...
        function Fill_DataTable_2() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    //$("<th>", { "class": "text-right" }).text("Cant. Atenciones"),
                    $("<th>", { "class": "text-right" }).text("Cant. Exámenes"),
                    $("<th>", { "class": "text-right" }).text("Valor Unidad"),
                    $("<th>", { "class": "text-right" }).text("Valor Total")
                )
            );
    ...
    <div class="flex_col">
        <div class="card mb-3 border-bar">
            <div class="card-header bg-bar p-2">
                <h5>Resumen general de exámenes realizados</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg">
                    ...
                    <div class="col-lg">
                        <label for="DdlProce">Procedencia:</label>
                    ...
                    <select id="Ddl_Progra" class="form-control"></select>
                </div>
                    <div class="col-lg">
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                     ...
                     <div class="col-lg">
                        <button id="Btn_Pdf" type="button" class="btn btn-block btn-warning btn-sm"><i class="fa fa-fw fa-file-text-o mr-2"></i>PDF</button>
                    </div>
                </div>
            </div>
        </div>
