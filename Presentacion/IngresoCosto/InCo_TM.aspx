<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="InCo_TM.aspx.vb" Inherits="Presentacion.InCo_TM" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script>
        ...
        function Llenar_Ddl_LugarTM() {
            ...
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_TM.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        function Fill_Ddl_LugarTM() {
            ...
            ).text("Todos").appendTo("#Slt_Proc");
            Mx_Ddl_LugarTM.forEach(aaa => {
                $("<option>",
                    {
                        "value": aaa.ID_PROCEDENCIA
                    }
                ).text(aaa.PROC_DESC).appendTo("#Slt_Proc");
            });
        }
        ...
        function Ajax_Datatable() {
            ...
            let Data_Par = JSON.stringify({
                "DESDE": $("#fecha").val(),
                "HASTA": $("#fecha2").val(),
                "ID_PROC": $("#Slt_Proc").val()
            });
            //Debug
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_TM.aspx/IRIS_WEBF_BUSCA_LIS_ADM_LUGAR_TM",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Ajax_Excel() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "HASTA": $("#fecha2").val(),
                "ID_PROC": $("#Slt_Proc").val(),
                "PROC_DESC": $("#Slt_Proc option:selected").text()
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card border-bar">
        <div class="card-header bg-bar">
            <h5 class="m-1">Ingreso vs Costos por Lugar de Toma de Muestra
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg">
                    <label for="Slt_Proc">Procedencia:</label>
                    <select id="Slt_Proc" class="form-control"></select>
                </div>
                <div class="col-lg">
                    <br />
