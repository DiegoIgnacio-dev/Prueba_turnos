...
Public Class REP_LAB_CANT_EXA_MINDS_ARE_SECC
    ...
    Public Shared Function Llenar_DataTable(ByVal ID_CODIGO_FONASA As Long, ByVal DATE_str01 As String,
        ...
        If (VALOR = 0) Then
            Data_Prev = NN_Exam.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_VALIDADOS(ID_CODIGO_FONASA, Date_01, Date_02, cookie_proc)
        ElseIf VALOR = 1 Then
            Data_Prev = NN_Exam.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_VALIDADOS_REVISADOS(ID_CODIGO_FONASA, Date_01, Date_02, cookie_proc)
        ElseIf VALOR = 2 Then
            Data_Prev = NN_Exam.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_TODOS(ID_CODIGO_FONASA, Date_01, Date_02, cookie_proc)
        End If
