...
Public Class D_InCo_TM
    Function IRIS_WEBF_BUSCA_LIS_ADM_LUGAR_TM(ByVal DESDE As String, ByVal HASTA As String, ByVal ID_PROC As Integer) As List(Of E_InCo_TM)
        ...
        Dim Obj_Read_Dt As E_InCo_TM
        Dim List_Reader As New List(Of E_InCo_TM)
        Dim Reader_Comm As OleDbDataReader
        Dim DD_GEN As New D_General_Functions
        'definiendo tipo de consulta a la BD
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_BUSCA_LIS_ADM_LUGAR_TM"
