...
Public Class D_IRIS_WEBF_BUSCA_PREVISION_ACTIVO
    ...
    Function IRIS_WEBF_BUSCA_PREVISION_ACTIVO() As List(Of E_IRIS_WEBF_BUSCA_PREVISION_ACTIVO)
        ...
        Cmd_command.CommandText = "IRIS_WEBF_CMVM_BUSCA_PREVISION_ACTIVO"
    ...
    Function IRIS_WEBF_CMVM_BUSCA_PREVISION_ACTIVO_PREVE_ID_USER(ByVal ID_USER As Integer) As List(Of E_IRIS_WEBF_BUSCA_PREVISION_ACTIVO)
        ...
        'Configuración general
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_CMVM_BUSCA_PREVISION_ACTIVO_PREVE_ID_USER"
        Cmd_command.Connection = objconexion.Connect_to_IrisLab_LoBarnechea


        With Cmd_command.Parameters
            .Add("@ID_PROC", OleDbType.VarChar).Value = ID_USER '1
        End With
        'establece conexion con la base de datos
        If (objconexion.Oledbconexion.State = ConnectionState.Open) Then
            objconexion.Oledbconexion.Close()
    ...
    Function IRIS_WEBF_CMVM_BUSCA_PREVISION_POR_PROCEDENCIA_ID_PROCE_2_AND_PART_WEB(ByVal ID_PROC As Integer) As List(Of E_IRIS_WEBF_BUSCA_PREVISION_ACTIVO)
        ...
        'Configuración general
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_CMVM_BUSCA_PREVISION_POR_PROCEDENCIA_ID_PROCE_2_AND_PART_WEB"
        Cmd_command.Connection = objconexion.Connect_to_IrisLab_LoBarnechea
        ...
        While Reader_Comm.Read
            ...
            Obj_Read_Dt.PREVE_COD = DD_GEN.DB_NULL(Reader_Comm, 1, Nothing)
            Obj_Read_Dt.PREVE_DESC = DD_GEN.DB_NULL(Reader_Comm, 2, Nothing)
            Obj_Read_Dt.PREVE_PART_WEB = DD_GEN.DB_NULL(Reader_Comm, 3, 0)
            'Agregar items a la lista
            List_Reader.Add(Obj_Read_Dt)
        End While
        objconexion.Oledbconexion.Close()
