...
Public Class N_REP_LAB_SEC
    ...
    Function Gen_Excel(ByVal MAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String, ByVal ID_CF As Integer) As String
        ...
        For y = 0 To (Data_Prev.Count - 1)
            ...
            Mx_Data(2, y) = Data_Prev(y).ATE_AÑO & " " & "Años"
        ...
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Búsqueda de Atenciones por Secciones")
        'titulo de la tabla
        sl.SetCellValue("B2", "Búsqueda de Atenciones por Secciones")
