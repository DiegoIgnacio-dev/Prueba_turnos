...
//AJAX Objects-------------------------------------------------------------------
let timer = 5000;
let objAJAX_Agendam = new Class_AJAX();
objAJAX_Agendam.url = "http://localhost:9990/Printer/Imp_Voucher_Agendam";
objAJAX_Agendam.success = (resp) => {
    console.log(`[ OK ] Impresión Voucher LugarTM`);
    console.log(resp);
    console.log(``);

    let str_Error = `La impresión del Voucher de Agendamiento se ha completado exitosamente. `;
...
function fn_Req_Prev() {
    ...
    objAJAX_Prev = $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Request_Prevision",
        "data": objParam,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
...
function fn_Req_Prog() {
    ...
    objAJAX_Prog = $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Request_Programa",
        "data": objParam,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
...
function fn_Req_SubP() {
    ...
    objAJAX_SubP = $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Request_SubPrograma",
        "data": objParam,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
...
function buscar_saydex_nuevo_folio() {
    modal_show();
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_AVIS",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
            ...
            if (json_receiver != "null") {
                Mx_SAYDEX_NUEVO = JSON.parse(json_receiver);
                if (Mx_SAYDEX_NUEVO[0].Rut != Mx_AVIS[0].Rut) {
                    Hide_Modal();
                    $("#mError_AAH").modal('hide');
                    var str_Error = "El N° ingresado no pertenece al paciente SAYDEX";
                    $("#title").text("N° SAYDEX:");
                    $("#button_modal").attr("class", "btn btn-danger");
...
function Fill_DL_SAYDEX() {

    MX_HO_ExamenCodigo.length = 0;

    for (x = 0; x < Mx_SAYDEX_NUEVO.length; x++) {
        switch (x) {
            case 0:
                var objId = {
                    "Examen": Mx_SAYDEX_NUEVO[x].Examen_Codigo,
                    "HO_CC": Mx_SAYDEX_NUEVO[x].Orden
                };
                MX_HO_ExamenCodigo.push(fnClone(objId));
                break;
            default:
                if (Mx_SAYDEX_NUEVO[x].Examen_Codigo != Mx_SAYDEX_NUEVO[x - 1].Examen_Codigo) {
                    var objId = {
                        "Examen": Mx_SAYDEX_NUEVO[x].Examen_Codigo,
                        "HO_CC": Mx_SAYDEX_NUEVO[x].Orden
                    };
...
function Ajax_Examens_SAYDEX() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/IRIS_WEBF_BUSCA_examenes_paciente",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
            var json_receiver = response.d;
            if (json_receiver != "null") {
                Mx_examenes_SAYDEX = JSON.parse(json_receiver);

                let bFound = false;
                let xi = 0;

                for (let reee in Mx_examenes_SAYDEX) {
                    bFound = false;

                    for (let ii in Mx_Dtt_examcof) {
                        if (Mx_examenes_SAYDEX[reee].ID_CODIGO_FONASA == Mx_Dtt_examcof[ii].ID_CODIGO_FONASA) {
                            bFound = true;
                            xi = ii;
                            break;
                        }
                    ...
                    if (bFound == true) {
                        let ID_SQL = parseInt(Mx_examenes_SAYDEX[reee].HO_CC);
                        let ID_TAB = parseInt(Mx_Dtt_examcof[xi].HO_CC);

                        if (ID_SQL > ID_TAB) {
                            Mx_Dtt_examcof[xi] = fnClone(Mx_examenes_SAYDEX[reee]);
                        }
                    } else {
                        Mx_Dtt_examcof.push(fnClone(Mx_examenes_SAYDEX[reee]));
                    }
                }
...
//    $.ajax({
//        "type": "POST",
//        "url": "IN_PAC_SAYDEX.aspx/Llenar_DataTable",
//        "data": Data_Par,
//        "contentType": "application/json;  charset=utf-8",
//        "dataType": "json",
//        "success": function (response) {
...
function Ajax_guardar() {
    ...
    var Data_Par = {
        ...
        "DIAG2": diag2,
        //"interno": $("#interno").val(),
        "sub_atencion": 1,//$("#sub_atencion").val(),
        "vih": $("#vih").val(),
        "NOMBRE_PAC": $("#Nom").val(),
        "APE_PAC": $("#Ape").val(),
        "FNAC_PAC": $("#fecha").val(),
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Guardar_TodoByVal",
...
function Ajax_Diagnostico() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen02() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_tabla_exam2",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function AJAX_SIN_RUT() {
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/AJAX_SIN_RUT",
        //"data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3(cod_fonasa, id, cod, txis) {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_tabla_exam",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_busca_rut() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_AVIS_RUT",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
            ...
            if (json_receiver != "null") {
                ...
                Hide_Modal();
                var str_Error = "El rut ingresado no pretenece a un paciente Saydex";
...
function Ajax_DL_SEXO() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_DL_SEXO",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DL_NAC() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_DL_NAC",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_Ciudad() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/IRIS_WEBF_BUSCA_CIUDAD",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_Comuna() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/IRIS_WEBF_BUSCA_RELACION_CIU_COMUNA",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DL_prevision() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_DL_prevision",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DL_TP_ATE() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_DL_aTENCIONES",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DL_sec() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_DL_Sectores",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DL_programa() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_DL_Programa",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DL_DOC() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_DL_DOC",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DL_orden_ate() {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/Llenar_DL_ordenATE",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DLdiag(hosts) {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO_POR_HOST",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DLdiag2(hosts) {
    ...
    $.ajax({
        "type": "POST",
        "url": "IN_PAC_SAYDEX.aspx/IRIS_WEBF_BUSCA_DIAGNOSTICO_POR_HOST2",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
