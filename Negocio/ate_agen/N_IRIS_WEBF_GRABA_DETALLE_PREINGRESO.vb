...
Public Class N_IRIS_WEBF_GRABA_DETALLE_PREINGRESO
    ...
    Function IRIS_WEBF_GRABA_DETALLE_PREINGRESO(ByVal ID_ATE As Integer,
        ...
        Return DD_Data.IRIS_WEBF_GRABA_DETALLE_PREINGRESO(ID_ATE, ID_USUARIO, ID_CF, ID_PER, ID_TP_PAGO, ATE_DET_DOC, 0, ATE_DET_V_PAGADO, ATE_DET_V_CCOPAGO, HO_CC)
    End Function
    Function IRIS_WEBF_GRABA_DETALLE_PREINGRESO_SIDRA(ByVal ID_ATE As Integer,
                                               ...
                                               ByVal ATE_DET_V_CCOPAGO As Integer,
                                               Optional ByVal HO_CC As String = "0") As Integer
        Return DD_Data.IRIS_WEBF_GRABA_DETALLE_PREINGRESO_SIDRA(ID_ATE, ID_USUARIO, ID_CF, ID_PER, ID_TP_PAGO, ATE_DET_DOC, 0, ATE_DET_V_PAGADO, ATE_DET_V_CCOPAGO, HO_CC)
    End Function
End Class