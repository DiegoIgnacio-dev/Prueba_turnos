...
Public Class N_REP_LAB_EXA
    ...
    End Function
    Function IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2(ByVal DESDE As Date, ByVal HASTA As Date, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2)
        Return DD_Data.IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2(DESDE, HASTA, PROCEDENCIA)
    End Function
    Function IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_2(ByVal DESDE As Date, ByVal HASTA As Date, ID_CF As Long, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2)
        Return DD_Data.IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_2(DESDE, HASTA, ID_CF, PROCEDENCIA)
    End Function
    Function Gen_Excel(ByVal MAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String, ByVal ID_CF As Integer, ByVal PROCEDENCIA As Integer) As String
        ...
        If (ID_CF = 0) Then
            Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS(Date01, Date02, PROCEDENCIA)
        Else
            Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID(Date01, Date02, ID_CF, PROCEDENCIA)
        End If
        'Vaciar Matriz
        ReDim Mx_Data(13, 0)
        ...
        'insertar tabla
        tabla = sl.CreateTable("A7", CStr("N" & ltabla + 1))
    ...
    Function PDFF(ByVal DOMAIN_URL As String, ByVal ID_CODIGO_FONASA As Long, ByVal DATE_str01 As String, ByVal DATE_str02 As String, ByVal PROCEDENCIA As Integer) As String
        ...
        If (ID_CODIGO_FONASA = 0) Then
            Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS(Date_01, Date_02, PROCEDENCIA)
        Else
            Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID(Date_01, Date_02, ID_CODIGO_FONASA, PROCEDENCIA)
        End If
        ...
        With fuck.Canvas
            ...
            .DrawText("Doctor", STR_PARAM(70, 680, 100, "left", 8, 90), FONT_2)
            ...
            For z = 0 To Data_Prev.Count - 1
                ...
                If contador_filas < 31 Then
                    ...
                    End If
                    .DrawText(Sect, STR_PARAM(eje_y, 645, 40, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).MEDICO_SOLICITANTE & " " & Data_Prev(z).MEDICO_SOLICITANTE_2, STR_PARAM(eje_y, 680, 100, "left", 6, 90), FONT_1)
                ...
                Else
                    ...
                    With fuck.Canvas
                        ...
                        If xxx = 1 Then
                            ...
                            .DrawText("Doctor", STR_PARAM(25, 680, 100, "left", 8, 90), FONT_2)
                            xxx = 0
                        End If
    ...
    Function Gen_Excel_2(ByVal MAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String, ByVal ID_CF As Integer, ByVal PROCEDENCIA As Integer) As String
        'Declaraciones Generales
        Dim datos As String = ""
        'Declaraciones internas
        Dim NN_Date As New N_Date
        ...
        Dim Date02 As Date = NN_Date.strToDate(Str_d2(2), Str_d2(1), Str_d2(0))
        If (ID_CF = 0) Then
            Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2(Date01, Date02, PROCEDENCIA)
        Else
            Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_POR_ID_2(Date01, Date02, ID_CF, PROCEDENCIA)
        End If
        'Vaciar Matriz
        ReDim Mx_Data(15, 0)
        For x = 0 To (Mx_Data.GetUpperBound(0))
        ...
        For y = 0 To (Data_Prev.Count - 1)
            ...
            Mx_Data(7, y) = Format(CDate(Data_Prev(y).ATE_FECHA), "dd/MM/yyyy")
            Mx_Data(8, y) = Format(CDate(Data_Prev(y).ATE_FECHA), "HH:mm:ss")
            Mx_Data(9, y) = Data_Prev(y).PREVISION
            Mx_Data(10, y) = Data_Prev(y).PROC_DESC
            Mx_Data(11, y) = Data_Prev(y).PROGRAMA
            Mx_Data(12, y) = Data_Prev(y).SUBPROGRAMA
            Mx_Data(13, y) = Data_Prev(y).CF_DESC
            Mx_Data(14, y) = Data_Prev(y).DETER
            Mx_Data(15, y) = Data_Prev(y).RESULTADO
        Next y
        Dim Excel_x As Integer
        Dim Excel_y As Integer
        Excel_x = 1
        ...
        sl.SetCellValue("C7", "Rut o D.N.I")
        sl.SetCellValue("D7", "Fecha Nac.")
        sl.SetCellValue("E7", "Edad")
        sl.SetCellValue("F7", "Nacionalidad")
        sl.SetCellValue("G7", "Sexo")
        sl.SetCellValue("H7", "Fecha")
        sl.SetCellValue("I7", "Hora")
        sl.SetCellValue("J7", "Prevision")
        sl.SetCellValue("K7", "Procedencia")
        sl.SetCellValue("L7", "Programa")
        sl.SetCellValue("M7", "SubPrograma")
        sl.SetCellValue("N7", "Examen")
        sl.SetCellValue("O7", "Determinacion")
        sl.SetCellValue("P7", "Resultado")
        sl.SetColumnWidth(8, 55.0)
        For y = 1 To 16
            sl.SetColumnWidth(y, 20.0)
        Next y
        ...
        'insertar tabla
        tabla = sl.CreateTable("A7", CStr("P" & ltabla + 1))
        tabla.SetTableStyle(SLTableStyleTypeValues.Dark11)
        sl.InsertTable(tabla)
    ...
    Function PDFF_2(ByVal DOMAIN_URL As String, ByVal ID_CODIGO_FONASA As Long, ByVal DATE_str01 As String, ByVal DATE_str02 As String, ByVal PROCEDENCIA As Integer) As String
        ...
        With fuck.Canvas
            ...
            .DrawText("#", STR_PARAM(70, 20, 23, "left", 8, 90), FONT_2)
            .DrawText("Folio", STR_PARAM(70, 45, 23, "left", 8, 90), FONT_2)
            .DrawText("Nombre Paciente", STR_PARAM(70, 70, 103, "left", 8, 90), FONT_2)
            .DrawText("RUT/DNI", STR_PARAM(70, 175, 43, "left", 8, 90), FONT_2)
            .DrawText("F. Nac.", STR_PARAM(70, 220, 33, "left", 8, 90), FONT_2)
            .DrawText("Edad", STR_PARAM(70, 255, 28, "left", 8, 90), FONT_2)
            .DrawText("Nac.", STR_PARAM(70, 285, 28, "left", 8, 90), FONT_2)
            .DrawText("Sexo", STR_PARAM(70, 315, 28, "left", 8, 90), FONT_2)
            .DrawText("Fecha.", STR_PARAM(70, 345, 38, "left", 8, 90), FONT_2)
            .DrawText("Previsión", STR_PARAM(70, 385, 43, "left", 8, 90), FONT_2)
            .DrawText("Lugar TM", STR_PARAM(70, 430, 58, "left", 8, 90), FONT_2)
            .DrawText("Programa", STR_PARAM(70, 490, 53, "left", 8, 90), FONT_2)
            .DrawText("SubProg", STR_PARAM(70, 545, 43, "left", 8, 90), FONT_2)
            .DrawText("Examen", STR_PARAM(70, 590, 73, "left", 8, 90), FONT_2)
            .DrawText("Determinación", STR_PARAM(70, 665, 68, "left", 8, 90), FONT_2)
            .DrawText("Resultado", STR_PARAM(70, 735, 48, "left", 8, 90), FONT_2)

            For z = 0 To Data_Prev.Count - 1

                If contador_filas < 31 Then

                    .DrawText(contador_filas, STR_PARAM(eje_y, 20, 23, "left", 6, 90), FONT_2)
                    .DrawText(Data_Prev(z).ATE_NUM, STR_PARAM(eje_y, 45, 23, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).PAC_NOMBRE & " " & Data_Prev(z).PAC_APELLIDO, STR_PARAM(eje_y, 70, 103, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).PAC_RUT, STR_PARAM(eje_y, 175, 43, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).DNI, STR_PARAM(eje_y, 175, 43, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).FECHA_NAC.Substring(0, 10), STR_PARAM(eje_y, 220, 33, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).ATE_AÑO & " Años", STR_PARAM(eje_y, 255, 28, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).NACIONALIDAD, STR_PARAM(eje_y, 285, 28, "left", 6, 90), FONT_1)
                    Dim Sx As String
                    If Data_Prev(z).SEXO_DESC = "Femenino" Then
                        Sx = "F"
                    Else
                        Sx = "M"
                    End If
                    .DrawText(Sx, STR_PARAM(eje_y, 310, 28, "center", 6, 90), FONT_1)
                    .DrawText(Format(Data_Prev(z).ATE_FECHA, "dd/MM/yyyy hh:mm"), STR_PARAM(eje_y, 345, 38, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).PREVISION, STR_PARAM(eje_y, 385, 43, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).PROC_DESC, STR_PARAM(eje_y, 430, 58, "left", 6, 90), FONT_1)
                    Dim Prog As String
                    If Data_Prev(z).PROGRAMA = "<Sin Programa>" Then
                        Prog = "Sin Prog."
                    Else
                        Prog = Data_Prev(z).PROGRAMA
                    End If
                    .DrawText(Prog, STR_PARAM(eje_y, 490, 53, "left", 6, 90), FONT_1)
                    Dim SProg As String
                    If Data_Prev(z).SUBPROGRAMA = "<Sin SubPrograma>" Then
                        SProg = "Sin SubProg."
                    Else
                        SProg = Data_Prev(z).SUBPROGRAMA
                    End If
                    .DrawText(SProg, STR_PARAM(eje_y, 545, 43, "left", 6, 90), FONT_1)
                    Dim Sect As String
                    If Data_Prev(z).SECTOR = "<SIN SECTOR>" Then
                        Sect = "Sin Sec."
                    Else
                        Sect = Data_Prev(z).SECTOR
                    End If
                    .DrawText(Data_Prev(z).CF_DESC, STR_PARAM(eje_y, 590, 73, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).DETER, STR_PARAM(eje_y, 665, 68, "left", 6, 90), FONT_1)
                    .DrawText(Data_Prev(z).RESULTADO, STR_PARAM(eje_y, 735, 48, "left", 6, 90), FONT_1)
                    '.DrawText(Data_Prev(z).MEDICO_SOLICITANTE & " " & Data_Prev(z).MEDICO_SOLICITANTE_2, STR_PARAM(eje_y, 680, 100, "left", 6, 90), FONT_1)
                ...
                Else
                    ...
                    With fuck.Canvas
                        ...
                        If xxx = 1 Then
                            .DrawText("#", STR_PARAM(25, 20, 23, "left", 8, 90), FONT_2)
                            .DrawText("Folio", STR_PARAM(25, 45, 23, "left", 8, 90), FONT_2)
                            .DrawText("Nombre Paciente", STR_PARAM(25, 70, 103, "left", 8, 90), FONT_2)
                            .DrawText("RUT/DNI", STR_PARAM(25, 175, 43, "left", 8, 90), FONT_2)
                            .DrawText("F. Nac.", STR_PARAM(25, 220, 33, "left", 8, 90), FONT_2)
                            .DrawText("Edad", STR_PARAM(25, 255, 28, "left", 8, 90), FONT_2)
                            .DrawText("Nac.", STR_PARAM(25, 285, 28, "left", 8, 90), FONT_2)
                            .DrawText("Sexo", STR_PARAM(25, 315, 28, "left", 8, 90), FONT_2)
                            .DrawText("Fecha.", STR_PARAM(25, 345, 38, "left", 8, 90), FONT_2)
                            .DrawText("Previsión", STR_PARAM(25, 385, 43, "left", 8, 90), FONT_2)
                            .DrawText("Lugar TM", STR_PARAM(25, 430, 58, "left", 8, 90), FONT_2)
                            .DrawText("Programa", STR_PARAM(25, 490, 53, "left", 8, 90), FONT_2)
                            .DrawText("SubProg", STR_PARAM(25, 545, 43, "left", 8, 90), FONT_2)
                            .DrawText("Examen", STR_PARAM(25, 590, 73, "left", 8, 90), FONT_2)
                            .DrawText("Determinación", STR_PARAM(25, 665, 68, "left", 8, 90), FONT_2)
                            .DrawText("Resultado", STR_PARAM(25, 735, 48, "left", 8, 90), FONT_2)
                            xxx = 0
                        End If
