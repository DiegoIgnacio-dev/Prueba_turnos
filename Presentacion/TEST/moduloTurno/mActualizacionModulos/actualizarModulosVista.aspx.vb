...
Public Class visorModulosVista
    ...
    Public Shared Function Busca_Modulos() As List(Of E_DATA_MODULOS) 'crear mi propia E_DATA_TURNO
    ...
    End Function
    <Services.WebMethod()> 'Funciones con etiquetas de servicio tipo WebMethod
    Public Shared Function Busca_Modulos_Por_ID(ByVal ID_TURNO As Integer) As List(Of E_DATA_MODULOS) 'crear mi propia E_DATA_TURNO
        'Funcion publica compartida que recibe parametros declarados con su tipo de dato y devuelve una lista de entidad
        ...
        Return Instancia_Negocio.IRIS_WEBF_BUSCA_MODULOS_POR_ID(ID_TURNO)
    End Function
