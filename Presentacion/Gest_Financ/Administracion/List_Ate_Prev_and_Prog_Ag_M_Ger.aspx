<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="List_Ate_Prev_and_Prog_Ag_M_Ger.aspx.vb" Inherits="Presentacion.List_Ate_Prev_and_Prog_Ag_M_Ger" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function AJAX_Ddl_Prev() {
            ...
            $.ajax({
                "type": "POST",
                "url": "List_Ate_Prev_and_Prog_Ag_M_Ger.aspx/Llenar_Ddl_Prev",
                //"data": '{}',
        ...
        function AJAX_Ddl_Prog() {
            ...
            $.ajax({
                "type": "POST",
                "url": "List_Ate_Prev_and_Prog_Ag_M_Ger.aspx/Llenar_Ddl_Prog",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_Ddl_Prog_Alt() {
            ...
            $.ajax({
                "type": "POST",
                "url": "List_Ate_Prev_and_Prog_Ag_M_Ger.aspx/Llenar_Ddl_Prog_Alt",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "List_Ate_Prev_and_Prog_Ag_M_Ger.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "List_Ate_Prev_and_Prog_Ag_M_Ger.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
