Imports Entidades
Imports Negocio
Public Class Resumen_Prev_Prog_Subp_Scr
    ...
    End Sub
    <Services.WebMethod()>
    Public Shared Function Call_User_Data(ByVal ID_USER As Integer) As List(Of E_IRIS_WEBF_CMVM_BUSCA_USUARIO_DETALLE)
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String,
        ...
        Data_DTT = NN_DTT.IRIS_WEBF_BUSCA_RESUMEN_PREVE_PROG_SUBP_2_SCR(DESDE, HASTA, PROC, PREV, 0, 0, ID_USER)
    ...
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String,
        ...
        Return NN_Prev.Gen_Excel_scr(DOMAIN_URL, DESDE, HASTA, PROC, PREV, 0, 0, ID_USER)
    End Function
    <Services.WebMethod()>
