...
Public Class N_IRIS_WEBF_GRABA_PACIENTE_ATENCION
    ...
    Function IRIS_WEBF_GRABA_PACIENTE_ATENCION(ByVal RUT_PAC As String,
        ...
        Return DD_Data.IRIS_WEBF_GRABA_PACIENTE_ATENCION(RUT_PAC, NOMBRE_PAC, APE_PAC, FNAC_PAC, ID_SEXO, ID_NACIONALIDAD, FONO1, MOVIL1, ID_CIU_COM, DIR_PAC, EMAIL_PAC, ID_DIAGNOSTICO, OBS_PER, ID_ESTADO, dni)
    End Function
End Class