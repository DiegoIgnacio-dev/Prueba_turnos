Imports Entidades
Imports Negocio
Public Class Det_Proc_Prev_Prog_Scr_2
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable(ByVal PROG As Integer) As List(Of E_IRIS_WEBF_BUSCA_DETALLE_PREVE_PROG_SUBP)
        'Declaraciones internas
        ...
        Data_DTT = NN_DTT.IRIS_WEBF_BUSCA_DETALLE_PREVE_PROG_SUBP_2_SCR_2(PROG)
    ...
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String,
        ...
        Return NN_Prev.Gen_Excel_2(DOMAIN_URL, PROG)
    End Function
End Class