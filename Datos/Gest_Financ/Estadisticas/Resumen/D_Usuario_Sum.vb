...
Public Class D_Usuario_Sum
    ...
    Function IRIS_WEBF_BUSCA_USUARIO3() As List(Of E_IRIS_WEBF_BUSCA_USUARIO3)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_USUARIO3"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Conectar con la base de datos
        Select Case CC_ConnBD.Oledbconexion.State
    ...
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_USUARIO(ByVal ID_USUARIO As Integer, ByVal Date_01 As Date, ByVal Date_02 As Date) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_USUARIO)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_USUARIO"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
    ...
    End Function
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_USUARIO_2(ByVal ID_USUARIO As Integer, ByVal MES As String, ByVal AÑO As String) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_USUARIO)
        'Declaraciones SQL
        CC_ConnBD = New C_ConnBD
        Dim Obj_Reader As OleDbDataReader
        Dim Cmd_SQL As New OleDb.OleDbCommand
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_USUARIO_2"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@ID_PRE", OleDbType.BigInt).Value = ID_USUARIO
            .Add("@MES", OleDbType.VarChar).Value = MES
    ...
    Function IRIS_WEBF_CMVM_BUSCA_USUARIO2_BOL() As List(Of E_IRIS_WEBF_BUSCA_USUARIO2)
        'Declaraciones SQL
        CC_ConnBD = New C_ConnBD
        Dim Obj_Reader As OleDbDataReader
        Dim Cmd_SQL As New OleDb.OleDbCommand
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_USUARIO2_BOL"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Conectar con la base de datos
        Select Case CC_ConnBD.Oledbconexion.State
