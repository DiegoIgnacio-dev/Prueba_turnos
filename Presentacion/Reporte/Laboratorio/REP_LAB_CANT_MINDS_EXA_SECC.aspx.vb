...
Public Class REP_LAB_CANT_MINDS_EXA_SECC
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable(ByVal ID_SECC As Long, ByVal DATE_str01 As String, ByVal DATE_str02 As String, ByVal VALOR As Integer) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datos As String = ""
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String, ByVal ID_SECC As Long, ByVal DATE_str01 As String, ByVal DATE_str02 As String, ByVal VALOR As Integer) As String
        Dim NN_Med As New N_REP_LAB_CANT_EXA_SECC
        Return NN_Med.Gen_Excel_Minds(DOMAIN_URL, ID_SECC, DATE_str01, DATE_str02, VALOR)
    End Function
