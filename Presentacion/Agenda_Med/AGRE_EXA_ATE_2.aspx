<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="AGRE_EXA_ATE_2.aspx.vb" Inherits="Presentacion.AGRE_EXA_ATE_2" %>
        ...
        var Mx_examenes_OMI = [
{
    ...
    "CF_AVIS": 0,
        ...
        function Ajax_Examens_OMI() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AGRE_EXA_ATE_2.aspx/IRIS_WEBF_BUSCA_examenes_paciente",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_modal_exa() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AGRE_EXA_ATE_2.aspx/MODAL_PAC",
                "data": Data_Par_modal,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Ajax_modal_exa_RUT() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AGRE_EXA_ATE_2.aspx/MODAL_PAC_RUT",
                "data": Data_Par_modal,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": Data_Par_modal_paciente => {
        ...
        var Mx_DL_Diag = [
{
    ...
    "DIA_HOST_AVIS": 0
        ...
        function Ajax_guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AGRE_EXA_ATE_2.aspx/Guardar_TodoByVal",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_orden_ate = [
 {
    ...
    <script>
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "AGRE_EXA_ATE_2.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
