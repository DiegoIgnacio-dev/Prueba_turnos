...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="card border-bar">
        <div class="card-header bg-bar text-center">
            <h5 class="m-0 float-left">Gráfico de Atención</h5>
            <a class="btn btn-sm btn-success float-right" href="/Gest_Financ/Gest_Graphics.aspx">
                <span>Gráficos Resumen</span>
            </a>
        </div>
        <div class="card-body">
