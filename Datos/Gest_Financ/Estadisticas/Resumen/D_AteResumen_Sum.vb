...
Public Class D_AteResumen_Sum
    ...
    Function IRIS_WEBF_BUSCA_EST_EXAMENES_RESULTADOS2(ByVal ID_TM As Long, ByVal ID_PREVE As Long, ByVal ID_PRG As Long, ByVal ID_SUB As Long, ByVal Date_01 As Date,
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_EXAMENES_RESULTADOS2"
    ...
    Function IRIS_WEBF_BUSCA_EST_EXAMENES_RESULTADOS3(ByVal ID_TM As Long, ByVal ID_PREVE As Long, ByVal ID_PRG As Long, ByVal ID_SUB As Long, ByVal Date_01 As Date,
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_EXAMENES_RESULTADOS3"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
        ...
        While Obj_Reader.Read
            ...
            E_Prev_Item.ATE_OMI = DD_Gen.DB_NULL(Obj_Reader, 24, "")
            E_Prev_Item.SEXO_DESC = DD_Gen.DB_NULL(Obj_Reader, 25, "")
            E_Prev_Item.SECTOR_DESC = DD_Gen.DB_NULL(Obj_Reader, 26, "")
