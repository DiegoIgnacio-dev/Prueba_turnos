...
Public Class D_IRIS_WEBF_BUSCA_EST_PREVISION_POR_ID_PREVISION_DIALISIS
    ...
    Function IRIS_WEBF_BUSCA_EST_PREVISION_POR_ID_PREVISION_DIALISIS(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_PRE As Integer) As List(Of E_IRIS_WEBF_BUSCA_EST_PREVISION_POR_ID_PREVISION_DIALISIS)
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_PREVISION_POR_ID_PREVISION_DIALISIS"
    ...
    Function IRIS_WEBF_BUSCA_EST_PREVISION_POR_ID_PREVISION_DIALISIS_2(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_PROC As Integer, ByVal AÑO As Long) As List(Of E_IRIS_WEBF_BUSCA_EST_PREVISION_POR_ID_PREVISION_DIALISIS)
        'Declaraciones
        CC_ConnBD = New C_ConnBD
        Dim Obj_Reader As OleDbDataReader
        Dim Cmd_SQL As New OleDb.OleDbCommand
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_PREVISION_POR_ID_PREVISION_DIALISIS_3"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        ...
        With Cmd_SQL.Parameters
            ...
            .Add("@ID_AÑO", OleDbType.Numeric).Value = AÑO
        End With
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.ATE_ANO = DD_GEN.DB_NULL(Obj_Reader, 7, "")
            E_Proc_Item.ATE_MES = DD_GEN.DB_NULL(Obj_Reader, 8, "")
            E_Proc_Item.ATE_DIA = DD_GEN.DB_NULL(Obj_Reader, 9, "")
            E_Proc_Item.SEXO_DESC = DD_GEN.DB_NULL(Obj_Reader, 10, "")
            E_Proc_Item.PROC_DESC = DD_GEN.DB_NULL(Obj_Reader, 11, "")
            E_Proc_Item.PAC_FNAC = DD_GEN.DB_NULL(Obj_Reader, 12, New Date)
            E_Proc_Item.ID_PRUEBA = DD_GEN.DB_NULL(Obj_Reader, 13, "")
            E_Proc_Item.ATE_RESULTADO = DD_GEN.DB_NULL(Obj_Reader, 14, "")
            E_Proc_Item.ATE_RESULTADO_NUM = DD_GEN.DB_NULL(Obj_Reader, 15, "")
            'Agregar items a la lista
            E_Proc_List.Add(E_Proc_Item)
        End While
