<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="InCo_Ord.aspx.vb" Inherits="Presentacion.InCo_Ord" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script>
        ...
        function Llenar_Ddl_Ord() {
            //Debug
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_Ord.aspx/Llenar_Ddl_Ord",
                //"data": Data_Par,
        ...
        function Fill_Ddl_Ord() {
            ...
            ).text("Todos").appendTo("#Slt_Ord");
            Mx_Ddl_Ord.forEach(aaa => {
                $("<option>",
                    {
                        "value": aaa.ID_ORDEN
                    }
                ).text(aaa.ORD_DESC).appendTo("#Slt_Ord");
            });
        }
        ...
        function Ajax_Datatable() {
            ...
            let Data_Par = JSON.stringify({
                "DESDE": $("#fecha").val(),
                "HASTA": $("#fecha2").val(),
                "ID_ORDEN": $("#Slt_Ord").val()
            });
            //Debug
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_Ord.aspx/IRIS_WEBF_BUSCA_LIS_ADM_ORD",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Ajax_Excel() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "HASTA": $("#fecha2").val(),
                "ID_ORDEN": $("#Slt_Ord").val(),
                "ORDEN_DESC": $("#Slt_Ord option:selected").text()
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card border-bar">
        <div class="card-header bg-bar">
            <h5 class="m-1">Ingreso vs Costos por Orden de Atención
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg">
                    <label for="Slt_Ord">Orden:</label>
                    <select id="Slt_Ord" class="form-control"></select>
                </div>
                <div class="col-lg">
                    <br />
