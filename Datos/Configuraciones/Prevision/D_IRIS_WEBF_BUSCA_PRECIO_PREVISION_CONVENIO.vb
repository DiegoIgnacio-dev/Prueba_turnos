...
Public Class D_IRIS_WEBF_BUSCA_PRECIO_PREVISION_CONVENIO
    ...
    Function IRIS_WEBF_BUSCA_PRECIO_PREVISION_CONVENIO(ByVal ID_AÑO As String, ByVal ID_PREVI As String) As List(Of E_IRIS_WEBF_BUSCA_PRECIO_PREVISION_CONVENIO)
        ...
        Cmd_command.CommandText = "IRIS_WEBF_CMVM_BUSCA_PRECIO_PREVISION_CONVENIO"
        ...
        Return List_Reader
    End Function
    Function IRIS_WEBF_BUSCA_PRECIO_PREVISION_CONVENIO_BONIFICACION(ByVal ID_AÑO As String, ByVal ID_PREVI As String) As List(Of E_IRIS_WEBF_BUSCA_PRECIO_PREVISION_CONVENIO)
        'Configuración general
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_CMVM_BUSCA_PRECIO_PREVISION_CONVENIO_BONIFICACION"
        Cmd_command.Connection = objconexion.Connect_to_IrisLab_LoBarnechea
        With Cmd_command.Parameters
            .Add("@ID_AÑO", OleDbType.Integer).Value = Convert.ToInt32(ID_AÑO)
            .Add("@ID_PREVI", OleDbType.Integer).Value = Convert.ToInt32(ID_PREVI)
