...
Public Class N_Examenes_Sum
    ...
    End Function
    Function IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS(ByVal ID_CODIGO_FONASA As Long, ByVal DESDE As Date,
                                                        ByVal HASTA As Date, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES)
        Return DD_Examenes.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS(ID_CODIGO_FONASA, DESDE, HASTA, PROCEDENCIA)

    End Function
    Function IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_TODOS(ByVal ID_CODIGO_FONASA As Long, ByVal DESDE As Date,
                                                        ByVal HASTA As Date, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES)
        Return DD_Examenes.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_TODOS(ID_CODIGO_FONASA, DESDE, HASTA, PROCEDENCIA)

    End Function
    Function IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS_REVISADOS(ByVal ID_CODIGO_FONASA As Long, ByVal DESDE As Date,
                                                        ByVal HASTA As Date, ByVal PROCEDENCIA As Integer) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES)
        Return DD_Examenes.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS_REVISADOS(ID_CODIGO_FONASA, DESDE, HASTA, PROCEDENCIA)

    End Function
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_PROVEE_2(ByVal DESDE As Date,
                                                        ByVal HASTA As Date,
                                                                 ByVal ID_CF As Integer) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES)
        Return DD_Examenes.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_PROVEE_2(DESDE, HASTA, ID_CF)

    End Function
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_TODOS(ByVal DESDE As Date,
                                                        ByVal HASTA As Date,
                                                                 ByVal ID_CF As Integer, ByVal cookie_proc As Integer) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES)
        Return DD_Examenes.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_TODOS(DESDE, HASTA, ID_CF, cookie_proc)

    End Function
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS(ByVal DESDE As Date,
                                                        ByVal HASTA As Date,
                                                                 ByVal ID_CF As Integer, ByVal cookie_proc As Integer) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES)
        Return DD_Examenes.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS(DESDE, HASTA, ID_CF, cookie_proc)

    End Function
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS_REVISADOS(ByVal DESDE As Date,
                                                        ByVal HASTA As Date,
                                                                 ByVal ID_CF As Integer, ByVal cookie_proc As Integer) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES)
        Return DD_Examenes.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS_REVISADOS(DESDE, HASTA, ID_CF, cookie_proc)
