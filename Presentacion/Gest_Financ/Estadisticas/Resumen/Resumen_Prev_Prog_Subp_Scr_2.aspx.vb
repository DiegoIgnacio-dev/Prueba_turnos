Imports Entidades
Imports Negocio
Public Class Resumen_Prev_Prog_Subp_Scr_2
    ...
    Public Shared Function PDFF(ByVal DOMAIN_URL As String,
        ...
        link = NN_pdf.PDFF_2(DOMAIN_URL, DESDE, HASTA, PROC, PREV, 0, 0, ID_USER)
        Return link
    End Function
    ...
    <Services.WebMethod()>
    Public Shared Function PDFF_by_Exam(ByVal DOMAIN_URL As String,
                                     ByVal DESDE As String,
                                            ByVal HASTA As String,
                                            ByVal PROC As Integer,
                                            ByVal PREV As Integer,
        ...
        link = NN_pdf.PDFF_2_by_Exam(DOMAIN_URL, DESDE, HASTA, PROC, PREV, 0, 0, ID_USER)
        Return link
    End Function
    <Services.WebMethod()>
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable_by_Exam(ByVal DESDE As String,
                                            ByVal HASTA As String,
                                            ByVal PROC As Integer,
                                            ByVal PREV As Integer,
                                            ByVal PROG As Integer,
    ...
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String,
        ...
        Return NN_Prev.Gen_Excel_scr_2(DOMAIN_URL, DESDE, HASTA, PROC, PREV, 0, 0, ID_USER)
    End Function

    <Services.WebMethod()>
    Public Shared Function Gen_Excel_by_Exam(ByVal DOMAIN_URL As String,
                                     ByVal DESDE As String,
                                     ByVal HASTA As String,
                                     ByVal PROC As Integer,
                                     ByVal PREV As Integer,
                                     ...
                                     ByVal ID_USER As Integer) As String
        Dim NN_Prev As New N_IRIS_WEBF_BUSCA_RESUMEN_PREVE_PROG_SUBP
        Return NN_Prev.Gen_Excel_scr_2_by_Exam(DOMAIN_URL, DESDE, HASTA, PROC, PREV, 0, 0, ID_USER)
    End Function
    <Services.WebMethod()>
