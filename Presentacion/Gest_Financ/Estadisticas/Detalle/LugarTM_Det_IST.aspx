<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="LugarTM_Det_IST.aspx.vb" Inherits="Presentacion.LugarTM_Det_IST" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function AJAX_Ddl_Prev() {
            ...
            $.ajax({
                "type": "POST",
                "url": "LugarTM_Det_IST.aspx/Llenar_Ddl",
                //"data": '{}',
        ...
        function AJAX_Ddl_Proc() {
            ...
            $.ajax({
                "type": "POST",
                "url": "LugarTM_Det_IST.aspx/Llenar_Ddl_Proce",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_Ddl_Pago() {
            ...
            $.ajax({
                "type": "POST",
                "url": "LugarTM_Det_IST.aspx/Llenar_Ddl_T_Pago",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            function getEdad(txt_str) {
                ...
                if ($re.isNumeric(numIn) == true) {
                    ...
                    $("#mdlNotif .modal-header h4").text("Error");
                    $("#mdlNotif .modal-body p").html("Debe de colocar un valor numérico. Se reemplazará el valor por cero.");
                    $("#mdlNotif").modal();
            ...
            $.ajax({
                "type": "POST",
                "url": "LugarTM_Det_IST.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_Excel_Async() {
            ...
            $.ajax({
                "type": "POST",
                "url": "LugarTM_Det_IST.aspx/Gen_Excel_Async",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "LugarTM_Det_IST.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        //cModal_Notif("Archivo Generado", str_Download);
                        Hide_Modal();
                        $("#mdlNotif .modal-header h4").text("Descargar Excel");
                        $("#mdlNotif .modal-body p").html(str_Download);
                        $("#mdlNotif").modal();
    ...
    <script>
        ...
        function Fill_Ddl_Prev() {
            ...
            $("<option>", { "value": 260 }).text("IST").appendTo("#Ddl_Prev");
            $("<option>", { "value": 265 }).text("IST-2").appendTo("#Ddl_Prev");
        };
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="card mb-3 border-bar">
        <div class="card-header bg-bar p-2">
            <h5>Pacientes, Exámenes y precios por previsión y lugar de Tm</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <!--DatePicker-->
