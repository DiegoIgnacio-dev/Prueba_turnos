...
Public Class Ana_PROVEE_Prev
    Inherits System.Web.UI.Page
    <Services.WebMethod()>
    Public Shared Function PDFF_4(ByVal MAIN_URL As String, ByVal Dll As String, ByVal Año As String, ByVal ID_CF As Integer, ByVal CF_DESC As String) As String
        ...
        link = NN_pdf.PDFF_4_PROVEE(MAIN_URL, Dll, Año, ID_CF, CF_DESC)
        Return link
    End Function
    <Services.WebMethod()>
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable(ByVal Dll As Integer, ByVal Año As String, ByVal ID_CF As Integer) As List(Of E_GraficoVisor_Json)
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        'Declaraciones internas
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Gen_Excel(ByVal MAIN_URL As String, ByVal Dll As String, ByVal Año As String, ByVal ID_CF As Integer, ByVal CF_DESC As String) As String
        Dim NN_Grafico_Ate As New N_AnaPrev
        Return NN_Grafico_Ate.Gen_Excel_2_PROVEE(MAIN_URL, Dll, Año, ID_CF, CF_DESC)
    End Function
