<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master_MINDS.Master" CodeBehind="REP_LAB_CANT_MINDS_EXA_TOT.aspx.vb" Inherits="Presentacion.REP_LAB_CANT_MINDS_EXA_TOT" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl_Proce() {
            ...
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_MINDS_EXA_TOT.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_MINDS_EXA_TOT.aspx/Llenar_Ddl",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_MINDS_EXA_TOT.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_MINDS_EXA_TOT.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
