...
Public Class Ver_Orden
    ...
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable(ByVal ID_ATENCION As Long) As E_IRIS_WEBF_CMVM_BUSCA_ATE_PAC_DIA_2
        ...
        Data_Estado_Mant = NN_Estado_Mant.IRIS_WEBF_CMVM_BUSCA_ATE_PAC_SCAN(ID_ATENCION)
