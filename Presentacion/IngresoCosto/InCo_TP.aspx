<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="InCo_TP.aspx.vb" Inherits="Presentacion.InCo_TP" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script>
        ...
        function Llenar_Ddl_TP() {
            //Debug
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_TP.aspx/Llenar_Ddl_TP",
                //"data": Data_Par,
        ...
        function Fill_Ddl_TP() {
            ...
            ).text("Todos").appendTo("#Slt_TP");
            Mx_Ddl_TP.forEach(aaa => {
                $("<option>",
                    {
                        "value": aaa.ID_TP_PAGO
                    }
                ).text(aaa.TP_PAGO_DESC).appendTo("#Slt_TP");
            });
        }
        ...
        function Ajax_Datatable() {
            ...
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_TP.aspx/IRIS_WEBF_BUSCA_LIS_ADM_TP",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Ajax_Excel() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "HASTA": $("#fecha2").val(),
                "ID_TP": $("#Slt_TP").val(),
                "TP_DESC": $("#Slt_TP option:selected").text()
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card border-bar">
        <div class="card-header bg-bar">
            <h5 class="m-1">Ingreso vs Costos por Forma de Pago
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg">
                    <label for="Slt_TP">Forma Pago:</label>
                    <select id="Slt_TP" class="form-control"></select>
                </div>
                <div class="col-lg">
                    <br />
