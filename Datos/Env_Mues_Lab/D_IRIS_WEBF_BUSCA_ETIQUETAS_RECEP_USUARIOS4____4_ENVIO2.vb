...
Public Class D_IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2
    ...
    Function IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2(ByVal ID_USU As Integer) As List(Of E_IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2)
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2"
    ...
    Function IRIS_WEBF_CMVM_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2_CON_PENDIENTES(ByVal ID_USU As Integer) As List(Of E_IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2_CON_PENDIENTES"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.ATE_NUM_OMI = DD_GEN.DB_NULL(Obj_Reader, 15, Nothing)
            E_Proc_Item.ATE_CODIGO_TEST = DD_GEN.DB_NULL(Obj_Reader, 16, Nothing)
    ...
    Function IRIS_WEBF_CMVM_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2_CON_PENDIENTES_666(ByVal ID_USU As Integer) As List(Of E_IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2_CON_PENDIENTES_666"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
