...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script src="Impr_Etiq.js"></script>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-4 col-md-6">
                        <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#mdlSearch">
                            <i class="fa fa-search" aria-hidden="true"></i>
                            <span>Buscar</span>
                        </button>
                    </div>
                    <div class="col-12 col-sm-8 col-md-6 div-button">
                        <button type="button" class="btn btn-danger mb-3" id="Btn_Print">
                            <i class="fa fa-print" aria-hidden="true"></i>
                            <span>Imprimir</span>
                        </button>
                        <button type="button" class="btn btn-success mb-3" id="Btn_Export">
                    ...
                    <div class="col-12 table-responsive" id="divTable">
                        <div class="alert alert-info mb-0">
                            <span>Ingrese un número de Atención para realizar la búsqueda.</span>
                        </div>
                    </div>
                    <div class="col-6">
