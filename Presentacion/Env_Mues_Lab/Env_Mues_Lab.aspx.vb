...
Public Class Env_Mues_Lab
    ...
    <Services.WebMethod()>
    Public Shared Function Form_Table() As E_List_wDict3
        ...
        Dim data_paciente As E_List_wDict3
        ...
        data_paciente = NN.IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_ENVIO2(ID_USER)
        data_paciente3 = NN3.IRIS_WEBF_BUSCA_USUARIO_TM_GRILLA(ID_USER)

        For i = 0 To data_paciente.List_Data.Count - 1
            data_paciente.List_Data(i).USU_NIC = data_paciente3(0).USU_NIC
        Next i
