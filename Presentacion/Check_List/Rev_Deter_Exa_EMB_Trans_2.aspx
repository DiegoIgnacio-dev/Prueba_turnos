<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Rev_Deter_Exa_EMB_Trans_2.aspx.vb" Inherits="Presentacion.Rev_Deter_Exa_EMB_Trans_2" %>
        ...
        var Mx_Ddl = [
{
    ...
    "ID_ESTADO": ""
        ...
        function Call_AJAX_Ddl() {
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB_Trans_2.aspx/Llenar_Ddl_LugarTM",
                //"data": '{}',
        ...
        var Mx_Dtt_previ = [
    {
        ...
        function Ajax_previ() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB_Trans_2.aspx/Llenar_DdL_prevision",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function fn_Req_Prev() {
            ...
            objAJAX_Prev = $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB_Trans_2.aspx/Request_Prevision",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function fn_Req_Prog() {
            ...
            objAJAX_Prog = $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB_Trans_2.aspx/Request_Programa",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function fn_Req_SubP() {
            ...
            objAJAX_SubP = $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB_Trans_2.aspx/Request_SubPrograma",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB_Trans_2.aspx/Llenar_Ddl_Exam",
                "data": JSON.stringify({
                    ID_PREV: $("#Ddl_previ").val()
                }),
                "contentType": "application/json;  charset=utf-8",
        ...
        var Mx_Dtt_Det = [
    {
        ...
        function Ajax_Det() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB_Trans_2.aspx/Llenar_Ddl_Det",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB_Trans_2.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB_Trans_2.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB_Trans_2.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "textoReducido text-center" }).text("Cf Cod"),
                    $("<th>", { "class": "textoReducido text-center" }).text("Descrión"),
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                ...
                $("#DataTable tbody").append(
                    $("<tr>", {
                        ...
                        $("<td>").css("text-align", "center").text(Mx_Dtt[i].CF_COD),
                        $("<td>").css("text-align", "center").text(Mx_Dtt[i].CF_DESC),
                        $("<td>").css("text-align", "center").text(Mx_Dtt[i].TOTAL)
                    )
                );
                toti += Mx_Dtt[i].TOTAL;
            }
            ...
            $("#DataTable tbody").append(
                    ...
                    $("<tr>", {
                        ...
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(""),
                        $("<td>").css("text-align", "center").text(""),
                        $("<td>", { "class": "darkkk" }).css("text-align", "center").text(""),
                        $("<td>", { "class": "darkkk" }).css("text-align", "center").text("TOTAL: " + toti)
                    )
                );
            ...
            <div class="card mb-3 border-bar">
                <div class="card-header bg-bar">
                    <h5 style="text-align: center; padding: 5px;">
                        ...
                        Listado de Resultados por Determinaciones (Resumen)
                    </h5>
                </div>
