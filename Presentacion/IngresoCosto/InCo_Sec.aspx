<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="InCo_Sec.aspx.vb" Inherits="Presentacion.InCo_Sec" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script>
        ...
        function Llenar_Ddl_Sec() {
            //Debug
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_Sec.aspx/Llenar_Ddl_Sec",
                //"data": Data_Par,
        ...
        function Fill_Ddl_Sec() {
            ...
            ).text("Todos").appendTo("#Slt_Sec");
            Mx_Ddl_Sec.forEach(aaa => {
                $("<option>",
                    {
                        "value": aaa.ID_SECCION
                    }
                ).text(aaa.SECC_DESC).appendTo("#Slt_Sec");
            });
        }
        ...
        function Ajax_Datatable() {
            ...
            let Data_Par = JSON.stringify({
                "DESDE": $("#fecha").val(),
                "HASTA": $("#fecha2").val(),
                "ID_SECCION": $("#Slt_Sec").val()
            });
            //Debug
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_Sec.aspx/IRIS_WEBF_BUSCA_LIS_ADM_SECCION",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Ajax_Excel() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "HASTA": $("#fecha2").val(),
                "ID_SECCION": $("#Slt_Sec").val(),
                "SEC_DESC": $("#Slt_Sec option:selected").text()
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card border-bar">
        <div class="card-header bg-bar">
            <h5 class="m-1">Ingreso vs Costos por Sección
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg">
                    ...
                    <select id="Slt_Sec" class="form-control"></select>
                </div>
                <div class="col-lg">
                    <br />
