        ...
        var Mx_Dtt_Atencion_Asereje = [
{
    ...
    "ID_PACIENTE": 0
        ...
        function Ajax_Marcar_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES_2.aspx/Llenar_DataTable_Marcar",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
            ...
            for (i = 0; i < Mx_Dtt_Load.length; i++) {
                $("#DataTable_Load tbody").append(
                    $("<tr>", {
                        ...
                        $("<td>").css("text-align", "center").text(function () {
                            $(this).html("<div class='checkbox checkbox-success pz' style='margin-top:-19px;'><input type='checkbox' value='" + Mx_Dtt_Load[i].CB_DESC + "~" + Mx_Dtt_Load[i].ATE_NUM + "~" + Mx_Dtt_Load[i].ATE_NUM_OMI + "~" + Mx_Dtt_Load[i].ATE_CODIGO_TEST + "~" + Mx_Dtt_Load[i].ID_ATENCION + "~" + Mx_Dtt_Load[i].ID_CODIGO_FONASA + "~" + Mx_Dtt_Load[i].CF_DESC + "~" + Mx_Dtt_Load[i].ATE_CF_MULTIPLICADOS + "' class='manitos2' id='Hasdasd" + i + "'/><label class='manitos2' for='Hasdasd" + i + "'></label></div>")
                        })
                    )
                );
            }
