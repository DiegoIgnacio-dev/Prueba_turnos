...
Public Class D_IRIS_WEBF_UPDATE_CONF_DIAS_EXAMEN
    Function D_IRIS_WEBF_UPDATE_CONF_DIAS_EXAMEN(ByVal ID_CONF As Integer, ByVal CANTIDAD As String, ByVal ID_ESTADO As Integer) As Integer
        ...
        Cmd_command.CommandText = "IRIS_WEBF_CMVM_UPDATE_CONF_DIAS_EXAMEN"
        ...
        Return Read_Sql
    End Function
    Function IRIS_WEBF_UPDATE_CONF_DIAS_EXAMEN_NEW(ByVal ID_CONF As Integer, ByVal CANTIDAD As String, ByVal ID_ESTADO As Integer, ByVal normal As String, ByVal prioritario As String, ByVal espontaneo As String) As Integer
        Dim objconexion As New Conexion.ConexionBD
        Dim Cmd_command As New OleDb.OleDbCommand
        Dim Read_Sql As Integer
        'definiendo tipo de consulta a la BD
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_CMVM_UPDATE_CONF_DIAS_EXAMEN_NEW_2"
        Cmd_command.Connection = objconexion.Connect_to_IrisLab_LoBarnechea
        'Enviar parámetros
        With Cmd_command.Parameters
            .Add("@ID_CONF", OleDbType.Numeric).Value = Convert.ToInt32(ID_CONF)
