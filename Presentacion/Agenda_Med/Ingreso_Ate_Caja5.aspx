<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Ingreso_Ate_Caja5.aspx.vb" Inherits="Presentacion.Ingreso_Ate_Caja5" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script src="../js/Deep-Copy.js"></script>
    <script src="Ingreso_Ate_Caja5.js"></script>
...
<%--        <!-- modal Datos Extras -->
    ...
    <div id="MOdal_PAGO" class="modal fade" role="dialog">
        ...
        <!-- Modal Imed-->
    <div id="Modal_Imed" class="modal fade" role="dialog">
        <div class="modal-dialog ml-xl-auto">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <%--<button type="button" class="close" data-dismiss="modal">&times;</button>--%>
                    <h4 class="modal-title">Venta por Interfaz</h4>
                </div>
                <div class="modal-body">
                    <p> Estimado Usuario: ¿Desea Recibir Archivo Imed?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                    <button id="btn_Imed_Modal" type="button" class="btn btn-success" data-dismiss="modal">Recibir</button>
                </div>
            </div>
        </div>
    </div>
  ...
  <div id="xxx_xxx">
    ...
    <div id="mError_AAH" class="modal fade" role="dialog">
        ...
        <!-- Modal Imed-->
    <div id="mError_AAH_Imed" class="modal fade" role="dialog">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <%--<button type="button" class="close" data-dismiss="modal">&times;</button>--%>
                    <h4 id="title_Imed" class="modal-title">Error</h4>
                </div>
                <div class="modal-body">
                    <p></p>
                </div>
                <div class="modal-footer">
                    <button type="button" id="button_modal_Imed" class="btn btn-danger" data-dismiss="modal">
                        <span>Aceptar</span>
                    </button>
            ...
            <!-- Modal Imed Proceso-->
    <div id="mError_AAH_Imed_Proceso" class="modal fade" role="dialog">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <%--<button type="button" class="close" data-dismiss="modal">&times;</button>--%>
                    <h4 id="title_Imed_Proceso" class="modal-title">Error</h4>
                </div>
                <div class="modal-body">
                    <p></p>
                </div>
                <div class="modal-footer">
                    <button type="button" id="button_modal_Imed_Proceso" class="btn btn-danger" data-dismiss="modal">
                        <span>Continuar</span>
                    </button>
                    <button type="button" id="button_modal_Imed_Proceso_Cancelar" class="btn btn-danger" data-dismiss="modal">
                        <span>Cancelar</span>
                    </button>
                </div>
            </div>
                ...
                <!-- Modal Imed Proceso-->
    <div id="mError_AAH_Imed_Proceso_2" class="modal fade" role="dialog">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <%--<button type="button" class="close" data-dismiss="modal">&times;</button>--%>
                    <h4 id="title_Imed_Proceso_2" class="modal-title">Error</h4>
                </div>
                <div class="modal-body">
                    <p></p>
                </div>
                <div class="modal-footer">
                    <button type="button" id="button_modal_Imed_Proceso_2" class="btn btn-danger" data-dismiss="modal">
...
<%--                     <div class="col-sm">
            ...
            <div class="container" style="max-width: 100%; border: 0px solid #fff;">
                <div class="row">
                    <div class="col-sm-1">
                        <button id="btn_Imed" type="button" class="btn btn-warning btn-block">
                            <br />
                            <i class="fa fa-android" aria-hidden="true" style="font-size: 30px;"></i>
                            <p style="margin-top: 2px;">Imed</p>
                        </button>
                    </div>
                    <div class="col-sm-2">
