...
Public Class IN_PAC_MAN_3_NE
    ...
    Public Shared Function Llenar_tabla_exam2(ByVal ID_PREVE As Integer, ByVal Fecha As String) As String
        ...
        If ID_PREVE = 254 Then
            data_paciente = NN.IRIS_WEBF_CMVM_BUSCA_CODIGO_FONASA_PARA_CARGA_ATENCION_SAN_JOAQUIN(Format(ANO, "yyyy"), ID_PREVE) 'LA CISTERNA
        Else
            data_paciente = NN.IRIS_WEBF_BUSCA_CODIGO_FONASA_PARA_CARGA_ATENCION(Format(ANO, "yyyy"), ID_PREVE)
        End If
    ...
    Public Shared Function Guardar_TodoByVal(ByVal RUT_PAC As String,
                                             ...
                                             ByVal sub_atencion As String, ByVal vih As String, ByVal dni As String, ByVal Numero_clini As String, ByVal Sub_progra As String) As String
        ...
        If (Paridad = 2) Then
            ...
            PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW(correlativo,
                                                              ...
                                                              FECHA_PRE,
                                                              Programa,
                                                              Sector, Numero_clini, 0, 0, sub_atencion, vih, Sub_progra, xHora
                                                             )
        Else
