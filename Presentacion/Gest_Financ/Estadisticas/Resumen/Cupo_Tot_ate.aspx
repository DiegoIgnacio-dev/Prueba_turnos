        ...
        function Fill_DataTable() {
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                $("#DataTable tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "center" }).text(Mx_Dtt[i].TOTAL_AGEND_PAP + Mx_Dtt[i].TOTAL_AGEND_ESPONTANEO + Mx_Dtt[i].TOTAL_AGEND_PRIORITARIO + Mx_Dtt[i].TOTAL_AGEND_CUPO_NORMAL)
            ...
            $("#DataTableTotal tbody").append(
                $("<tr>").append(
                    ...
                    $("<td>", { "align": "center" }).text(T_Usu + T_Sis + T_Exa + T_Ate)
                )
            );
            //var arr = ["Array"];
            //var arr1 = [0];
