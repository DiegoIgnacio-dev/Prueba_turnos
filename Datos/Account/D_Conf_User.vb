...
Public Class D_Conf_User
    ...
    Function IRIS_WEBF_CMVM_BUSCA_USUARIO_DETALLE(ByVal ID_USER As Integer) As E_IRIS_WEBF_CMVM_BUSCA_USUARIO_DETALLE
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.USU_ID_PROC = DD_GEN.DB_NULL(Obj_Reader, 21, 0)
            E_Proc_Item.USU_ID_PREV = DD_GEN.DB_NULL(Obj_Reader, 22, 0)
    ...
    Function IRIS_WEBF_CMVM_BUSCA_USUARIO_ID_PREVISION_SCR() As List(Of E_IRIS_WEBF_CMVM_BUSCA_USUARIO_DETALLE)
        'Declaraciones
        CC_ConnBD = New C_ConnBD
        Dim Obj_Reader As OleDbDataReader
        Dim Cmd_SQL As New OleDb.OleDbCommand
        ...
        'Declaraciones 'lista'
        Dim E_Proc_List As New List(Of E_IRIS_WEBF_CMVM_BUSCA_USUARIO_DETALLE)

        'Configuración general
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_USUARIO_ID_PREVISION_SCR"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With


        Dim objSession As HttpSessionState = HttpContext.Current.Session
        Dim id_preve_by_cookie As Integer = CType(objSession("ID_PREV"), Integer)
        ...
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@ID_PREVE", OleDbType.Numeric).Value = CInt(id_preve_by_cookie)
        End With
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.USU_NOMBRE = DD_GEN.DB_NULL(Obj_Reader, 1, "")
            E_Proc_Item.USU_APELLIDO = DD_GEN.DB_NULL(Obj_Reader, 2, "")
            E_Proc_Item.USU_NIC = DD_GEN.DB_NULL(Obj_Reader, 3, 0)
