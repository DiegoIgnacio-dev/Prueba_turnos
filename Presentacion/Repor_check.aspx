...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="card">
        <div class="card-header bg-bar">
            <h4 class="text-center m-0"><i class="fa fa-check-square-o fa-fw"></i>Reportes y Check List</h4>
        </div>
        <div class="card-body">
            <div class="row xmb-3">
        ...
        <div class="col-lg mb-1">
            <div class="card border-bar">
                <div class="list-group list-group-root well">
                    <h6 class="m-0">
                    <a href="#item-2" class="list-group-item ttl" data-toggle="collapse">
                        <i class="fa fa-fw fa-chng fa-chevron-right"></i>Check List
                    </a></h6>
                   ...
                   <a href="/Check_List/Check_Point/Chk_Est_Exam.aspx" class="list-group-item">
                    ...
                    <a href="/Recha_Mues/Lis_recha_Mues.aspx" class="list-group-item">
                         ...
                         <a href="/Check_List/REV_VALOR_ALTER.aspx"" class="list-group-item">
                            <i class="fa fa-fw fa-minus"></i>Listado valores alterados </a>
