<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Traza_Env_RecepLab2.aspx.vb" Inherits="Presentacion.Traza_Env_RecepLab2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Dtt_LugarTM = [
    {
        ...
        function Ajax_LugarTM() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Traza_Env_RecepLab2.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
        ...
        var Mx_Seccion = [
    {
        ...
        function Ajax_Seccion() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Traza_Env_RecepLab2.aspx/Llenar_Ddl_Seccion",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DDL_RECHAZOS_ACTIVOS() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Traza_Env_RecepLab2.aspx/DDL_TIPO_RECHAZO_ACTIVOS",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Traza_Env_RecepLab2.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE, yyy) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Traza_Env_RecepLab2.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Traza_Env_RecepLab2.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                ...
                for (i = 0; i < Mx_Dtt.length; i++) {
                    $("#DataTable tbody").append(
                        $("<tr>", {
                            ...
                            $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(moment(Mx_Dtt[i].ATE_FECHA).format("L")),
                            $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(moment(Mx_Dtt[i].ATE_FECHA).format("HH:mm")),
                            $("<td>").text(function () {
                                //if (i > 0) {
                                //    if (Mx_Dtt[i - 1].ATE_NUM == Mx_Dtt[i].ATE_NUM) {
                                //        $(this).css("cssText", "text-align:center;").text("");
                            ...
                            $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(function () {
                                if (Mx_Dtt[i].USU_ENVIO != null) {
                                    $(this).css("cssText", "text-align:center; background-color:#ffcf87;").text("SI")
                                } else {
                                    $(this).text("")
                                }
                            }),
                            $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt[i].USU_ENVIO),
                            $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(function () {
                                if (Mx_Dtt[i].USU_ENVIO != null) {
                                    $(this).text(moment(Mx_Dtt[i].ENVIO_ETI_FECHA).format("DD/MM/YYYY HH:mm"))
                                } else {
                                    $(this).text("")
                                }
                            }),
                            $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(function () {
                                if (Mx_Dtt[i].USU_RECEP != null) {
                                    $(this).css("cssText", "text-align:center; background-color:#60f759;").text("SI")
                                } else {
                                    $(this).text("")
                                }
                            }),
                            $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt[i].USU_RECEP),
                             $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(function () {
                                 if (Mx_Dtt[i].USU_RECEP != null) {
                                     $(this).text(moment(Mx_Dtt[i].RECEP_ETI_FECHA).format("DD/MM/YYYY HH:mm"))
                                 } else {
                                     $(this).text("")
                                 }
                             })
            ...
            <div class="card mb-3 border-bar">
                <div class="card-header bg-bar">
                    <h5 style="text-align: center; padding: 5px;">
                        ...
                        Trazabilidad por Envío y Recepción.
                    </h5>
                </div>
                <div class="card-body">
