<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Rel_Est_Exam.aspx.vb" Inherits="Presentacion.Rel_Est_Exam" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script>
        ...
        function Ajax_Prevision() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rel_Est_Exam.aspx/Llenar_Estadistica",
                //"data": Data_Par,
        ...
        function Ajax_LugarTM() {
            $.ajax({
                "type": "POST",
                "url": "Rel_Est_Exam.aspx/Llenar_Ddl_LugarTM",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Preve() {
            $.ajax({
                "type": "POST",
                "url": "Rel_Est_Exam.aspx/Llenar_Ddl_Prevision",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    let json_receiver = response.d;
        ...
        function pruebas_ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rel_Est_Exam.aspx/IRIS_WEBF_BUSCA_PRUEBA_POR_CODIGO_F",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rel_Est_Exam.aspx/Llenar_Prueba",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Call_Data_Table() {
            ...
            AJAX_Data_Table = $.ajax({
                "type": "POST",
                "url": "Rel_Est_Exam.aspx/Call_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Call_Export() {
            ...
            AJAX_Data_Table = $.ajax({
                "type": "POST",
                "url": "Rel_Est_Exam.aspx/Call_Export",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
