<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Ingreso_Ate_Omi.aspx.vb" Inherits="Presentacion.Ingreso_Ate_Omi" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script src="../js/Deep-Copy.js"></script>
    <%-- Colocar esto para forzar el evento load --%>
    <%@ OutputCache Location="None" NoStore="true" %>
    <script src="Ingreso_Ate_Omi.js"></script>
    <style>
        .alertas {
            margin-top: 180px;
            text-align: center;
                    ...
                    <div class="col-md-12">
                        <div class="row">
                         ...
                         <input type='text' id="rut" class="form-control textoReducido" placeholder="12.345.789-0" />
                             ...
                             <div class="col-lg">
                                <label class="textoReducido">DNI:</label>
...
<%--                           <div class="col-lg">
                                <label class="textoReducido">Embarazo:</label>
                                <input type='text' id="Emba" class="form-control textoReducido" placeholder="" disabled="disabled" />
                            </div>--%>
                            <%--                        <div class="col-sm">
                            <label class="textoReducido">Diagnostico 2:</label>
