<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Usuarios_Sum_2.aspx.vb" Inherits="Presentacion.Usuarios_Sum_2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl_Año() {

            modal_show();
            $.ajax({
                "type": "POST",
                "url": "Usuarios_Sum_2.aspx/Llenar_Ddl_Año",
                //"data": '{}',
                ...
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        Mx_Ddl_Año = JSON.parse(json_receiver);
                        Fill_Ddl_Año();
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Usuarios_Sum_2.aspx/Llenar_Ddl",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Usuarios_Sum_2.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Usuarios_Sum_2.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
