...
Public Class Master
    ...
    Sub Check_Test()
        ...
        For Each item In arrConn
            If (item.Split("=")(1) = "IRIS_LAB_ALEMAN") Then
                bolTEST = False
                Exit For
            End If
        Next
        ...
        If (bolTEST = True) Then
            aTitle.InnerText = "Lab Alemán >>TEST<<"
            Me.Page.Title = "Iris Lab Alemán >>TEST<<"
        Else
            aTitle.InnerText = "Lab Alemán"
            Me.Page.Title = "Iris Lab Alemán"
        End If
    End Sub
