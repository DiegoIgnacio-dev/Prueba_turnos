...
Public Class N_IRIS_WEBF_UPDATE_CONF_DIAS_EXAMEN
    ...
    End Function
    Function IRIS_WEBF_UPDATE_CONF_DIAS_EXAMEN_NEW(ByVal ID_CONF As String, ByVal CANTIDAD As String, ByVal ID_ESTADO As String, ByVal normal As String, ByVal prioritario As String, ByVal espontaneo As String) As Integer
        Return DD_Data.IRIS_WEBF_UPDATE_CONF_DIAS_EXAMEN_NEW(ID_CONF, CANTIDAD, ID_ESTADO, normal, prioritario, espontaneo)
    End Function
End Class
