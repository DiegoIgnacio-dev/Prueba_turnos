        ...
        var Mx_Dtt_Antiguos = [
{
        ...
        var Mx_Ciudad = [
    {
        ...
        function Ajax_Ciudad() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Editar_Paciente.aspx/Data_Sel_Ciudad",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    Mx_Ciudad = response.d;
                    if (Mx_Ciudad != null) {
        ...
        var Mx_Comuna = [
    {
        ...
        function Ajax_Comuna() {
            var Data_Par = JSON.stringify({
                "ID_CIUD": $("#DdlCiudad").val()
            });

            $.ajax({
                "type": "POST",
                "url": "Editar_Paciente.aspx/Data_Sel_Comuna",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    Mx_Comuna = response.d;
                    if (Mx_Comuna != null) {
                        Fill_Ddl_Comuna();
            ...
            $.ajax({
                ...
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        Ajax_DataTable_UPDATE($("#txtNuevoRut").val())
        ...
        var Mx_Dtt = [
    {
        ...
        function Ajax_DataTable_UPDATE(RUT) {
            modal_show();
    ...
    <script>
        ...
        function Fill_Ddl_Cuidad() {
            ...
            for (y = 0; y < Mx_Ciudad.length; ++y) {
                $("<option>", {
                    "value": Mx_Ciudad[y].value
                }).text(Mx_Ciudad[y].text).appendTo("#DdlCiudad");
            }
        };
        ...
        function Fill_Ddl_Comuna() {
            ...
            for (y = 0; y < Mx_Comuna.length; ++y) {
                $("<option>", {
                    "value": Mx_Comuna[y].value
                }).text(Mx_Comuna[y].text).appendTo("#DdlComuna");
            }
        };
