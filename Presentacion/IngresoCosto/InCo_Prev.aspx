<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="InCo_Prev.aspx.vb" Inherits="Presentacion.InCo_Prev" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script>
        ...
        function Llenar_Ddl_Preve() {
            ...
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_Prev.aspx/Llenar_Ddl_Preve",
                //"data": Data_Par,
        ...
        function Ajax_Datatable() {
            ...
            let Data_Par = JSON.stringify({
                "DESDE": $("#fecha").val(),
                "HASTA": $("#fecha2").val(),
                "ID_PREVE": $("#Slt_Preve").val()
            });
            //Debug
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_Prev.aspx/IRIS_WEBF_BUSCA_LIS_ADM_PREVE",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Ajax_Excel() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "HASTA": $("#fecha2").val(),
                "ID_PREVE": $("#Slt_Preve").val(),
                "PREVE_DESC": $("#Slt_Preve option:selected").text()
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card border-bar">
        <div class="card-header bg-bar">
            <h5 class="m-1">Ingreso vs Costos por Previsión
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg">
                    <label for="Slt_Preve">Previsión:</label>
                    <select id="Slt_Preve" class="form-control"></select>
                </div>
                <div class="col-lg">
                    <br />
