...
'strconn3 = "Driver={SQL Server};Server=45.71.46.202,7778;Database=IRIS_LAB_ALEMAN;Uid=sa;Pwd=xlab;"
    strconn3 = "Driver={SQL Server};Server=192.168.10.200,7778;Database=IRIS_LAB_ALEMAN;Uid=sa;Pwd=xlab;"
