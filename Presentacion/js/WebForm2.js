...
(function (H) {
    ...
    class Ts_Table {
        ...
        set isSelectable(value) {
            ...
            if (value == true) {
                this.obj_raw.find(`tbody tr`).click((Me) => {
         ...
         */
        addHeader(text, alignment, width = null) {
    ...
    class Ts_Select extends Ts_Input {
         ...
         */
        get text() {
            let xStr = this.obj_raw.children(`option:selected`).text();
            return xStr;
        }
        /**
...
(function (H) {
    class Class_Form {
         ...
         */
        scrollToID(id_dom) {
            let elem = document.getElementById(id_dom);
            elem.scrollIntoView({
                block: 'start',
                behavior: 'smooth'
            });
...
(function (U) {
    ...
    class Ajax {
         ...
         * @param parameters
         */
        requestNow(parameters = null, callback = null) {
            let obj_options = {};
    ...
    (function (CONV) {
         ...
         */
        CONV.formatNum = (num, cantDec = null) => {
            if (num == null) {
                return "-";
            }
