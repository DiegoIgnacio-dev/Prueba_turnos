...
Public Class Ate_Resultados
    ...
    Public Shared Function Json_DataTable('ByVal R_ID_ATE As Long,
                                          ...
                                          ByVal R_AÑO As Integer) As List(Of E_Json_Result_DataTable)
        'Declaraciones internas
        ...
        Data_Res01 = NN_Result.IRIS_WEBF_BUSCA_VISOR_DETALLE_RESULTADO_SECCION_EXAMEN2(NN_Result.ID_ATE, R_ID_SECC, R_ID_EXAM, R_DIA, R_MES, R_AÑO)
    ...
    Public Shared Function Change_Ate_L_or_R(ByVal ATE_NUM As Long, ByVal DIRECTION As Boolean, ByVal ID_PROC As Integer,
        ...
        Dim RRR As Long = 0
        'If (ID_PROC = 0 And ID_PREV = 0 And ID_PROG = 0 And ID_SECC = 0 And ID_EXAM = 0 And ID_SECC = 0 And ID_SECT = 0 And ID_PACI = 0) Then
        ...
        'Else
        ID_OTHER = NNN.IRIS_WEBF_CMVM_BUSCA_ATE_L_R_2(ATE_NUM, DIRECTION, ID_PROC, ID_PREV, ID_PROG, ID_SECC, ID_EXAM, ID_SECT, ID_PACI)
        'End If
