...
Public Class D_DATA_MOVIL
    'Declarar la Conexión
    Dim CC_ConnBD As C_ConnBD
    'Declarar una nueva Instancia de General Functions
    Dim DD_GEN As New D_General_Functions
    Function IRIS_WEBF_BUSCA_MODULOS() As List(Of E_DATA_MOVIL) ' Lo mismo que las demas capas
        'Declaraciones
        ...
        'Declaraciones 'lista'
        Dim Item_Retorno As New E_DATA_MOVIL 'Item de Entidad

        Dim Lista_Retorno As New List(Of E_DATA_MOVIL) 'Nueva lista de Entidad
        'Configuración general

        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure 'Tipo Consulta
            .CommandText = "IRIS_WEBF_BUSCA_MODULOS_TEST" 'Nombre PA
        ...
        While Obj_Reader.Read
            Item_Retorno = New E_DATA_MOVIL 'Nuevo item de Entidad (Limpiar el anterior)
