...
function LLENA_MARCO_HOJA
	...
	Set Image = Doc.OpenImage(Server.MapPath( "/Firmas/logoaleman3.png" ) )		
	Set Param = Pdf.CreateParam
	Param("x") = 30
	Param("y") = 727
	Param("ScaleX") = (0.3)
	...
	Set Image = Doc.OpenImage(Server.MapPath( "/Firmas/logoacreditacion.png" ) )		
	Set Param = Pdf.CreateParam
	Param("x") = 515
	Param("y") = 727
	Param("ScaleX") = (0.095)
	...
	'Params("y") = 780
	'Params("size") = 14	
	'Page.Canvas.DrawText "LABORATORIO CLINICO HOLANDA", Params, Font
	...
	Params("y") = 725
	Params("size") = 11
	Page.Canvas.DrawText "Manuel Montt #378, Curicó", Params, Font
	...
	Params("y") = 725
	Params("size") = 11
	Page.Canvas.DrawText "FONO: (075) 2323749", Params, Font
	...
	Params("y") = 725
	Params("size") = 11
	Page.Canvas.DrawText "Sitio Web: www.laboratorioaleman.cl", Params, Font
	...
	Params("y") = 725
	Params("size") = 11
	'Page.Canvas.DrawText "Email: info@labholanda.cl", Params, Font
