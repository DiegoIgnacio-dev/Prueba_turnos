...
Public Class N_GraficoAteTP
    ...
    End Function
    Function IRIS_WEBF_CMVM_BUSCA_CANT_EXAMENES_ATE_USUARIO(ByVal ID_PAC As Long, ByVal Año As Long, ByVal Mes As Long) As List(Of E_IRIS_WEBF_BUSCA_CANT_EXAMENES_ATE_POR_LUGAR_TM1_TODOS)
        Return DD_Data.IRIS_WEBF_CMVM_BUSCA_CANT_EXAMENES_ATE_USUARIO(ID_PAC, Año, Mes)
    End Function
    Function Gen_Excel(ByVal MAIN_URL As String, ByVal Dll As Long, ByVal Año As String) As String
        ...
        End If
    End Function
    Function Gen_Excel_User(ByVal MAIN_URL As String, ByVal Dll As Long, ByVal Año As String, ByVal USER As String, ByVal Mes As Integer) As String
        'Declaraciones Generales
        Dim NN_Date As New N_Date
        Dim NN_Med As New N_GraficoTM_Todo
        Dim NN_TP As New N_GraficoAteTP
        ...
        sl.SetCellValue("B2", "Atenciones Totales (Listado)")
        If (Dll = "0") Then
            sl.SetCellValue("B3", "Usuario: Todas")
        Else
            sl.SetCellValue("B3", "Usuario: " & USER)
        End If
        sl.SetCellValue("B4", "Año: " & Año)
        'nombre columnas
        sl.SetCellValue("A7", "Mes")
