...
Public Class DET_ATE_X_USU_TP
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable(ByVal ID_TP_PAGO As Long, ByVal USUARIO As Long,
        ...
        Data_TM_Provision = NN_TM_Prevision.IRIS_WEBF_BUSCA_LIS_ADM_RESU_FORMA_PAGO_LTM(Date_01, Date_02, ID_TP_PAGO, USUARIO)
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String, ByVal ID_TP_PAGO As Long, ByVal USUARIO As Long,
                                            ByVal DATE_str01 As String, ByVal DATE_str02 As String) As String
        Dim NN_TM_Prevision As New N_DET_ATE_USU
        Dim NN_Date As New N_Date
        DATE_str01 = DATE_str01.Replace("-", "/")
        ...
        Return NN_TM_Prevision.Gen_Excel_usu_tp(DOMAIN_URL, Date_01, Date_02, ID_TP_PAGO, USUARIO)
    End Function
