    ...
    Public Shared Function Llenar_DataTable_2(ByVal NATE As String) As String
        ...
        If data_id_ate_x_nate.Count > 0 Then
            ...
            If (data_lis_exa.Count > 0) Then
                For i = 0 To data_lis_exa.Count - 1
                    Data_Estado_Mant_2 = NN_Estado_Mant.IRIS_WEBF_CMVM_BUSCA_IMAGEN_SCANNER_MOBILE_2(data_lis_exa(i).ATE_NUM)

                    If (Data_Estado_Mant_2.Count > 0) Then
                        data_lis_exa(i).DOCS_CANT = Data_Estado_Mant_2.Count
                    Else
                        data_lis_exa(i).DOCS_CANT = 0
                    End If
                Next i
            End If
