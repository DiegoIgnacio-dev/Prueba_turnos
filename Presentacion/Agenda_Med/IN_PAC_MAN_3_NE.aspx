<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="IN_PAC_MAN_3_NE.aspx.vb" Inherits="Presentacion.IN_PAC_MAN_3_NE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function fn_Req_Prev() {
            ...
            objAJAX_Prev = $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Request_Prevision",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function fn_Req_Prog() {
            ...
            objAJAX_Prog = $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Request_Programa",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function fn_Req_SubP() {
            ...
            objAJAX_SubP = $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Request_SubPrograma",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function Ajax_guardar() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "Sub_progra": $("#Ddl_Prog02").val()
            });
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Guardar_TodoByVal",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        var Mx_Dtt_exam02_respaldo = [
  {
      ...
      "CF_DIAS": 0,
        ...
        function Ajax_DataTable_examen02() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_tabla_exam2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_examen3(cod_fonasa, id, cod, txis) {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_tabla_exam",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Ddl = [
    {
        ...
        function Call_AJAX_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_Ddl_LugarTM",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_busca_rut() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_rut",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        //    var date_x = Mx_Dtt2[i].PAC_FNAC;
                        //    date_x = String(date_x).replace("/Date(", "");
                        //    date_x = date_x.replace(")/", "");

                        //    var Date_Change = new Date(parseInt(date_x));
                        //    Mx_Dtt2[i].PAC_FNAC = Date_Change;
                        //}
        ...
        function Ajax_busca_dni() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_dni",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DL_SEXO() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_DL_SEXO",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DL_NAC() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_DL_NAC",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ciudad() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/IRIS_WEBF_BUSCA_CIUDAD",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Comuna() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/IRIS_WEBF_BUSCA_RELACION_CIU_COMUNA",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_prevision = [
      {
        ...
        function Ajax_DL_prevision() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_DL_prevision",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_TP_ATE = [
     {
        ...
        function Ajax_DL_TP_ATE() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_DL_aTENCIONES",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Sec = [
    {
        ...
        function Ajax_DL_sec() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_DL_Sectores",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_Programa = [
   {
       ...
       "ID_ESTADO": 0
        ...
        function Ajax_DL_programa() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_DL_Programa",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_DOC = [
  {
      ...
      "ID_ESTADO": 0
        ...
        function Ajax_DL_DOC() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_DL_DOC",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_DL_orden_ate = [
 {
     ...
     "ID_ESTADO": 0
        ...
        function Ajax_DL_orden_ate() {
            ...
            $.ajax({
                "type": "POST",
                "url": "IN_PAC_MAN_3_NE.aspx/Llenar_DL_ordenATE",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-sm">
                            ...
                            <select id="Nacio" class="form-control textoReducido" style="height: 31.75px;">
                                <option value="volvoNacio">Seleccionar</option>
                            </select>
                        </div>
                        <div class="col-sm">
...
<%--                        <div class="col-sm-1">
                        ...
                        <div class="col-sm">
                            ...
                            <select id="Programa" class="form-control textoReducido" style="height: 31.75px; background-color: #87f0ff;">
                                <option value="volvoProgra">Seleccionar</option>
                            </select>
                        </div>   
                                            <div class="col-sm">
                            <label class="textoReducido">Sub-Programa:</label>
                            <select id="Ddl_Prog02" class="form-control textoReducido" style="height: 31.75px; background-color: #87f0ff;">
                                <option value="volvoSubProgra">Seleccionar</option>
                            </select>
                        </div>  
                        ...
                        <div class="col-sm">
                            ...
                            <select id="Sector" class="form-control textoReducido" style="height: 31.75px; background-color: #87f0ff;">
                                <option value="volvoSector">Seleccionar</option>
                            </select>
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-sm">
                            ...
                            <select id="Prevision" class="form-control textoReducido" style="height: 31.75px;">
                                <option value="volvoPrevi">Seleccionar</option>
                            </select>
                        </div>
                      <div class="col-sm">
