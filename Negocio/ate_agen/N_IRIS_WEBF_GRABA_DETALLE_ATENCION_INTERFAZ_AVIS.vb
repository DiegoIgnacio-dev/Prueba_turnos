...
Public Class N_IRIS_WEBF_GRABA_DETALLE_ATENCION_INTERFAZ_AVIS
    ...
    End Sub
    Function IRIS_WEBF_GRABA_DETALLE_ATENCION_INTERFAZ_AVIS(ByVal ID_ATE As Integer, ByVal ID_USUARIO As Integer, ByVal ID_CF As Integer, ByVal ID_PER As Integer, ByVal ID_TP_PAGO As Integer, ByVal ATE_DET_DOC As String, ByVal ATE_DET_V_PREVI As Integer, ByVal ATE_DET_V_PAGADO As Integer, ByVal ATE_DET_V_CCOPAGO As Integer, ByVal ATE_NUM_INTERFAZ As String) As Integer
