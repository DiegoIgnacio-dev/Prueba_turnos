...
Public Class Ingreso_Ate_Saydex
    ...
    Public Shared Function Llenar_tabla_exam_pack(ByVal ID_PREVE As Integer, ByVal Fecha As String, ByVal CF As String) As String
        ...
        Dim ANO As Date
        ANO = CDate(Fecha)
        data_paciente = NN.IRIS_WEBF_BUSCA_ATENCION_CODIGO_FONASA_PACK(ID_PREVE, Format(ANO, "yyyy"), CF)
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Request_Programa_2() As List(Of e_IRIS_WEBF_BUSCA_PROGRAMA)
        'Declaraciones internas
        Dim data_paciente As List(Of e_IRIS_WEBF_BUSCA_PROGRAMA)
        Dim NN As New N_IRIS_WEBF_BUSCA_BANCO
    ...
    <Services.WebMethod()>
    Public Shared Function TP_Pgo() As String
        Dim NN_Activo As New N_Gen_Activos
        Dim data_paciente As List(Of E_IRIS_WEBF_BUSCA_TIPO_DE_PAGO_INGRESO_ATE)
        Dim datas As String = ""
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        data_paciente = NN_Activo.IRIS_WEBF_BUSCA_TIPO_DE_PAGO_INGRESO_ATE()
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function IRIS_WEBF_BUSCA_examenes_paciente(ByVal examenes As List(Of examens_avis), ByVal ID_PREVE As String) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        For x = 0 To examenes.Count - 1
            data_paciente = NN.IRIS_WEBF_HOST_BUSCA_CODIGO_FONSA_POR_COD_SAYDEX_2(examenes(x).examen, Format(ANO, "yyyy"), ID_PREVE)
            ...
            If (data_paciente.Count > 0) Then
                ...
                'Item_Exam.CF_PRECIO_AMB = data_paciente(0).CF_PRECIO_AMB
                'Item_Exam.CF_PRECIO_HOS = data_paciente(0).CF_PRECIO_HOS
    ...
    Public Shared Function Guardar_TodoByVal(ByVal RUT_PAC As String,
                                           ...
                                           ByVal vih As String,
                                              ...
                                              ByVal APE_PAC As String,
                                               ...
                                               ByVal EMAIL_PAC As String) As String
        'Checar Galletas
        ...
        Else
            ...
            If (data_paciente2222.Count = 0 Or RUT_PAC = "") Then
                ...
                PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW(correlativo,
                                                                             ...
                                                                             FECHA_PRE,
                                                                             Programa,
                                                                             Sector, ATE_SAYDEX, DIAG1, DIAG2, sub_atencion, vih, 1)
            Else
