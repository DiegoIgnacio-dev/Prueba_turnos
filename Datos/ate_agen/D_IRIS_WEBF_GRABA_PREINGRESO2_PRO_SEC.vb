...
Public Class D_IRIS_WEBF_GRABA_PREINGRESO2_PRO_SEC
    ...
    Function IRIS_WEBF_GRABA_PREINGRESO2_PRO_SEC(ByVal ATE_NUM As String,
        ...
        With Cmd_SQL
            ...
            '.CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO2_PRO_SEC"
            .CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO2_PRO_SEC_4_diag"
    ...
    Function IRIS_WEBF_GRABA_PREINGRESO2_PRO_SEC_NEW(ByVal ATE_NUM As String,
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            '.CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO2_PRO_SEC"
            .CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO2_PRO_SEC_4_diag_NEW"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
    ...
    Function IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_OMI_NEW(ByVal ATE_NUM As String,
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_OMI_2_NEW"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
    ...
    Function IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW(ByVal ATE_NUM As String,
                                                 ...
                                                 ByVal DIAG2 As Integer,
                                                 ByVal sub_atencion As String,
                                                 ByVal vih As String, ByVal sub_programa As String,
                                                 Optional ByVal xHora As String = "00:00") As Integer
        'Declaraciones
        CC_ConnBD = New Conexion.ConexionBD
        Dim Cmd_SQL As New OleDb.OleDbCommand
        ...
        With Cmd_SQL.Parameters
            ...
            .Add("@DIAG2", OleDbType.Numeric).Value = DIAG2
            .Add("@HORA", OleDbType.VarChar).Value = xHora
            .Add("@SUB_ATENCION", OleDbType.VarChar).Value = sub_programa

            .Add("@VIH", OleDbType.VarChar).Value = vih
            .Add("@SUB_PROGRAMA", OleDbType.VarChar).Value = sub_atencion
        End With
        'Conectar con la Base de Datos
        Select Case CC_ConnBD.Oledbconexion.State
            Case ConnectionState.Open
    ...
    Function IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_SAYDEX_NEW(ByVal ATE_NUM As String,
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            '.CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_AVIS"
            .CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_SAYDEX_2_NEW"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
    ...
    Function IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS(ByVal ATE_NUM As String,
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            '.CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_AVIS"
            .CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_AVIS_2"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
        ...
        Return Obj_Read_Dt
    End Function
    Function IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_SIDRA_3_NEW(ByVal ATE_NUM As String,
                                         ByVal ID_PACIENTE As Integer,
                                         ByVal ID_USUARIO As Integer,
                                         ByVal ATE_FUR As Date,
                                         ByVal ID_PROCE As Integer,
                                         ...
                                         ByVal sub_atencion As String,
                                         ByVal vih As String, ByVal sub_programa As String,
                                          ByVal ID_HORARIO As Integer,
                                          ByVal VAL_CLOCK As String) As Integer
        'Declaraciones
        CC_ConnBD = New Conexion.ConexionBD
        Dim Cmd_SQL As New OleDb.OleDbCommand
        Dim Obj_Read_Dt As Integer = 0
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_SIDRA_3_NEW"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            ...
            .Add("@DIAG1", OleDbType.Numeric).Value = DIAG1
            .Add("@DIAG2", OleDbType.Numeric).Value = DIAG2
            .Add("@HORA", OleDbType.VarChar).Value = VAL_CLOCK
            .Add("@SUB_ATENCION", OleDbType.VarChar).Value = sub_programa

            .Add("@VIH", OleDbType.VarChar).Value = vih
            .Add("@SUB_PROGRAMA", OleDbType.VarChar).Value = sub_atencion
            .Add("@ID_HORARIO", OleDbType.Integer).Value = ID_HORARIO
            .Add("@VAL_CLOCK", OleDbType.VarChar).Value = VAL_CLOCK
        End With
        'Conectar con la Base de Datos
        Select Case CC_ConnBD.Oledbconexion.State
            Case ConnectionState.Open
    ...
    Function IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW_CAJA(ByVal ATE_NUM As String,
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            '.CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_AVIS"
            .CommandText = "IRIS_WEBF_CMVM_GRABA_PREINGRESO3_PRO_SEC_AVIS_2_NEW"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
