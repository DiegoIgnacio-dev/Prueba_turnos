<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Ingreso_Ate_Caja4_Bol_2.aspx.vb" Inherits="Presentacion.Ingreso_Ate_Caja4_Bol_2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script src="../js/Deep-Copy.js"></script>
    <script src="Ingreso_Ate_Caja4_Bol_2.js"></script>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row" style="font-size:20px;">
                        ...
                        <div class="col-lg-10"><input name="chkRevisa" class="m-0" id="chkRevisa2" value="0" style="display: none; margin-left:15px; cursor:pointer;" type="checkbox" />
                            <label class="div-chk" for="chkRevisa2">
                                <i class="fa fa-square" style="font-size:20px; cursor:pointer;"></i>
                                <i class="fa fa-check-square" style="font-size:20px; cursor:pointer;"></i>
                                <span style="font-size:20px; font-weight:500; cursor:pointer;">¿Confirma que los datos ingresados son correctos?</span>
                            </label></div>
                    </div>
...
<%--                            <div class="form-check form-check-inline col-sm">
                            ...
                            <div class="form-check form-check-inline col-sm">
                              <input type="radio" class="form-check-input manito" id="materialInline4" name="inlineMaterialRadiosExample" value="1"/>
