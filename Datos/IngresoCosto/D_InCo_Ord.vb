...
Public Class D_InCo_Ord
    Function IRIS_WEBF_BUSCA_LIS_ADM_ORD(ByVal DESDE As String, ByVal HASTA As String, ByVal ID_ORDEN As Integer) As List(Of E_InCo_Ord)
        ...
        Dim Obj_Read_Dt As E_InCo_Ord
        Dim List_Reader As New List(Of E_InCo_Ord)
        Dim Reader_Comm As OleDbDataReader
        Dim DD_GEN As New D_General_Functions
        'definiendo tipo de consulta a la BD
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_BUSCA_LIS_ADM_ORD"
        ...
        While Reader_Comm.Read
            ...
            Obj_Read_Dt.ORD_DESC = DD_GEN.DB_NULL(Reader_Comm, 13, Nothing)
