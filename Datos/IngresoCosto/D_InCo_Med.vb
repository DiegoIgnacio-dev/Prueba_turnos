...
Public Class D_InCo_Med
    Function IRIS_WEBF_BUSCA_LIS_ADM_MED(ByVal DESDE As String, ByVal HASTA As String, ByVal ID_DOC As Integer) As List(Of E_InCo_Med)
        ...
        Dim Obj_Read_Dt As E_InCo_Med
        Dim List_Reader As New List(Of E_InCo_Med)
        Dim Reader_Comm As OleDbDataReader
        Dim DD_GEN As New D_General_Functions
        'definiendo tipo de consulta a la BD
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_BUSCA_LIS_ADM_MED"
        Cmd_command.Connection = objconexion.Connect_to_IrisLab_LoBarnechea

        With Cmd_command.Parameters
            .Add("@DESDE", OleDbType.Date).Value = CDate(DESDE)
            .Add("@HASTA", OleDbType.Date).Value = CDate(HASTA)
            .Add("@ID_DOC", OleDbType.Numeric).Value = ID_DOC
        End With
