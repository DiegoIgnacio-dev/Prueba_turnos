...
Public Class N_IRIS_WEBF_BUSCA_ATENCION_PACIENTE_FECHA
    ...
    End Sub
    Function IRIS_WEBF_BUSCA_ATENCION_PACIENTE_FECHA(ByVal FECHA1 As String, ByVal FECHA2 As String, ByVal ID_PROC As String) As List(Of E_IRIS_WEBF_BUSCA_ATENCION_PACIENTE_FECHA)
        ...
        List_in = DD_Data.D_IRIS_WEBF_BUSCA_ATENCION_PACIENTE_FECHA(xDate01, xDate02, ID_PROC)
