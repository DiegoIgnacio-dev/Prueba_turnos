Public Class E_IRIS_WEBF_BUSCA_EST_PREVISION_POR_ID_PREVISION_DIALISIS
    ...
    Public Property ATE_EST_VALIDA As Integer
        ...
        End Set
    End Property
    Private EE_RESUL_RET As List(Of E_IRIS_WEBF_BUSCA_RESULTADO_DIALISIS)
    Public Property RESUL_RET() As List(Of E_IRIS_WEBF_BUSCA_RESULTADO_DIALISIS)
        Get
            Return EE_RESUL_RET
        End Get
        Set(ByVal value As List(Of E_IRIS_WEBF_BUSCA_RESULTADO_DIALISIS))
            EE_RESUL_RET = value
        End Set
    End Property
End Class