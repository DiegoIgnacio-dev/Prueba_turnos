...
Public Class Rev_Deter_Exa_EMB_Trans
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String,
        ...
        If (TRANSMITIDO = 1) Then
            Data = NN.IRIS_WEBF_CMVM_BUSCA_EXAMEN_DET_ESTADISTICA_CHECK_TODOS_2_2_SOLO_MULTIPLE_TRANSMITIDO(CDate(DESDE), CDate(HASTA), ID_CF, ID_EST, Procedencia, Ddl_previ, Ddl_programa, Ddl_subPrograma)
        Else
    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String,
        ...
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Listado de Resultados por Determinaciones Transmitidas")
        'titulo de la tabla
        sl.SetCellValue("B2", "Listado de Resultados por Determinaciones Transmitidas")
        ...
        'insertar tabla
        tabla = sl.CreateTable("A8", CStr("S" & ltabla + 1))
