...
Imports ASPPDFLib
Public Class REP_LAB_CANT_EXA_MINDS_TOT_2
    Inherits System.Web.UI.Page
    <Services.WebMethod()>
    Public Shared Function PDFF(ByVal DOMAIN_URL As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String, ByVal ID_CF As Integer, VALOR As Integer) As String
        ...
        link = NN_pdf.PDFF_2(DOMAIN_URL, DATE_str01, DATE_str02, ID_CF, VALOR)
        Return link
    End Function
    <Services.WebMethod()>
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Llenar_DataTable(ByVal DATE_str01 As String, ByVal DATE_str02 As String, ByVal ID_CF As Integer, ByVal VALOR As Integer) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datos As String = ""
        ...
        If VALOR = 0 Then
            Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS(Date_01, Date_02, ID_CF, cookie_proc)
        ElseIf VALOR = 1 Then
            Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS_REVISADOS(Date_01, Date_02, ID_CF, cookie_proc)
        ElseIf VALOR = 2 Then
            Data_Prev = NN_Exam.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_TODOS(Date_01, Date_02, ID_CF, cookie_proc)
        End If
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String, ByVal ID_CODIGO_FONASA As Long, ByVal VALOR As Integer) As String
        Dim NN_Exam As New N_REP_LAB_CANT_EXA_TOT
        Return NN_Exam.Gen_Excel_PROVEE(DOMAIN_URL, DATE_str01, DATE_str02, ID_CODIGO_FONASA, VALOR)
    End Function
