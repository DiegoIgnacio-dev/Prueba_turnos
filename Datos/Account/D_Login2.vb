...
Public Class D_Login2
    ...
    Function Login2(ByVal USER As String, ByVal PASS As String) As E_Login2
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_00_ASPX_LOGIN_NEW"
    ...
    Function IRIS_WEBF_00_ASPX_LOGIN_PACIENTES(ByVal RUT As String, ByVal N_ATE As Long, ByVal FECHA As Date) As List(Of E_IRIS_WEBF_00_ASPX_LOGIN_PACIENTES)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_00_ASPX_LOGIN_PACIENTES"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
    ...
    Function IRIS_WEBF_CMVM_BUSCA_ID_CIU_ID_COM_BY_ID_USER(ByVal ID_USER As Integer) As E_IRIS_WEBF_CMVM_BUSCA_ID_CIU_ID_COM_BY_ID_USER
        ...
        Return E_Proc_Item
    End Function
    Function IRIS_WEBF_00_ASPX_LOGIN_PROVEEDORES(ByVal USER As String, ByVal PASS As String) As E_Login2
        'Declaraciones
        CC_ConnBD = New C_ConnBD
        Dim Obj_Reader As OleDbDataReader
        Dim Cmd_SQL As New OleDb.OleDbCommand
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_00_ASPX_LOGIN_NEW_PROVEE"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        ...
        Return E_Proc_Item
    End Function
    Function IRIS_WEBF_CMVM_00_ASPX_LOGIN_NEW_MINDS(ByVal USER As String, ByVal PASS As String) As E_Login2
        'Declaraciones
        CC_ConnBD = New C_ConnBD
        Dim Obj_Reader As OleDbDataReader
        Dim Cmd_SQL As New OleDb.OleDbCommand
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_00_ASPX_LOGIN_NEW_MINDS"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
