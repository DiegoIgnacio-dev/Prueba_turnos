<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master_MINDS.Master" CodeBehind="REP_LAB_CANT_EXA_MINDS_TOT_2.aspx.vb" Inherits="Presentacion.REP_LAB_CANT_EXA_MINDS_TOT_2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_MINDS_TOT_2.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
        ...
        function Ajax_Ddl_Proce() {
            ...
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_MINDS_TOT_2.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_MINDS_TOT_2.aspx/Llenar_Ddl",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_MINDS_TOT_2.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_MINDS_TOT_2.aspx/PDFF",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_MINDS_TOT_2.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "text-center" }).text("Venta")
                )
            );
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                ...
                T_Sis += parseFloat(Mx_Dtt[i].TOTA_SIS);
            }


            $("#lbl_totales").text(addCommas(T_Exa));
            $("#lbl_totales_plata").text("$ " + addCommas(T_Sis));
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                ...
                arr2.push(parseFloat(Mx_Dtt[i].TOTA_SIS));
            }
...
<%--                <div class="col-lg">
            ...
            <div class="row">
                <form action="" class="row" style="margin-left:5px;">
                    ...
                    <div class="col-lg">
                        <label for="Chk_Pendientes">Validados</label>
                        <input type="radio" name="gender" value="0" id="Chk_Pendientes"/>
                    </div>
                    <div class="col-lg">
                        <label for="Chk_Todos">Validados/Revisados</label>
                        <input type="radio" name="gender" value="1" id="Chk_Todos"/>
                    </div>
        ...
        <div class="row">
            ...
            <div class="card mb-3 border-bar" id="div_totales">
                <div class="card-header bg-bar p-2">
                    <div class="row">
                        <div class="col-lg">
                            <h5>Total de Exámenes: <span id="lbl_totales"></span></h5>
                        </div>
                        <div class="col-lg">
                            <h5>Total Venta: <span id="lbl_totales_plata"></span></h5>
                        </div>
                    </div>
