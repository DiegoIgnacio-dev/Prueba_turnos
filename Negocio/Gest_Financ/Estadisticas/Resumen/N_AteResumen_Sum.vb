...
Public Class N_AteResumen_Sum
    ...
    End Sub
    Function IRIS_WEBF_BUSCA_EST_EXAMENES_RESULTADOS2(ByVal ID_TM As Long, ByVal ID_PREVE As Long, ByVal ID_PRG As Long, ByVal ID_SUB As Long, ByVal Date_01 As Date,
    ...
    End Function
    Function IRIS_WEBF_BUSCA_EST_EXAMENES_RESULTADOS3(ByVal ID_TM As Long, ByVal ID_PREVE As Long, ByVal ID_PRG As Long, ByVal ID_SUB As Long, ByVal Date_01 As Date,
                                                                      ByVal Date_02 As Date) As List(Of E_IRIS_WEBF_BUSCA_EST_EXAMENES_RESULTADOS2)
        Return DD_Resumen.IRIS_WEBF_BUSCA_EST_EXAMENES_RESULTADOS3(ID_TM, ID_PREVE, ID_PRG, ID_SUB, Date_01, Date_02)
    End Function
    Function Gen_Excel(ByVal MAIN_URL As String, ByVal ID_TM As Long, ByVal ID_PREVE As Long, ByVal ID_PRG As Long, ByVal ID_SUB As Long, ByVal Date_01 As Date, _
        ...
        'Realizar Consulta
        Data_TM_Prevision = NN_Prev.IRIS_WEBF_BUSCA_EST_EXAMENES_RESULTADOS3(ID_TM, ID_PREVE, ID_PRG, ID_SUB, Date_01, Date_02)
        ...
        For y = 0 To (Data_TM_Prevision.Count - 1)
            ...
            Mx_Data(9, y) = Data_TM_Prevision(y).SECTOR_DESC
            Mx_Data(10, y) = Data_TM_Prevision(y).PAC_RUT
            Mx_Data(11, y) = Format(CDate(Data_TM_Prevision(y).ATE_FECHA), "dd/MM/yyyy")
            Mx_Data(12, y) = "-/-"
            Mx_Data(13, y) = Data_TM_Prevision(y).ATE_OMI
            Mx_Data(14, y) = Data_TM_Prevision(y).SEXO_DESC
            Mx_Data(15, y) = Data_TM_Prevision(y).ATE_AÑO
        Next y
        ...
        sl.SetCellValue("J7", "Sector")
        sl.SetColumnWidth(9, 20.0)
        sl.SetCellValue("K7", "Rut")
        sl.SetColumnWidth(10, 20.0)
        sl.SetCellValue("L7", "Fecha Atención")
        sl.SetColumnWidth(11, 20.0)
        sl.SetCellValue("M7", "Sub Programa")
        sl.SetColumnWidth(12, 20.0)
        sl.SetCellValue("N7", "OC")
        sl.SetColumnWidth(13, 10.0)
        sl.SetCellValue("O7", "Sexo")
        sl.SetColumnWidth(14, 10.0)
        sl.SetCellValue("P7", "Edad")
