<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Recep_Mue_PENDIENTES.aspx.vb" Inherits="Presentacion.Recep_Mue_PENDIENTES" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        $(document).ready(function () {
            ...
            $("#Btn_Pendiente").click(function () {
                ...
                if (CB_Pendiente == 0 || ATE_NUM_Pendiente == 0) {
                    ...
                    $("#mError_AAH button").attr("class", "btn btn-danger");
                    $("#mError_AAH p").text("Por favor, seleccione una muestra para marcar pendiente.");
                    $("#mError_AAH").modal();
                } else {
    ...
    <script>
        ...
        function Ajax_DataTable_Load() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Form_Table",
                //"data": Data_Par,
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Atencion_Asereje = [
{
    ...
    "ID_PACIENTE": 0
        ...
        function Ajax_Info_Asereje() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Info",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Info_Exa_Asereje() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Exa_Info",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Marcar_Guardar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Llenar_DataTable_Marcar",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_Ate_ONCLICK() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Llenar_DataTable2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable_Marcar() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Llenar_DataTable3",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Pendiente_Marcar() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "ID_ATE": ID_ATENCHION,
                "ID_CF": ID_CEEFEICHON,
                "MULTIPLICADIIIIIS": MULTIPLICADIIIIIS

            });
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Ajax_Pendiente_Marcar",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Llenar_Modal_Cargar_Doble_click(NUM_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Llenar_Modal_Cargar_Doble_click",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Guardar_Lote() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Guardar_Lote",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Guardar_Lote_2(correlativin2) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/Guardar_Lote2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ver_Lotes_Anteriores() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Muestras_Lotes(NUMLOTE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Recep_Mue_PENDIENTES.aspx/IRIS_WEBF_BUSCA_LOTE_RECEPCIONADO_LOTE_2",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        //--------------------------------------------------- CLICK EN TABLA ----------------------------------------------------------|
        function Ajax_Get_values_to_Pendiente(CBB, ATE_NUMM, NUM_OMII, ATE_COD_TEST, ID_ATEEEEEEECX, ID_CEEFEEE, PARA_CF_DESQQQ, MULTIPLICADIIWII) {
            ...
            MULTIPLICADIIIIIS = MULTIPLICADIIWII;
        };
