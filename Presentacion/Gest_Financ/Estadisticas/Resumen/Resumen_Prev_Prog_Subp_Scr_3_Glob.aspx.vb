Imports Entidades
Imports Negocio
Public Class Resumen_Prev_Prog_Subp_Scr_3_Glob
    ...
    Public Shared Function PDFF(ByVal DOMAIN_URL As String,
        ...
        link = NN_pdf.PDFF_DUAL_COPA(DOMAIN_URL, DESDE, HASTA, PROC, PREV, 0, 0, ID_USER)
        Return link
    End Function
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String,
        ...
        Data_DTT = NN_DTT.IRIS_WEBF_BUSCA_RESUMEN_PREVE_PROG_SUBP_278_2_SCR_2_DUAL_COPAGO_DUAL_PARTICULAR_ATE_DET_ATE(DESDE, HASTA, PROC, PREV, ID_USER)
    ...
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String,
        ...
        Return NN_Prev.Gen_Excel_Dual_Copago(DOMAIN_URL, DESDE, HASTA, PROC, PREV, 0, 0, ID_USER)
    End Function
