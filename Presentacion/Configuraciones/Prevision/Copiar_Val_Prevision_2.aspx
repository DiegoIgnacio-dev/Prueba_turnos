<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Copiar_Val_Prevision_2.aspx.vb" Inherits="Presentacion.Copiar_Val_Prevision_2" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#ddl_Año, #ddl_Preve").change(function () {
                ...
                if (ddlAño != "Seleccione Año" && ddlPreve != "Seleccione Previsión" && $("#ddl_Año").val() != 0 && $("#ddl_Preve").val() != 0) {
                    Ajax_DataTable();
                }
            });
        });
        ...
        function Llenar_Ddl_Año() {
            $.ajax({
                "type": "POST",
                "url": "Copiar_Val_Prevision_2.aspx/Llenar_Ddl_Año",
        ...
        function Llenar_Ddl_Preve() {
            $.ajax({
                "type": "POST",
                "url": "Copiar_Val_Prevision_2.aspx/Llenar_Ddl_Preve",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
                    Mx_Ddl_Preve = data.d;
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Copiar_Val_Prevision_2.aspx/Llenar_DataTable",
                "data": Data_Param,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
        ...
        function Update_Precio() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Copiar_Val_Prevision_2.aspx/Update_Precio",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "class": "textoReducido" }).text("Bonificación (Copago)")
                )
            );
            for (i = 0; i < Mx_Dtt.length; i++) {
                $("#DataTable tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt[i].CF_BONIFICACION)
                    )
                );
            }
        }
    ...
    <div class="card mb-3 border-bar">
        ...
        <div class="row" style="margin-top: 5px;">
            ...
            <div class="col-md-4">
                ...
                <option value="0">Seleccione Previsión (Origen)</option>
                </select>
            </div>
            <div class="col-md-1"></div>      
        </div>
