Public Class E_IRIS_WEBF_BUSCA_EST_CODIGO_FONASA_TODOS_2
    ...
    Public Property RESULTADO() As String
        ...
        End Set
    End Property
    Public Property DETER() As String
        Get
            Return EE_DETER
        End Get
        Set(ByVal value As String)
    ...
    Public Property SUBPROGRAMA() As String
        Get
            Return EE_SUBPROGRAMA
        End Get
        Set(ByVal value As String)
            EE_SUBPROGRAMA = value
        End Set
    End Property
