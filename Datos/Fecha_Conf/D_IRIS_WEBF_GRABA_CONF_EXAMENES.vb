...
Public Class D_IRIS_WEBF_GRABA_CONF_EXAMENES
    Function D_IRIS_WEBF_GRABA_CONF_EXAMENES(ByVal ID_PRO As Integer, ByVal FECHA As String, ByVal CAT As Integer) As Integer
        ...
        Cmd_command.CommandText = "IRIS_WEBF_CMVM_GRABA_CONF_EXAMENES"
        ...
        Return Read_Sql
    End Function
    Function IRIS_WEBF_GRABA_CONF_EXAMENES_2(ByVal ID_PRO As String, ByVal FECHA As String, ByVal CANT As String, ByVal normal As String, ByVal prioritario As String, ByVal espontaneo As String) As Integer
        Dim objconexion As New Conexion.ConexionBD
        Dim Cmd_command As New OleDb.OleDbCommand
        Dim Read_Sql As Integer
        'definiendo tipo de consulta a la BD
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_CMVM_GRABA_CONF_EXAMENES_NEW_2"
        Cmd_command.Connection = objconexion.Connect_to_IrisLab_LoBarnechea
        'Enviar parámetros
        With Cmd_command.Parameters
            .Add("@ID_PRO", OleDbType.Numeric).Value = Convert.ToInt32(ID_PRO)
