...
Public Class D_InCo_TP
    Function IRIS_WEBF_BUSCA_LIS_ADM_TP(ByVal DESDE As String, ByVal HASTA As String, ByVal ID_TP As Integer) As List(Of E_InCo_TP)
        Dim objconexion As New Conexion.ConexionBD
        Dim Cmd_command As New OleDb.OleDbCommand
        Dim Obj_Read_Dt As E_InCo_TP
        Dim List_Reader As New List(Of E_InCo_TP)
        Dim Reader_Comm As OleDbDataReader
        Dim DD_GEN As New D_General_Functions
        'definiendo tipo de consulta a la BD
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_BUSCA_LIS_ADM_TP"
        ...
        While Reader_Comm.Read
            ...
            Obj_Read_Dt.TP_PAGO_DESC = DD_GEN.DB_NULL(Reader_Comm, 13, Nothing)
