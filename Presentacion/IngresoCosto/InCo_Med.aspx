<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="InCo_Med.aspx.vb" Inherits="Presentacion.InCo_Med" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    <script>
        ...
        function Llenar_Ddl_Doc() {
            //Debug
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_Med.aspx/Llenar_Ddl_Doc",
                //"data": Data_Par,
        ...
        function Fill_Ddl_Doc() {
            ...
            ).text("Todos").appendTo("#Slt_Doc");
            Mx_Ddl_Doc.forEach(aaa => {
                $("<option>",
                    {
                        "value": aaa.ID_DOCTOR
                    }
                ).text(aaa.DOC_NOMBRE+" "+aaa.DOC_APELLIDO).appendTo("#Slt_Doc");
            });
        }
        ...
        function Ajax_Datatable() {
            ...
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "InCo_Med.aspx/IRIS_WEBF_BUSCA_LIS_ADM_MED",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Fill_Dtt() {
            ...
            Mx_Dtt.forEach(aah=> {
                $("<tr>", {
                    ...
                    $("<td>").text(i + 1),
                    $("<td>").text(aah.ATE_NUM),
                    $("<td>").text(aah.DOC_NOMBRE+" "+aah.DOC_APELLIDO),
        ...
        function Ajax_Excel() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "HASTA": $("#fecha2").val(),
                "ID_DOC": $("#Slt_Doc").val(),
                "DOC_NOM": $("#Slt_Doc option:selected").text()
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card border-bar">
        <div class="card-header bg-bar">
            <h5 class="m-1">Ingreso vs Costos por Médico
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg">
                    <label for="Slt_Doc">Médico:</label>
                    <select id="Slt_Doc" class="form-control"></select>
                </div>
                <div class="col-lg">
                    <br />
