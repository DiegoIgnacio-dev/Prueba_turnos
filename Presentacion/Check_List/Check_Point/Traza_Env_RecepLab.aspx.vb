...
Public Class Traza_Env_RecepLab
    ...
    Public Shared Function Llenar_DataTable(ByVal TIPO As Integer,
        ...
        Try
            ...
            Data_Validado = NN.IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_SECCCION_POR_FOLIO_666_FECHAS_ENVIO_Y_RECEP_LAB_2(TIPO, date_01, date_02, ID_PRE, ID_ENVIO)
        ...
        If (Data_Validado.Count > 0) Then
            ...
            For y = 0 To (Data_Validado.Count - 1)
                ...
                If Data_Validado(y).ATE_EST_RECEP_DESC = Nothing Then
                    Mx_Data(15, y) = ""
                Else
                    Mx_Data(15, y) = Data_Validado(y).ATE_EST_RECEP_DESC
                End If

                If Data_Validado(y).ATE_USU_RECEP = Nothing Then
                    Mx_Data(16, y) = ""
                Else
                    Mx_Data(16, y) = Data_Validado(y).ATE_USU_RECEP
                End If

                If Data_Validado(y).ATE_FEC_RECEP = Nothing Then
                    Mx_Data(17, y) = ""
                Else
                    Mx_Data(17, y) = Format(Data_Validado(y).ATE_FEC_RECEP, "dd/MM/yyyy")
                End If
