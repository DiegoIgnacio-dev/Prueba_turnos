...
function Ajax_Prevision() {
    ...
    $.ajax({
        "type": "POST",
        "url": "REP_LAB_CANT_EXA_ARE_SECC_2_VALIDADOS.aspx/Llenar_Ddl_Prevision",
        //"data": Data_Par,
...
function Ajax_Ddl() {
    ...
    $.ajax({
        "type": "POST",
        "url": "REP_LAB_CANT_EXA_ARE_SECC_2_VALIDADOS.aspx/Llenar_Ddl",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable() {
    ...
    $.ajax({
        "type": "POST",
        "url": "REP_LAB_CANT_EXA_ARE_SECC_2_VALIDADOS.aspx/Llenar_DataTable",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_Excel() {
    ...
    $.ajax({
        "type": "POST",
        "url": "REP_LAB_CANT_EXA_ARE_SECC_2_VALIDADOS.aspx/Gen_Excel_Desagrupado",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
...
function Ajax_Excel_Agrupado() {
    ...
    $.ajax({
        "type": "POST",
        "url": "REP_LAB_CANT_EXA_ARE_SECC_2_VALIDADOS.aspx/Gen_Excel_Agrupado",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
...
function Fill_Ddl_Prevision() {
    ...
    //$("<option>", { "value": 0 }).text("TODAS").appendTo("#DdlPrevision");
