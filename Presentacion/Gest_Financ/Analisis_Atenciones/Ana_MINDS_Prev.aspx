<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master_MINDS.Master" CodeBehind="Ana_MINDS_Prev.aspx.vb" Inherits="Presentacion.Ana_MINDS_Prev" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ana_MINDS_Prev.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ana_MINDS_Prev.aspx/Llenar_Ddl",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Ddl_Prev() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ana_MINDS_Prev.aspx/Llenar_Ddl_Prev",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ana_MINDS_Prev.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ana_MINDS_Prev.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ana_MINDS_Prev.aspx/PDFF_4",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function Fill_DataTable() {
            ...
            for (i = 0; i < Mx_Dtt.length; ++i) {
                $("#DataTable tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "center" }).text("$ " + addCommas(Mx_Dtt[i].PREVI))
                        )
                );
            }
            ...
            $("#DataTableTotal thead").append(
                $("<tr>").append(
                    ...
                    $("<th>").css("text-align", "center").text("Total Ventas")
                )
            );
            var T_Ate = 0;
            var T_Exa = 0;
            ...
            for (i = 0; i < Mx_Dtt.length; i++) {
                ...
                T_ventas += parseFloat(Mx_Dtt[i].PREVI);
            }
            $("#DataTableTotal tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "center" }).text("$ " + addCommas(T_ventas))
                    )
                );
            var arr = ["Array"];
            var arr1 = [0];
