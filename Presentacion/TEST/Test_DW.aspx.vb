...
Public Class Test_DW
    ...
    Public Shared Function Busca_Datos(ByVal DESDE As String, ByVal HASTA As String) As List(Of E_DATA_PRODUCTOS)
        ...
        Dim Instancia_Negocio As New N_DATA_PRODUCTOS
        ...
        Return Instancia_Negocio.IRIS_WEBF_BUSCA_PRODUCTOS(DESDE, HASTA)
    End Function
