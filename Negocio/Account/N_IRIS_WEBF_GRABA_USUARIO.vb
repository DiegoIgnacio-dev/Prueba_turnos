...
Public Class N_IRIS_WEBF_GRABA_USUARIO
    ...
    Function IRIS_WEBF_GRABA_USUARIO(ByVal USU_RUT As String,
        ...
        Return DD_Data.IRIS_WEBF_GRABA_USUARIO(USU_RUT, NOMBRE_USU, APE_USU, FNAC_USU, DIR_USU, EMAIL_USU, ID_EST_USU, ID_CIU_COM, ID_PRO_USU, ID_CAR_USU, USUARIO, PASS, FONO, MOVIL, USU_ADMIN, USU_ID_PROC)
