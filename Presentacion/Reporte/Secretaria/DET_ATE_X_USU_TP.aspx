<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="DET_ATE_X_USU_TP.aspx.vb" Inherits="Presentacion.DET_ATE_X_USU_TP" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Ddl_T_Pago = [
    {
        ...
        function Ajax_Ddl_T_Pago() {
            ...
            $.ajax({
                "type": "POST",
                "url": "DET_ATE_X_USU_TP.aspx/Llenar_Ddl_T_Pago",
                //"data": '{}',
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "DET_ATE_X_USU_TP.aspx/Llenar_Ddl",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "DET_ATE_X_USU_TP.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "DET_ATE_X_USU_TP.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_Ddl() {
            ...
            for (y = 0; y < Mx_Ddl.length; ++y) {
                ...
                }).text(Mx_Ddl[y].USU_NIC + " - " + Mx_Ddl[y].USU_APELLIDO + " " + Mx_Ddl[y].USU_NOMBRE).appendTo("#DLLUSU");
            }
        };
        //Llenar DataTable
            ...
            $("#DataTable_Totales thead").append(
                ...
                $("#DataTable_Totales tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "center" }).text("$" + addCommas(tot_exa)),
