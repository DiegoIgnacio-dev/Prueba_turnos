...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            Ajax_DL_orden_ate();
            //Ajax_DL_prevision();
            Call_AJAX_Ddl_TP_PAGO();
            Ajax_DL_DOC();
            Ajax_DataTable_examen0GObal();
            Ajax_DataTable_examen02_particluar();
        ...
        var Mx_OMI = [
{
        ...
        var POSTA_REL = [
    {
        ...
        function Ajax_BUSCA_POSTA_REL() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_ate.aspx/Llenar_DL_POSTA",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    var json_receiver = response.d;
                    if (json_receiver != "null") {
                        POSTA_REL = JSON.parse(json_receiver);
                        Fill_DL_POSTA();
        ...
        function Fill_DL_POSTA() {
            $("#Posta").empty();


            for (y = 0; y < POSTA_REL.length; ++y) {
                $("<option>", {
                    "value": POSTA_REL[y].ID_POSTA
                }).text(POSTA_REL[y].POSTA_DESC).appendTo("#Posta");
            }
        };
        function Fill_DL_OMI() {
            ...
            for (c = 0; c < Mx_OMI.length; c++) {
                var objId = {
                    "Examen": Mx_OMI[c].Examen_Codigo,
                    "HO_CC": Mx_OMI[c].Orden
                };
            ...
            for (x = 0; x < Mx_OMI.length; x++) {
                switch (x) {
                    case 0:
                        var objId = {
                            "Examen": Mx_OMI[x].Examen_Codigo,
                            "HO_CC": Mx_OMI[x].Orden
                        };
                        MX_HO_ExamenCodigo.push(fnClone(objId));
                        break;
                    default:
                        if (Mx_OMI[x].Examen_Codigo != Mx_OMI[x - 1].Examen_Codigo) {
                            var objId = {
                                "Examen": Mx_OMI[x].Examen_Codigo,
                                "HO_CC": Mx_OMI[x].Orden
                            };
            ...
            for (x = 0; x < MX_HO_ExamenCodigo.length; x++) {
                for (y = 0; y < ftler.length; y++) {
                    if (MX_HO_ExamenCodigo[x].Examen == ftler[y].Examen) {
                        if (MX_HO_ExamenCodigo[x].Orden < ftler[y].Orden) {
        ...
        var Mx_examenes_OMI = [
{
    ...
    <script>
        ...
        function add_row() {
            ...
            if (xvalue != "") {
                $("#DataTable_pac2 tbody").append(
                        ...
                        $("<td>", {
                            "align": "center"
                        }).html("<button type='button' class='btn btn-default btn-xs borrar' value='Eliminar' data-id='0' style='padding: .1rem .1rem;font-size: 14px;cursor: pointer;'>X</button>")
                        )
                    )
                ...
                $(".tp_pago").change(function EnterEvent(e) {
                    if ($(this).val() == 20) {
                        var xId_pago = $(this).attr("id_pago");
                        console.log(xId_pago);
                        Ajax_DataTable_examen3_pago(xId_pago, $(this).val());
                    } else {

                        var xId_pago_2 = $(this).attr("id_pago");
                        console.log(xId_pago);
                        Ajax_DataTable_examen3_pago_2(xId_pago_2, $(this).val());
                ...
                $(".tp_programa").change(function EnterEvent(e) {

                    var xId_progra = $(this).attr("data-id_progama");
                    console.log(xId_progra);
                    Ajax_DataTable_examen3_programa(xId_progra, $(this).val());
                ...
                $(".tp_pago").change(function EnterEvent(e) {
                    if ($(this).val() == 20) {
                        var xId_pago = $(this).attr("id_pago");
                        console.log(xId_pago);
                        Ajax_DataTable_examen3_pago(xId_pago);
                    }
        ...
        function Ajax_guardar() {
            ...
            for (x = 0; x < Mx_Dtt_examcof.length; x++) {
                ...
                if ($("#TipoAtencion").val() == 1) {
                    ...
                    valor = Mx_Dtt_examcof[x].CF_PRECIO_HOS;
                ...
                var objId = {
                    ...
                    "CF_TP_PROGRA": Mx_Dtt_examcof[x].CF_TP_PROGRA,
                    "CF_VALOR": valor
                };
                ids.push(objId);
        ...
        function fn_Req_Prog_2() {
            ...
            objAJAX_Prog = $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Saydex.aspx/Request_Programa_2",
                //"data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
            ...
            $.ajax({
                ...
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        Hide_Modal();
                        $("#mError_AAH").modal('hide');
                        var str_Error = "El N° ingresado no pertenece a un paciente SAYDEX";
                        $("#title").text("N° SAYDEX no encontrado :");
                        $("#button_modal").attr("class", "btn btn-danger");
        ...
        var Mx_Dtt_exam02_particular = [
{
    ...
    "CF_DIAS": 0,
        ...
        function Ajax_DataTable_examen02_particluar() {
            var f = moment().format("DD-MM-YYYY");
        ...
        //function Ajax_DataTable_examen3_pago(xxid_pago, select_id) {
        //    console.log(xxid_pago);
        //    for (i = 0; i < Mx_Dtt_exam02_particular.length; i++) {
        //        if (Mx_Dtt_exam02_particular[i].ID_CODIGO_FONASA == xxid_pago) {
        //            $("input[data-id='" + xxid_pago + "']").val(Mx_Dtt_exam02_particular[i].CF_COD);
        //            $("input[data-id='" + xxid_pago + "']").parent().parent().children(".td_val1").text(Mx_Dtt_exam02_particular[i].CF_DESC);
        //            $("input[data-id='" + xxid_pago + "']").parent().parent().children(".td_val2").text(Mx_Dtt_exam02_particular[i].CF_DIAS);
        //            if ($("#TipoAtencion").val() == 1) {
        //                $("input[data-id='" + xxid_pago + "']").parent().parent().children(".td_val3").text("$ " + Mx_Dtt_exam02_particular[i].CF_PRECIO_AMB);
        //            }
        //            else {
        //                $("input[data-id='" + xxid_pago + "']").parent().parent().children(".td_val3").text("$ " + Mx_Dtt_exam02_particular[i].CF_PRECIO_HOS);
        //            }
        //            $("input[data-id='" + xxid_pago + "']").attr("data-cod", Mx_Dtt_exam02_particular[i].CF_COD);

        //        }
        //    }
        //    for (i = 0; i < Mx_Dtt_examcof.length; i++) {
        //        if (Mx_Dtt_examcof[i].ID_CODIGO_FONASA == xxid_pago) {
        //            for (x = 0; x < Mx_Dtt_exam02_particular.length; x++) {
        //                if (Mx_Dtt_exam02_particular[x].ID_CODIGO_FONASA == xxid_pago) {
        //                    Mx_Dtt_examcof[i].CF_COD = Mx_Dtt_exam02_particular[x].CF_COD;
        //                    Mx_Dtt_examcof[i].CF_DESC = Mx_Dtt_exam02_particular[x].CF_DESC;
        //                    Mx_Dtt_examcof[i].CF_DIAS = Mx_Dtt_exam02_particular[x].CF_DIAS;
        //                    Mx_Dtt_examcof[i].CF_PRECIO_AMB = Mx_Dtt_exam02_particular[x].CF_PRECIO_AMB;
        //                    Mx_Dtt_examcof[i].CF_PRECIO_HOS = Mx_Dtt_exam02_particular[x].CF_PRECIO_HOS;
        //                    Mx_Dtt_examcof[i].CF_TP_PAGO = select_id;
        //                }
        //            }
        ...
        //for (i = 0; i < Mx_Dtt_examcof.length; i++) {
        //    if ($("#TipoAtencion").val() == 1) {
        //        sumaas = parseInt(sumaas) + parseInt(Mx_Dtt_examcof[i].CF_PRECIO_AMB);
        //    }
        //    else {
        //        sumaas = parseInt(sumaas) + parseInt(Mx_Dtt_examcof[i].CF_PRECIO_HOS);
        //    }
        ...
        //function Ajax_DataTable_examen3_pago_2(xxid_pago_2, select_id_2) {

        //    for (i = 0; i < Mx_Dtt_exam02_particular.length; i++) {
        //        if (Mx_Dtt_exam02[i].ID_CODIGO_FONASA == xxid_pago_2) {
        //            $("input[data-id='" + xxid_pago_2 + "']").val(Mx_Dtt_exam02[i].CF_COD);
        //            $("input[data-id='" + xxid_pago_2 + "']").parent().parent().children(".td_val1").text(Mx_Dtt_exam02[i].CF_DESC);
        //            $("input[data-id='" + xxid_pago_2 + "']").parent().parent().children(".td_val2").text(Mx_Dtt_exam02[i].CF_DIAS);
        //            if ($("#TipoAtencion").val() == 1) {
        //                $("input[data-id='" + xxid_pago_2 + "']").parent().parent().children(".td_val3").text("$ " + Mx_Dtt_exam02[i].CF_PRECIO_AMB);
        //            }
        //            else {
        //                $("input[data-id='" + xxid_pago_2 + "']").parent().parent().children(".td_val3").text("$ " + Mx_Dtt_exam02[i].CF_PRECIO_HOS);
        //            }
        //            $("input[data-id='" + xxid_pago_2 + "']").attr("data-cod", Mx_Dtt_exam02[i].CF_COD);

        //        }

        //    }
        //    for (i = 0; i < Mx_Dtt_examcof.length; i++) {
        //        if (Mx_Dtt_examcof[i].ID_CODIGO_FONASA == xxid_pago_2) {
        //            for (x = 0; x < Mx_Dtt_exam02.length; x++) {
        //                if (Mx_Dtt_exam02[x].ID_CODIGO_FONASA == xxid_pago_2) {
        //                    Mx_Dtt_examcof[i].CF_COD = Mx_Dtt_exam02[x].CF_COD;
        //                    Mx_Dtt_examcof[i].CF_DESC = Mx_Dtt_exam02[x].CF_DESC;
        //                    Mx_Dtt_examcof[i].CF_DIAS = Mx_Dtt_exam02[x].CF_DIAS;
        //                    Mx_Dtt_examcof[i].CF_PRECIO_AMB = Mx_Dtt_exam02[x].CF_PRECIO_AMB;
        //                    Mx_Dtt_examcof[i].CF_PRECIO_HOS = Mx_Dtt_exam02[x].CF_PRECIO_HOS;
        //                    Mx_Dtt_examcof[i].CF_TP_PAGO = select_id_2;
        ...
        //    for (i = 0; i < Mx_Dtt_examcof.length; i++) {
        //        if ($("#TipoAtencion").val() == 1) {
        //            sumaas2 = parseInt(sumaas2) + parseInt(Mx_Dtt_examcof[i].CF_PRECIO_AMB);
        //        }
        //        else {
        //            sumaas2 = parseInt(sumaas2) + parseInt(Mx_Dtt_examcof[i].CF_PRECIO_HOS);
        //        }

        //    }
        //    $("#precio_").text("$" + sumaas2);


        //}
        function Ajax_DataTable_examen3_programa(xxid_pROGRAMA, select_id_2) {

          
            for (i = 0; i < Mx_Dtt_examcof.length; i++) {
                if (Mx_Dtt_examcof[i].ID_CODIGO_FONASA == xxid_pROGRAMA) {
                    Mx_Dtt_examcof[i].CF_TP_PROGRA = parseInt(select_id_2);
        ...
        var Mx_Ddl_TP_PAGO = [
{
    ...
    "ID_ESTADO": ""
        ...
        function Call_AJAX_Ddl_TP_PAGO() {



            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Saydex.aspx/TP_Pgo",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    var json_receiver = response.d;
                    if (json_receiver != "null") {
                        Mx_Ddl_TP_PAGO = JSON.parse(json_receiver);
                    } else {
                    }
                },
                "error": function (response) {
            ...
            $.ajax({
                ...
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        Hide_Modal();
                        var str_Error = "El rut ingresado no pertenece a un paciente SAYDEX";
        ...
        function Ajax_modal_exa_RUT() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Saydex.aspx/MODAL_PAC_RUT",
                "data": Data_Par_modal,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": Data_Par_modal_paciente => {
                    ...
                    var obj_RUT2 = Valid_RUT(Mx_Dtt2[0].Rut);

                    if ((Mx_Detalle_ate.proparra1.length == 0) || (Mx_Detalle_ate.proparra1[0].PAC_RUT == undefined && Mx_Detalle_ate.proparra1.length > 0)) {
                        $("#DataTable_pac2 tbody").empty();
                        add_row();
                        Fill_DL_Rut();
                        Hide_Modal();
                        ...
                        if (Mx_Detalle_ate.proparra1[0].PAC_RUT == obj_RUT2.Format) {
                            ...
                            window.location.replace(loc + "/Agenda_Med/AGRE_EXA_ATE_2.aspx" + "?Rt" + "=" + Mx_Dtt2[0].Rut + "&Di=" + "NONE");
                        } else {
        ...
        function Ajax_modal_exa_RUT_2() {
            modal_show();
            Mx_Detalle_ate = 0;
            var obj_RUT3 = Valid_RUT(Mx_AVIS[0].Rut);
                ...
                "success": Data_Par_modal_paciente => {
                    ...
                    if ((Mx_Detalle_ate.proparra1.length == 0) || (Mx_Detalle_ate.proparra1[0].PAC_RUT == undefined && Mx_Detalle_ate.proparra1.length > 0)) {
                        ...
                        if (Mx_Detalle_ate.proparra1[0].PAC_RUT == obj_RUT3.Format) {
                            console.log("la otra pagina 2");
                            var loc = location.origin;
                            window.location.replace(loc + "/Agenda_Med/AGRE_EXA_ATE_2.aspx" + "?Rt" + "=" + Mx_AVIS[0].Rut + "&Di=" + "NONE");
                        } else {
        ...
        var Mx_DL_Diag2 = [
{
                ...
                $("#DataTable_pac2 tbody").append(
                    $("<tr>", {
                      ...
                      //}(),
                       ...
                       $("<td>", {
                           "align": "center"
                       }).html("<button type='button' class='btn btn-default btn-xs borrar' value='Eliminar' data-id='" + Mx_Dtt_examcof[i].ID_CODIGO_FONASA + "' style='padding: .1rem .1rem;font-size: 14px;cursor: pointer;'>X</button>")
                        )
            ...
            if (Mx_Dtt_exam03.length == 0) {
                ...
                if (repetido == 0) {
                    ...
                    if ($("#TipoAtencion").val() == 1) {
                        ...
                        $("input[data-id='" + xxid + "']").parent().parent().children(".td_val3").text("$ " + Mx_Dtt_exam03[0].CF_PRECIO_HOS);
                    }

                    $("input[data-id='" + xxid + "']").parent().parent().children(".id_pago").text(Mx_Dtt_exam03[0].ID_CODIGO_FONASA);

                    //$("input[data-id='" + xxid + "']").parent().parent().children(".id_progama").text(Mx_Dtt_exam03[0].ID_CODIGO_FONASA);
                    //$("input[data-id='" + xxid + "']").parents("tr").find(`select`).attr("data-id_progama", Mx_Dtt_exam03[0].ID_CODIGO_FONASA);

                    //if (Mx_Dtt_exam03[0]["CF_TP_PROGRA"] == 0) {
                    //    $("input[data-id='" + xxid + "']").parents("tr").find(`select`).val(1);

                    //} else {
                    //    $("input[data-id='" + xxid + "']").parents("tr").find(`select`).val(Mx_Dtt_exam03[0].CF_TP_PROGRA);

                    //}



                    if (Mx_Dtt_exam03[0].CF_TP_PROGRA == 32) {
                        $("input[data-id='" + xxid + "']").parents("tr").find(`select`).attr('disabled', true)
                    }
                    ...
                    Mx_Dtt_examcof.push(Mx_Dtt_exam03[0]);
                    Mx_Dtt_examcof[Mx_Dtt_examcof.length - 1]["CF_ESTADO_EXAMEN"] = "Activo"
                    //Mx_Dtt_examcof[Mx_Dtt_examcof.length - 1]["CF_TP_PROGRA"] = 1
    ...
    <script>
        ...
        function fn_Req_Prev() {
            ...
            objAJAX_Prev = $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Saydex.aspx/Request_Prevision",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function fn_Req_Prog() {
            ...
            objAJAX_Prog = $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Saydex.aspx/Request_Programa",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function fn_Req_SubP() {
            ...
            objAJAX_SubP = $.ajax({
                "type": "POST",
                "url": "Ingreso_Ate_Saydex.aspx/Request_SubPrograma",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
...
<%--                                                 <div class="col-sm">
                                <label class="textoReducido">Posta:</label>
                                <select id="Posta" class="form-control textoReducido" style="height: 31.75px;">
                                    <option value="0">Seleccionar</option>
                                </select>
                            </div>--%>
                            <div class="col-lg">
...
<%--                     <div class="col-sm">
                    ...
                    <%--<div class="col-sm">
                            ...
                            <div class="col-lg">
                                ...
                                <select id="Ddl_Prog02" class="form-control textoReducido" style="height: 31.75px;">
                                    <option value="volvo">Seleccionar</option>
                                </select>
                            </div>
                            <div class="col-lg">
            ...
            <div class="container" style="max-width: 100%; border: 0px solid #fff;">
                <div class="row">
                   <div class="col-sm-4">
                    ...
                    <div class="col-sm-4" style="justify-content: flex-end;">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="col-sm-3">
                            <h5 style="/*! color: #ec1d1d; */font-weight: 900;">Resumen:</h5>
                            <div class="col-sm">
                                <h6>Precio Total: <span id="precio_" class="label label-info"></span></h6>
                            </div>
                            <div class="col-sm">
                                <h6>Cant. Exámenes: <span id="Cantida_" class="label label-info"></span></h6>
                            </div>
                        </div>-->
                </div>
            </div>
