...
Public Class ValoresCriticos_EMB_2
    ...
    End Sub
    <Services.WebMethod()>
    Public Shared Function Request_Prevision(ByVal ID_USER As Integer) As List(Of E_IRIS_WEBF_BUSCA_PREVISION_ACTIVO)
        ...
        data_paciente = NN.IRIS_WEBF_CMVM_BUSCA_PREVISION_ACTIVO_PREVE_ID_USER(ID_USER)

        Return data_paciente
    End Function

    <Services.WebMethod()>
    Public Shared Function Llenar_Ddl_LugarTM(ByVal ID_PREV As Integer, ByVal ID_USER As Integer) As String
        ...
        Data_LugarTM = NN_LugarTM.IRIS_WEBF_CMVM_BUSCA_PROCEDENCIA_ACTIVO_BY_ID_PREV(ID_PREV, ID_USER)
    ...
    Public Shared Function Call_DataTable(ByVal DATE_str01 As String,
                                          ...
                                          ByVal ID_PREVE As Integer) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        ...
        List_Obj = NN_Table.IRIS_WEBF_BUSCA_EST_ESTADOS_VALORES_CRITICOS_emb_NEW(Date_011, DATE_str022, ID_EXAM, ID_PROg, ID_PRUEB, ID_RESUL, ID_STAT, ID_SECC, ID_PROCE, ID_PREVE)
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Call_Export(ByVal DOMAIN_URL As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String, ByVal ID_EXAM As Long, ByVal ID_PROg As Long,
                                       ByVal ID_PRUEB As Integer, ByVal ID_RESUL As Long, ByVal id_est As Integer, ByVal ID_SECC As Integer,
                                       ByVal ID_PROCE As Integer, ByVal ID_PREVE As Integer) As String

        Dim NN_Table As New N_Check_Val_Criticos
        Dim URL As String
        URL = NN_Table.Gen_Excel5_NEW(DOMAIN_URL, DATE_str01, DATE_str02, ID_EXAM, ID_PROg, ID_PRUEB, ID_RESUL, id_est, ID_SECC, ID_PROCE, ID_PREVE)
