<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Prev_TM_Exa_Mult_Valid_OMI_GROUP.aspx.vb" Inherits="Presentacion.Prev_TM_Exa_Mult_Valid_OMI_GROUP" %>
        ...
        var Mx_Ddl_Medi = [
   {
       ...
       "DOC_MOVIL1": "asdf"
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_Valid_OMI_GROUP.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
  {
      "urls": ""
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Prev_TM_Exa_Mult_Valid_OMI_GROUP.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        ...
                        <select id="DdlPrevi" class="form-control">
                            <option value="126">Peñalolen</option>
                        </select>
                    </div>
                    <div class="col-lg">
