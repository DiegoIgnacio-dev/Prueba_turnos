    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#Btn_Crear_Lote").click(function () {
                if (Mx_Dtt_Load.List_Data[0].ID_USUARIO == 0) {
            ...
            $.ajax({
                ...
                "success": function (response) {
                    ...
                    if (json_receiver.List_Data.length > 0) {
                        ...
                        for (i = 0; i < Mx_Dtt_Load.List_Data.length; ++i) {
                            var date_x = Mx_Dtt_Load.List_Data[i].ENVIO_ETI_FECHA;
                            date_x = String(date_x).replace("/Date(", "");
                            date_x = date_x.replace(")/", "");

                            var Date_Change = new Date(parseInt(date_x));
                            Mx_Dtt_Load.List_Data[i].ENVIO_ETI_FECHA = Date_Change;
                        }
            ...
            $.ajax({
                ...
                "success": function (response) {
                    ...
                    if (json_receiver != "null") {
                        ...
                        Mx_Dtt_Load.List_Data[0].ID_USUARIO = 0;
        ...
        function Fill_DataTable_Load() {
            ...
            for (i = 0; i < Mx_Dtt_Load.List_Data.length; i++) {
                //if (xi == 0) {
                    ...
                    $("<tr>", {
                        "onclick": `Ajax_Get_values_to_Pendiente("` + Mx_Dtt_Load.List_Data[i].CB_DESC + `","` + Mx_Dtt_Load.List_Data[i].ATE_NUM + `")`,
                        "ondblclick": `Llenar_Modal_Cargar_Doble_click("` + Mx_Dtt_Load.List_Data[i].ATE_NUM + `")`,
                        "class": "manito"
                    }).append(
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(i + 1),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text("[" + Mx_Dtt_Load.List_Data[i].CB_DESC + "]" + " " + Mx_Dtt_Load.List_Data[i].T_MUESTRA_DESC),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt_Load.List_Data[i].CF_DESC),
                        $("<td>").css("text-align", "center").text(function () {
                            if (Mx_Dtt_Load.List_Data[i].EST_DESCRIPCION == "RECEP.") {
                                $(this).css("cssText", "background-color: #88d6e2 !important; cursor:pointer; text-align:center;").text("RECEP.");
                            }
                            else {
                                $(this).css("cssText", "background-color:#f5b0e5 !important; text-align:center;").text(Mx_Dtt_Load.List_Data[i].EST_DESCRIPCION);
                            }
                        }),
                        $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(function () {
                            //Obtener valores
                            var obj_date = new Date(Mx_Dtt_Load.List_Data[i].ENVIO_ETI_FECHA);
                        ...
                        $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(function () {
                            //Obtener valores
                            var obj_date2 = new Date(Mx_Dtt_Load.List_Data[i].ENVIO_ETI_FECHA);
                        ...
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt_Load.List_Data[i].PAC_NOMBRE + " " + Mx_Dtt_Load.List_Data[i].PAC_APELLIDO),
                        $("<td>", { "align": "center" }, { "class": "textoReducido" }).text(Mx_Dtt_Load.List_Data[i].ATE_NUM),
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(Mx_Dtt_Load.List_Data[i].USU_NIC)
                    )
                );
                //} else if (((xi > 0) && (Mx_Dtt_Load.List_Data[xi].CB_DESC != Mx_Dtt_Load.List_Data[xi - 1].CB_DESC))) {
                    //$("#DataTable_Load tbody").append(
                    //                    $("<tr>", {
                //                        "onclick": `Ajax_Get_values_to_Pendiente("` + Mx_Dtt_Load.List_Data[i].CB_DESC + `","` + Mx_Dtt_Load.List_Data[i].ATE_NUM + `")`,
                //                        "ondblclick": `Llenar_Modal_Cargar_Doble_click("` + Mx_Dtt_Load.List_Data[i].ATE_NUM + `")`,
