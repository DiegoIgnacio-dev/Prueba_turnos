<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="GraficoTPUser.aspx.vb" Inherits="Presentacion.GraficoTPUser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoTPUser.aspx/Llenar_Ddl",
                //"data": '{}',
        ...
        function Ajax_Ddl_TP() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoTPUser.aspx/Call_User_Data",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "GraficoTPUser.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel() {
            ...
            var Data_Par = JSON.stringify({
                ...
                "Dll": String($("#DllTP").val()),
                "Año": $("#DllAño option:selected").text(),
                "USER": String($("#DllTP option:selected").text()),
                "Mes": $("#DllMes").val()
            });
            $(".block_wait").fadeIn(500);
            $.ajax({
                "type": "POST",
                "url": "GraficoTPUser.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_Ddl_TP() {
            ...
            for (y = 0; y < Mx_Ddl_TP.length; ++y) {
                $("<option>", {
                    "value": Mx_Ddl_TP[y].ID_USUARIO
                }).text(Mx_Ddl_TP[y].USU_NIC + " - " + Mx_Ddl_TP[y].USU_NOMBRE + " " + Mx_Ddl_TP[y].USU_APELLIDO).appendTo("#DllTP");
            }
        };
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Body" runat="server">
    <div class="card mb-3 border-bar">
        <div class="card-header bg-bar">
            <h5>Cantidad Anual por Usuario</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-2">
                    <label for="DllMes">Mes:</label>
                    <select id="DllMes" class="form-control">
