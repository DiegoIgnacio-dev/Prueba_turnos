<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master_MINDS.Master" CodeBehind="REP_LAB_CANT_MINDS_EXA_SECC.aspx.vb" Inherits="Presentacion.REP_LAB_CANT_MINDS_EXA_SECC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function AJAX_Ddl() {
            ...
            obj_AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_MINDS_EXA_SECC.aspx/Llenar_Ddl",
                //"data": '{}',
        ...
        function AJAX_Dtt() {
            ...
            obj_AJAX_Dtt = $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_MINDS_EXA_SECC.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function AJAX_Xls() {
            ...
            obj_AJAX_Xls = $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_MINDS_EXA_SECC.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Fill_Dtt() {
            ...
            for (i = 0; i < obj_JSON_Dtt.length; ++i) {
                $("#DataTable tbody").append(
                    ...
                    $("<td>", { "align": "center" }).text(i + 1),
                        ...
                        $("<td>", {"align": "center","width": "20%"}).text("$ " + addCommas(obj_JSON_Dtt[i].TOTA_SIS))
                    )
                );
            }
            $("#DataTable").DataTable({
            ...
            for (i = 0; i < obj_JSON_Dtt.length; i++) {
                ...
                arr.push(obj_JSON_Dtt[i].CF_DESC);
                arr1.push(parseFloat(obj_JSON_Dtt[i].TOTAL_ATE));
                //arr2.push(parseFloat(obj_JSON_Dtt[i].TOT_FONASA));
            }
