<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master_PROVEE.Master" CodeBehind="REP_LAB_CANT_EXA_CART_MEN.aspx.vb" Inherits="Presentacion.REP_LAB_CANT_EXA_CART_MEN" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_CART_MEN.aspx/Llenar_Ddl_Exam",
                //"data": Data_Par,
        ...
        function Ajax_Ddl_Proce() {
            ...
            AJAX_Ddl = $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_CART_MEN.aspx/Llenar_Ddl_LugarTM",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": data => {
        ...
        function Ajax_Ddl() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_CART_MEN.aspx/Llenar_Ddl",
                //"data": '{}',
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_CART_MEN.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_CART_MEN.aspx/PDFF",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "REP_LAB_CANT_EXA_CART_MEN.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
    ...
    <script>
        ...
        function Ajax_ONCLICK(_PROG) {
            ...
            window.open(loc + "/Gest_Financ/Estadisticas/Detalle/REP_LAB_CANT_EXA_CART_MEN_DET.aspx?&P3=" + _PROG);
        }
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>").css("text-align", "center").text("Año"),
...
<asp:Content ID="Content3" ContentPlaceHolderID="Cph_Body" runat="server">
    ...
    <div class="card mb-3 border-bar">
        <div class="card-header bg-bar">
            <h5>Análisis Cartola Mensual</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-2">
