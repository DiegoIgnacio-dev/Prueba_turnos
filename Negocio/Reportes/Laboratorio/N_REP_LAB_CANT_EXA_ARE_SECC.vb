...
Public Class N_REP_LAB_CANT_EXA_ARE_SECC
    ...
    End Function
    Function IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_VALIDADOS_REVISADOS(ByVal ID_TP_PAGO As Long, ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_PROC As Integer) As List(Of E_IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION)
        Return DD_Data.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_VALIDADOS_REVISADOS(ID_TP_PAGO, DESDE, HASTA, ID_PROC)
    End Function
    Function IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_VALIDADOS(ByVal ID_TP_PAGO As Long, ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_PROC As Integer) As List(Of E_IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION)
        Return DD_Data.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_VALIDADOS(ID_TP_PAGO, DESDE, HASTA, ID_PROC)
    End Function
    Function IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_TODOS(ByVal ID_TP_PAGO As Long, ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_PROC As Integer) As List(Of E_IRIS_BUSCA_WEBF_LIS_ADM_RESU_CANT_EXAMENES_AREA_SECCION)
        Return DD_Data.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_TODOS(ID_TP_PAGO, DESDE, HASTA, ID_PROC)
    End Function
    ...
    Function Gen_Excel_Minds(ByVal MAIN_URL As String, ByVal ID_CODIGO_FONASA As Long, ByVal DATE1 As String, ByVal DATE2 As String, ByVal VALOR As Integer) As String
        ...
        If (VALOR = 0) Then
            Data_Exam = NN_Exam.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_VALIDADOS(ID_CODIGO_FONASA, Date01, Date02, cookie_proc)
        ElseIf VALOR = 1 Then
            Data_Exam = NN_Exam.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_VALIDADOS_REVISADOS(ID_CODIGO_FONASA, Date01, Date02, cookie_proc)
        ElseIf VALOR = 2 Then
            Data_Exam = NN_Exam.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_AREA_TODOS(ID_CODIGO_FONASA, Date01, Date02, cookie_proc)
        End If
