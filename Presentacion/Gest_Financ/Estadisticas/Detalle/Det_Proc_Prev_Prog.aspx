<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Det_Proc_Prev_Prog.aspx.vb" Inherits="Presentacion.Det_Proc_Prev_Prog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <script>
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Det_Proc_Prev_Prog.aspx/Llenar_DataTable",
                "data": Data_Par,
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Det_Proc_Prev_Prog.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_PDF = [
{
    "urls": ""
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Det_Proc_Prev_Prog.aspx/PDFF",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
