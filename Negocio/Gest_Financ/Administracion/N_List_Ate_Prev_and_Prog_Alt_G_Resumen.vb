...
Public Class N_List_Ate_Prev_and_Prog_Alt_G_Resumen
    ...
    End Function
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_IST(ByVal ID_PRE2 As Long, ByVal DESDE As Date, ByVal HASTA As Date) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA)
        Return DD_Data.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_IST(ID_PRE2, DESDE, HASTA)
    End Function
    Function IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_GER(ByVal ID_PRE2 As Long, ByVal DESDE As Date, ByVal HASTA As Date) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA)
        Return DD_Data.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_GER(ID_PRE2, DESDE, HASTA)
    End Function
    ...
    End Function
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA_IST(ByVal ID_PRE2 As Long, ByVal ID_PRE3 As Long, ByVal DESDE As Date, ByVal HASTA As Date) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA)
        Return DD_Data.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA_IST(ID_PRE2, ID_PRE3, DESDE, HASTA)
    End Function
    ...
    End Function
    Function IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_SOLO_VALIDADOS(ByVal ID_PRE2 As Long, ByVal DESDE As Date, ByVal HASTA As Date) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA)
        Return DD_Data.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_SOLO_VALIDADOS(ID_PRE2, DESDE, HASTA)
    End Function
    Function IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA_SOLO_VALIDADOS(ByVal ID_PRE2 As Long, ByVal ID_PRE3 As Long, ByVal DESDE As Date, ByVal HASTA As Date) As List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA)
        Return DD_Data.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA_SOLO_VALIDADOS(ID_PRE2, ID_PRE3, DESDE, HASTA)
    End Function
    ...
    '    Xls.SetCellValue(tablePosRow, tablePosCol_now, "A Facturar") : tablePosCol_now += 1
    '    If (Data_OUT(0).Data_Proced.Count <> 0) Then
    ...
    '    Xls.SetColumnWidth(tablePosCol_now, 17) : tablePosCol_now += 1
    '    Xls.SetColumnWidth(tablePosCol_now, 15) : tablePosCol_now += 1
    '    Xls.SetColumnWidth(tablePosCol_now, 80) : tablePosCol_now += 1
    '    For y = 0 To (Data_OUT(0).Data_Proced.Count - 1)
    ...
    '    'Inner_Table.SetTableStyle(SLTableStyleTypeValues.Light1)
    ...
    Function Gen_Excel(ByVal MAIN_URL As String, ByVal Group As Integer, ByVal ID_PREV As Long, ByVal ID_PROG As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As String
        ...
        'Realizar consulta inicial
        Data_OUT = Gen_Table_2(ID_PREV, ID_PROG, DATE_str01, DATE_str02)
        ...
        Return MAIN_URL & "/" & Replace(Relative_Path, "\", "/")
    End Function
    Function Gen_Excel_Val(ByVal MAIN_URL As String, ByVal Group As Integer, ByVal ID_PREV As Long, ByVal ID_PROG As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As String
        'Declaraciones internas
        Dim NN_Date As New N_Date
        Dim Date_01 As Date = NN_Date.strToDate(Split(DATE_str01, "/")(2), Split(DATE_str01, "/")(1), Split(DATE_str01, "/")(0))
        Dim Date_02 As Date = NN_Date.strToDate(Split(DATE_str02, "/")(2), Split(DATE_str02, "/")(1), Split(DATE_str02, "/")(0))
        ...
        Dim Data_OUT As New List(Of E_Ate_Prev_Prog_JSON_Output)
        'Realizar consulta inicial
        Data_OUT = Gen_Table_Val(ID_PREV, ID_PROG, DATE_str01, DATE_str02)
        If (Group <> 0) Then
            Data_OUT = Group_Elem(Data_OUT)
        End If
        'Select Case (Group)
    ...
    Function Gen_Table_Val(ByVal ID_PREV As Long, ByVal ID_PROG As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As List(Of E_Ate_Prev_Prog_JSON_Output)
        'Declaraciones internas
        Dim NN_Date As New N_Date
        Dim Date_01 As Date = NN_Date.strToDate(Split(DATE_str01, "/")(2), Split(DATE_str01, "/")(1), Split(DATE_str01, "/")(0))
        Dim Date_02 As Date = NN_Date.strToDate(Split(DATE_str02, "/")(2), Split(DATE_str02, "/")(1), Split(DATE_str02, "/")(0))
        ...
        Select Case (ID_PROG)
            Case 0, "", "null", "0", Nothing
                Data_Search = NN_Search.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_SOLO_VALIDADOS(ID_PREV, Date_01, Date_02)
            Case Else
                Data_Search = NN_Search.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA_SOLO_VALIDADOS(ID_PREV, ID_PROG, Date_01, Date_02)
        End Select
        'Recorrer consulta general
        For y = 0 To (Data_Search.Count - 1)
            Dim ItemList As New E_Ate_Prev_Prog_JSON_Output
    ...
    Function Gen_Table_2(ByVal ID_PREV As Long, ByVal ID_PROG As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As List(Of E_Ate_Prev_Prog_JSON_Output)
        'Declaraciones internas
        Dim NN_Date As New N_Date_Operat
        Dim Date_01 As Date = NN_Date.strToDate(Split(DATE_str01, "/")(2), Split(DATE_str01, "/")(1), Split(DATE_str01, "/")(0))
        Dim Date_02 As Date = NN_Date.strToDate(Split(DATE_str02, "/")(2), Split(DATE_str02, "/")(1), Split(DATE_str02, "/")(0))
        ...
        For y = 0 To (Data_Search.Count - 1)
            ...
            If (Data_Search(y).ID_CODIGO_FONASA = 690 Or Data_Search(y).ID_CODIGO_FONASA = 691) Then
                Debug.WriteLine("Creatinina !")
            End If
        ...
        Select Case ID_PROG
            Case 0
                For y = 0 To (Data_OUT.Count - 1)
                    ...
                    strSQL.Append("	   AND (dbo.IRIS_ATENCION.ID_PREVE = @ID_PREV) " & vbLf)
                    strSQL.Append("	   AND (dbo.IRIS_DET_ATENCION.ID_CODIGO_FONASA = @ID_COD_FONASA)" & vbLf)
                    strSQL.Append("	   AND ((dbo.IRIS_DET_ATENCION.ATE_DET_V_ID_ESTADO = 6) or (dbo.IRIS_DET_ATENCION.ATE_DET_V_ID_ESTADO = 14)) " & vbLf)
                    strSQL.Append("" & vbLf)
                    strSQL.Append("	   --Procedencias" & vbLf)
                    ...
                    strSQL.Append("" & vbLf)
                    strSQL.Append("Group BY" & vbLf)
                    'strSQL.Append("    dbo.IRIS_CODIGO_FONASA.ID_CODIGO_FONASA," & vbLf)
                    strSQL.Append("    dbo.IRIS_CODIGO_FONASA.CF_COD," & vbLf)
                    strSQL.Append("    dbo.IRIS_CODIGO_FONASA.CF_DESC," & vbLf)
                    strSQL.Append("    dbo.IRIS_DET_ATENCION.ID_CODIGO_FONASA," & vbLf)
                    strSQL.Append("    dbo.IRIS_DET_ATENCION.ID_ESTADO," & vbLf)
                    ...
                    strSQL.Append("HAVING" & vbLf)
                    strSQL.Append("    (dbo.IRIS_DET_ATENCION.ID_ESTADO = 1)" & vbLf)
                    'strSQL.Append("ORDER BY" & vbLf)
                    'strSQL.Append("    dbo.IRIS_CODIGO_FONASA.ID_CODIGO_FONASA DESC" & vbLf)
                    ...
                    If Data_Proc_Val.Count > 0 Then
                        If (Data_Proc_Val(0).ID_CODIGO_FONASA = 1255) Then
                            Dim hola As String
                            hola = "hola"
                        End If
                    End If
        ...
        'Ordenar solo Peñalolen
        If (ID_PREV = 126 Or ID_PREV = 235) Then
            Data_OUT = Ordenar_Peñalolen(Data_OUT, Data_Proc_Info)
        End If

        'Multiplicar x3 los valores de Electrolitos
        For y = 0 To Data_OUT.Count - 1
            If (Data_OUT(y).ID_CODIGO_FONASA = 74 Or Data_OUT(y).ID_CODIGO_FONASA = 1413 Or Data_OUT(y).ID_CODIGO_FONASA = 1220 Or Data_OUT(y).ID_CODIGO_FONASA = 1481) Then
                Data_OUT(y).TOTAL_ATE *= 3
                Data_OUT(y).TOT_FONASA *= 3
                Data_OUT(y).Data_Fonasa.CF_PRECIO_AMB *= 3
        ...
        Return Data_OUT
    End Function
    Function Gen_Table_2_IST(ByVal ID_PREV As Long, ByVal ID_PROG As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As List(Of E_Ate_Prev_Prog_JSON_Output)
        'Declaraciones internas
        Dim NN_Date As New N_Date_Operat
        Dim Date_01 As Date = NN_Date.strToDate(Split(DATE_str01, "/")(2), Split(DATE_str01, "/")(1), Split(DATE_str01, "/")(0))
        Dim Date_02 As Date = NN_Date.strToDate(Split(DATE_str02, "/")(2), Split(DATE_str02, "/")(1), Split(DATE_str02, "/")(0))
        ...
        Select Case (ID_PROG)
            Case 0, "", "null", "0", Nothing
                Data_Search = NN_Search.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_IST(ID_PREV, Date_01, Date_02)

            Case Else
                Data_Search = NN_Search.IRIS_WEBF_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_PROGRAMA_IST(ID_PREV, ID_PROG, Date_01, Date_02)
        ...
        Select Case ID_PROG
            Case 0
                For y = 0 To (Data_OUT.Count - 1)
                    ...
                    strSQL.Append("	   AND (dbo.IRIS_DET_ATENCION.ID_CODIGO_FONASA = @ID_COD_FONASA)" & vbLf)
                    strSQL.Append("	   AND (((dbo.IRIS_DET_ATENCION.ATE_DET_V_ID_ESTADO = 6) or (dbo.IRIS_DET_ATENCION.ATE_DET_V_ID_ESTADO = 14)) " & vbLf)
                    strSQL.Append("     OR ((dbo.IRIS_DET_ATENCION.ID_CODIGO_FONASA = 370) or (dbo.IRIS_DET_ATENCION.ID_CODIGO_FONASA = 371)))" & vbLf)
                    strSQL.Append("" & vbLf)
                    strSQL.Append("	   --Procedencias" & vbLf)
    ...
    Function Gen_Table_3_Ger(ByVal ID_PREV As Long, ByVal ID_PROG As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As List(Of E_Ate_Prev_Prog_JSON_Output)
        'Declaraciones internas
        Dim NN_Date As New N_Date_Operat
        Dim Date_01 As Date = NN_Date.strToDate(Split(DATE_str01, "/")(2), Split(DATE_str01, "/")(1), Split(DATE_str01, "/")(0))
        Dim Date_02 As Date = NN_Date.strToDate(Split(DATE_str02, "/")(2), Split(DATE_str02, "/")(1), Split(DATE_str02, "/")(0))
        ...
        'Debug
        Debug.WriteLine(">>>TABLA DE ATENCIONES POR PROCEDENCIA<<<")
        Debug.WriteLine("Inicializar consultas a la Base de Datos.")

        'Realizar consulta inicial
        'Select Case (ID_PROG)
        '    Case 0, "", "null", "0", Nothing
        Data_Search = NN_Search.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENE_PREV_HOLANDA_GER(ID_PREV, Date_01, Date_02)
        ...
        Return Data_OUT
    End Function
    Function Gen_Excel_IST(ByVal MAIN_URL As String, ByVal Group As Integer, ByVal ID_PREV As Long, ByVal ID_PROG As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As String
        'Declaraciones internas
        Dim NN_Date As New N_Date_Operat
        Dim Date_01 As Date = NN_Date.strToDate(Split(DATE_str01, "/")(2), Split(DATE_str01, "/")(1), Split(DATE_str01, "/")(0))
        Dim Date_02 As Date = NN_Date.strToDate(Split(DATE_str02, "/")(2), Split(DATE_str02, "/")(1), Split(DATE_str02, "/")(0))
        ...
        'Realizar consulta inicial
        Data_OUT = Gen_Table_2_IST(ID_PREV, ID_PROG, DATE_str01, DATE_str02)
    ...
    Function Gen_Excel_IST_FIX(ByVal MAIN_URL As String, ByVal Group As Integer, ByVal ID_PREV As Long, ByVal ID_PROG As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As String
        'Declaraciones internas
        Dim NN_Date As New N_Date_Operat
        Dim Date_01 As Date = NN_Date.strToDate(Split(DATE_str01, "/")(2), Split(DATE_str01, "/")(1), Split(DATE_str01, "/")(0))
        Dim Date_02 As Date = NN_Date.strToDate(Split(DATE_str02, "/")(2), Split(DATE_str02, "/")(1), Split(DATE_str02, "/")(0))
