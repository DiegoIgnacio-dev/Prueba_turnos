<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Det_Proc_Prev_Prog_Scr.aspx.vb" Inherits="Presentacion.Det_Proc_Prev_Prog_Scr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <script>
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Det_Proc_Prev_Prog_Scr.aspx/Llenar_DataTable",
                "data": Data_Par,
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "id": "a-right" }, { "class": "textoReducido" }).text("Valor")
                )
            );
                ...
                $("#DataTable tbody").append(
                    $("<tr>", {
                        ...
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text(() => {
                            return moment(Mx_Dtt[i].ATE_FECHA).format("DD-MM-YYYY");
                        }),
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Det_Proc_Prev_Prog_Scr.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_PDF = [
{
    "urls": ""
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Det_Proc_Prev_Prog_Scr.aspx/PDFF",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
    ...
    <div class="card border-bar">
        <div class="card-header bg-bar text-center">
            <h4 class="m-0">Detalle <span id="_desde"></span>al <span id="_hasta"></span>- <span id="_proc"></span>- <span id="_prev"></span>- <span id="_prog"></span></h4>
        </div>
        <div class="card-body">
            <div class="row mb-2 pl-3 pr-3">
                ...
                <div class="col-lg">
                    <h4>Atenciones: <span id="tot_at"></span> - Exámenes: <span id="tot_cf"></span> </h4>
                </div>
                <div class="col-lg-1">
