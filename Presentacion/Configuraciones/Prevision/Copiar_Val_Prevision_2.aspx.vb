Imports Entidades
Imports Negocio
Public Class Copiar_Val_Prevision_2
    ...
    Public Shared Function Update_Precio(ByVal Mx_Pos As List(Of E_IRIS_WEBF_BUSCA_PRECIO_PREVISION_CONVENIO),
        ...
        For Each Item As E_IRIS_WEBF_BUSCA_PRECIO_PREVISION_CONVENIO In LUPre
            ...
            Dim _BONI As Integer = Item.CF_BONIFICACION
            ...
            If data_ver.Count > 0 Then
                Data_UPre = NN_UPre.IRIS_WEBF_UPDATE_PRECIO_FONASA_2_BONIFICACION(_ID_PRE, _AMB, _HOSP, _ID_USU, _Fecha, _ID_ESTADO, ID_PREVE, _ID_CF, ID_ANO, _BONI)

                If Data_UPre = 0 Then
                    data_graba = nn_graba.IRIS_WEBF_GRABA_PRECIOS_FONASA_BONIFICACION(ID_PREVE, _ID_CF, ID_ANO, _ID_USU, _AMB, _BONI)
                End If
            Else
                data_graba = nn_graba.IRIS_WEBF_GRABA_PRECIOS_FONASA_BONIFICACION(ID_PREVE, _ID_CF, ID_ANO, _ID_USU, _AMB, _BONI)
