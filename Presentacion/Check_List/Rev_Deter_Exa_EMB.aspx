<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Rev_Deter_Exa_EMB.aspx.vb" Inherits="Presentacion.Rev_Deter_Exa_EMB" %>
        ...
        var Mx_Ddl = [
{
    ...
    "ID_ESTADO": ""
        ...
        function Call_AJAX_Ddl() {
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB.aspx/Llenar_Ddl_LugarTM",
                //"data": '{}',
        ...
        var Mx_Dtt_previ = [
    {
        ...
        function Ajax_previ() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB.aspx/Llenar_DdL_prevision",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function fn_Req_Prev() {
            ...
            objAJAX_Prev = $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB.aspx/Request_Prevision",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function fn_Req_Prog() {
            ...
            objAJAX_Prog = $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB.aspx/Request_Programa",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function fn_Req_SubP() {
            ...
            objAJAX_SubP = $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB.aspx/Request_SubPrograma",
                "data": objParam,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        var Mx_Exam = [
    {
        ...
        function Ajax_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB.aspx/Llenar_Ddl_Exam",
                "data": JSON.stringify({
                    ID_PREV: $("#Ddl_previ").val()
                }),
                "contentType": "application/json;  charset=utf-8",
        ...
        var Mx_Dtt_Det = [
    {
        ...
        function Ajax_Det() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB.aspx/Llenar_Ddl_Det",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Det_Ate = [
  {
      ...
      "ENCRYPTED_ID": 0
        ...
        function Ajax_DataTable_Det_Ate(ID_ATE) {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB.aspx/Llenar_DataTable_Det_Ate",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        var Mx_Dtt_Excel = [
    {
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Rev_Deter_Exa_EMB.aspx/Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
