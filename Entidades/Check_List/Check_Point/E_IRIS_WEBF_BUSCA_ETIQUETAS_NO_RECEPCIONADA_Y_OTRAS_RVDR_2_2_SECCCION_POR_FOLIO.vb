Public Class E_IRIS_WEBF_BUSCA_ETIQUETAS_NO_RECEPCIONADA_Y_OTRAS_RVDR_2_2_SECCCION_POR_FOLIO
    ...
    Dim EE_PRU_SOLICITADO As String
    Dim EE_ID_LOTE As String
    Dim EE_ID_ESTADO As String
    Dim EE_RECEP_ETI_FECHA As Date
    Dim EE_ID_USUARIO_2 As String
    Dim EE_ENVIO_ETI_FECHA As Date
    Dim EE_ID_USUARIO As String
    Dim EE_USU_ENVIO As String
    Dim EE_USU_RECEP As String
    Dim EE_ID_ENVIO_ETI As String
    Public Property ID_ENVIO_ETI As String
        Get
        ...
        End Set
    End Property
    Public Property USU_RECEP As String
        Get
            Return EE_USU_RECEP
        End Get
        Set(value As String)
        ...
        End Set
    End Property
    Public Property USU_ENVIO As String
        Get
            Return EE_USU_ENVIO
        End Get
        Set(value As String)
    ...
    Public Property ENVIO_ETI_FECHA As Date
        ...
        End Set
    End Property
    Public Property ID_USUARIO_2 As String
        Get
            Return EE_ID_USUARIO_2
        End Get
        Set(value As String)
            EE_ID_USUARIO_2 = value
        End Set
    End Property
    ...
    Public Property ID_ESTADO As String
        ...
        End Set
    End Property
    Public Property ID_LOTE As String
        Get
            Return EE_ID_LOTE
        End Get
        Set(value As String)
