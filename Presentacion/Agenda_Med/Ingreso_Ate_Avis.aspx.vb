...
Public Class Ingreso_Ate_Avis
    ...
    Public Shared Function Guardar_TodoByVal(ByVal RUT_PAC As String,
                                             ...
                                             ByVal CUPO_AGEND As String) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datas As String = ""
        ...
        Else
            ...
            Else
                ...
                Else
                    ...
                    PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW(correlativo,
                                                                             ...
                                                                             Programa,
                                                                             Sector,
                                                                                     ATE_SAYDEX, DIAG1, DIAG2, sub_atencion, vih, 1
                                                                            )
            ...
            If (Paridad = 1) Then
                For x = 0 To ids.Count - 1
                    zz.IRIS_WEBF_HOST_UPDATE_CARGA_AVIS_FOLIO(ids(x).HO_CC, PREINGRESO2_PRO_SEC)
                Next x
            Else
            ...
            id_atencion = ddx.IRIS_WEBF_GRABA_ATENCION_PROGRA2_PRO_SECTOR_AVIS(correlativo2,
                                                                         ...
                                                                         hocc,
                                                                               interno,
                                                                        data_atencion(0).ID_DIAGNOSTICO, data_atencion(0).ID_DIAGNOSTICO2, data_atencion(0).VIH, data_pac(0).DNI, OB, 1)
