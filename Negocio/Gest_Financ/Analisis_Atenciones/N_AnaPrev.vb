...
Public Class N_AnaPrev
    ...
    Function Gen_Excel(ByVal MAIN_URL As String, ByVal Dll As Long, ByVal Año As String) As String
        ...
        End If
    End Function
    Function Gen_Excel_2(ByVal MAIN_URL As String, ByVal Dll As Long, ByVal Año As String, ByVal ID_CF As Integer, ByVal CF_DESC As String, ByVal VALOR As Integer) As String
        'Declaraciones Generales
        ...
        For y = 0 To (date_json_rial.Count - 1)
            ...
            Mx_Data(1, y) = date_json_rial(y).CANT_ATE
            Mx_Data(2, y) = date_json_rial(y).CANT_EXA
            Mx_Data(3, y) = date_json_rial(y).PREVI
            'Mx_Data(2, y) = Data_Lis_Ate(y).ATE_AÑO & " años"
            'Mx_Data(3, y) = Format(Data_Lis_Ate(y).ATE_FECHA, "dd/MM/yyy")
            'Mx_Data(4, y) = Format(Data_Lis_Ate(y).ATE_FECHA, "HH:mm:ss")
            'Mx_Data(5, y) = Data_Lis_Ate(y).PROC_DESC
        ...
        sl.SetCellValue("B2", "Atenciones Totales (Análisis)")
        If (ID_CF = 0) Then
            sl.SetCellValue("B3", "Examen: Todos")
        Else
            sl.SetCellValue("B3", "Examen: " & CF_DESC)
        End If
        sl.SetCellValue("B4", "Año: " & Año)
        'nombre columnas
        sl.SetCellValue("A7", "Mes")
        ...
        End If
    End Function
    Function Gen_Excel_2_PROVEE(ByVal MAIN_URL As String, ByVal Dll As Long, ByVal Año As String, ByVal ID_CF As Integer, ByVal CF_DESC As String) As String
        'Declaraciones Generales
        Dim NN_Date As New N_Date_Operat
        Dim NN_Med As New N_GraficoTM_Todo
        Dim NN_Prev As New N_GraficoPrev
