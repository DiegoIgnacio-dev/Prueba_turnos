<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Resumen_Prev_Prog_Subp_Scr_3.aspx.vb" Inherits="Presentacion.Resumen_Prev_Prog_Subp_Scr_3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph_Body" runat="server">
    <script>
        ...
        function Ajax_LugarTM() {
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp_Scr_3.aspx/Llenar_Ddl_LugarTM",
        ...
        function Ajax_Preve() {
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp_Scr_3.aspx/Llenar_Ddl_Prevision",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    let json_receiver = response.d;
        ...
        function Ajax_Usu() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp_Scr_3.aspx/Call_User_Data",
                //"data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Progra() {
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp_Scr_3.aspx/Llenar_Ddl_Programa",
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
                    let json_receiver = response.d;
        ...
        function Ajax_DataTable() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp_Scr_3.aspx/Llenar_DataTable",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "success": function (response) {
                    let json_receiver = response.d;
        ...
        function Fill_DataTable() {
            ...
            $("#DataTable thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "id": "a-right" }, { "class": "textoReducido " }).text("Descuentos"),
            ...
            Mx_Dtt.forEach(aah=> {
                ...
                descuentossss += parseInt(aah.ATE_V_BENEF);
            });
            ...
            $("#DataTable_Tot thead").append(
                $("<tr>").append(
                    ...
                    $("<th>", { "align": "right" }, { "class": "textoReducido " }).text("Total Descuentos")
                )
            );
                ...
                $("#DataTable_Tot tbody").append(
                    $("<tr>").append(
                        ...
                        $("<td>", { "align": "left" }, { "class": "textoReducido" }).text("$" + addCommas(descuentossss))
                    )
                );
        ...
        function do_Chart_1() {
            ...
            Mx_Dtt.forEach(aah=> {
                ...
                descuentosssssss += parseInt(aah.ATE_V_BENEF);
            });

            let BUUM = parseInt(tota_copa) + parseInt(tota_parti) + parseInt(descuentosssssss);
            ...
            Highcharts.chart('chrt_1', {
                ...
                title: {
                    text: 'Valorización de Exámenes Copago/Particular/Descuentos',
                    margin: 50
                },
                subtitle: {
                ...
                series: [{
                    showInLegend: false,
                    name: 'platita',
                    data: [tota_copa, tota_parti, descuentosssssss]
                }]
            });
        ...
        function Ajax_Excel() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp_Scr_3.aspx/Gen_Excel",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_Excel_by_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp_Scr_3.aspx/Gen_Excel_by_Exam",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": function (response) {
        ...
        function Ajax_PDF_by_Exam() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp_Scr_3.aspx/PDFF_by_Exam",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
        ...
        function Ajax_PDF() {
            ...
            $.ajax({
                "type": "POST",
                "url": "Resumen_Prev_Prog_Subp_Scr_3.aspx/PDFF",
                "data": Data_Par,
                "contentType": "application/json;  charset=utf-8",
                "dataType": "json",
                "success": (resp) => {
    ...
    <div class="card border-bar">
        <div class="card-header bg-bar text-center">
            <h4 class="m-0">Secretaria Resumen Atenciones Caja</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg">
