...
Public Class D_IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4
    Function IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4(ByVal ID_USU As Integer) As List(Of E_IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4)
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4"
        ...
        Return E_Proc_List
    End Function
    Function IRIS_WEBF_CMVM_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_CON_PENDIENTES(ByVal ID_USU As Integer) As List(Of E_IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4)
        'Declaraciones Generales
        Dim CC_ConnBD As Conexion.ConexionBD
        Dim DD_GEN As New D_General_Functions
        'Declaraciones
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_CON_PENDIENTES"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
    ...
    Function IRIS_WEBF_CMVM_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_CON_PENDIENTES_666(ByVal ID_USU As Integer) As List(Of E_IRIS_WEBF_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_ETIQUETAS_RECEP_USUARIOS4____4_CON_PENDIENTES_666"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
