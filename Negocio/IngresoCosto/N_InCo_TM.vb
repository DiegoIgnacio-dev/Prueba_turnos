...
Public Class N_InCo_TM


    'Declaraciones Generales
    Dim DD_Data As D_InCo_TM
    Sub New()
        DD_Data = New D_InCo_TM
    End Sub
    Function IRIS_WEBF_BUSCA_LIS_ADM_LUGAR_TM(ByVal DESDE As String, ByVal HASTA As String, ByVal ID_PROC As Integer) As List(Of E_InCo_TM)

        Dim List_in As New List(Of E_InCo_TM)
        List_in = DD_Data.IRIS_WEBF_BUSCA_LIS_ADM_LUGAR_TM(DESDE, HASTA, ID_PROC)

        Return List_in
    End Function
    Function Gen_Excel(ByVal MAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String, ByVal ID_PROC As Integer, ByVal PROC_DESC As String) As String
        'Declaraciones Generales
        Dim NN_Aten As New N_InCo_TM
        Dim Data_Aten As New List(Of E_InCo_TM)
        Dim Mx_Data(10, 0) As Object
        'Obtener parámetros para la consulta
        'Realizar Consulta
        Data_Aten = NN_Aten.IRIS_WEBF_BUSCA_LIS_ADM_LUGAR_TM(DESDE, HASTA, ID_PROC)
        ...
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Ing vs Cos TM")
        'titulo de la tabla
        sl.SetCellValue("B2", "Ingreso vs Costos por Lugar de Toma de Muestra ")

        sl.SetCellValue("B3", "Procedencia: " & PROC_DESC)
