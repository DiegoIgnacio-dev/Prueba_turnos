...
Imports ASPPDFLib
Public Class REP_LAB_CANT_EXA_CART_MEN
    ...
    Public Shared Function Llenar_DataTable(ByVal DATE_str01 As String, ByVal DATE_str02 As String, ByVal ID_CF As Integer) As String
        ...
        Dim elemento_año_desde() = DATE_str01.Split("~")
        Dim años_desde = elemento_año_desde(2)

        Dim elemento_año_hasta() = DATE_str02.Split("~")
        Dim años_hasta = elemento_año_desde(2)

        Dim elemento_mes_desde() = DATE_str01.Split("~")
        Dim mes_desde = elemento_año_desde(1)

        Dim elemento_mas_hasta() = DATE_str02.Split("~")
        Dim mes_hasta = elemento_año_desde(1)
