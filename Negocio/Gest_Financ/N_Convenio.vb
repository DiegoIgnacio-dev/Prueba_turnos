...
Public Class N_Convenio
    ...
    End Sub
    Function IRIS_WEBF_BUSCA_EXAMENES_SIN_CONVENIO(ByVal ID_PREV As Long, ByVal DATE_01 As String, ByVal DATE_02 As String) As List(Of E_IRIS_WEBF_BUSCA_EXAMENES_SIN_CONVENIO)
    ...
    Function Gen_Xls(ByVal DOMAIN_URL As String, ByVal ID_PREV As Long, ByVal DATE_str01 As String, ByVal DATE_str02 As String) As String
        ...
        'Realizar consulta
        DD_List = NN_List.IRIS_WEBF_BUSCA_EXAMENES_SIN_CONVENIO(ID_PREV, DATE_str01, DATE_str02)
        ...
        Xls.SetCellValue(tablePosRow, tablePosCol_now, "% Centro ($)") : tablePosCol_now += 1
        Xls.SetCellValue(tablePosRow, tablePosCol_now, "%") : tablePosCol_now += 1
        ...
        Dim normalStyle = Xls.CreateStyle()
        normalStyle.Font.Bold = False
        normalStyle.Font.FontSize = 10
        normalStyle.Font.FontName = "Calibri"
        ...
        For y = 0 To Mx_Data.GetUpperBound(1)
            ...
            For x = 0 To Mx_Data.GetUpperBound(0)
                ...
                Xls.SetCellStyle(tablePosRow_now, tablePosCol + x, normalStyle)
            Next x
            'Formato de celdas
        ...
        style_total.Font.FontName = "Calibri"
