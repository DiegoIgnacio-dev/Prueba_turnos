...
Public Class N_Usuario_Sum
    ...
    Function IRIS_WEBF_CMVM_BUSCA_USUARIO2_BOL() As List(Of E_IRIS_WEBF_BUSCA_USUARIO2)
        Return DD_Usuario.IRIS_WEBF_CMVM_BUSCA_USUARIO2_BOL()
    End Function
    Function IRIS_WEBF_BUSCA_USUARIO3() As List(Of E_IRIS_WEBF_BUSCA_USUARIO3)
        Return DD_Usuario.IRIS_WEBF_BUSCA_USUARIO3()
    End Function
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_USUARIO(ByVal ID_USUARIO As Integer, ByVal DATE_01 As Date,
    ...
    End Function
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_USUARIO_2(ByVal ID_USUARIO As Integer, ByVal MES As String,
                                                  ByVal AÑO As String) As _
                                                  List(Of E_IRIS_WEBF_BUSCA_LIS_ADM_RESU_USUARIO)
        Return DD_Usuario.IRIS_WEBF_BUSCA_LIS_ADM_RESU_USUARIO_2(ID_USUARIO, MES, AÑO)
    End Function
