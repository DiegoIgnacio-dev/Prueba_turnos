...
function Call_AJAX_Ddl() {
    ...
    AJAX_Ddl = $.ajax({
        "type": "POST",
        "url": "ValoresCriticos_EMB.aspx/Llenar_Ddl_LugarTM",
        //"data": Data_Par,
...
function fn_Req_Prev() {
    ...
    objAJAX_Prev = $.ajax({
        "type": "POST",
        "url": "ValoresCriticos_EMB.aspx/Request_Prevision",
        "data": objParam,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
...
function Call_Data_Table() {
    ...
    AJAX_Data_Table = $.ajax({
        "type": "POST",
        "url": "ValoresCriticos_EMB.aspx/Call_DataTable",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Call_Export() {
    ...
    AJAX_Data_Table = $.ajax({
        "type": "POST",
        "url": "ValoresCriticos_EMB.aspx/Call_Export",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
