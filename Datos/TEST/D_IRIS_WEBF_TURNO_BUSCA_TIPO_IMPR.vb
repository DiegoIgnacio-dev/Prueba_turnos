...
Public Class D_IRIS_WEBF_TURNO_BUSCA_TIPO_IMPR
    'Declarar la Conexión
    Dim CC_ConnBD As C_ConnBD
    'Declarar una nueva Instancia de General Functions
    Dim DD_GEN As New D_General_Functions
    Function IRIS_WEBF_TURNO_BUSCA_TIPO_IMPR() As List(Of E_IRIS_WEBF_TURNO_BUSCA_TIPO_IMPR) ' Lo mismo que las demas capas
        'Declaraciones
        ...
        'Declaraciones 'lista'
        Dim Item_Retorno As New E_IRIS_WEBF_TURNO_BUSCA_TIPO_IMPR 'Item de Entidad

        Dim Lista_Retorno As New List(Of E_IRIS_WEBF_TURNO_BUSCA_TIPO_IMPR) 'Nueva lista de Entidad
        'Configuración general

        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure 'Tipo Consulta
            .CommandText = "IRIS_WEBF_TURNO_BUSCA_TIPO_IMPR" 'Nombre PA
        ...
        While Obj_Reader.Read
            Item_Retorno = New E_IRIS_WEBF_TURNO_BUSCA_TIPO_IMPR 'Nuevo item de Entidad (Limpiar el anterior)
            ...
            Item_Retorno.TP_ATE_MODULO_DESC = DD_GEN.DB_NULL(Obj_Reader, 1, Nothing)
            Item_Retorno.TP_ATE_IMG = DD_GEN.DB_NULL(Obj_Reader, 2, Nothing)
