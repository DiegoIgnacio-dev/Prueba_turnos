...
Public Class D_IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO
    ...
    Function IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO(ByVal ID_PROC As Integer) As List(Of E_IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO)
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO_3_2"
    ...
    Function IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO_POR_FECHA(ByVal DESDE As Date, ByVal HASTA As Date, ByVal NLOTE As String) As List(Of E_IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO)
        ...
        If NLOTE = "" Then
            With Cmd_SQL
                .CommandType = CommandType.StoredProcedure
                .CommandText = "IRIS_WEBF_CMVM_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO_POR_FECHA_2_2"
                .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
            End With
        ...
        Else
            With Cmd_SQL
                .CommandType = CommandType.StoredProcedure
                .CommandText = "IRIS_WEBF_CMVM_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO_POR_NUM_LOTE_2_2"
                .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
            End With
    ...
    Function IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO_RECEP() As List(Of E_IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO_2_RECEP"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
    ...
    Function IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO_POR_FECHA_RECEP(ByVal DESDE As Date, ByVal HASTA As Date, ByVal NLOTE As String) As List(Of E_IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO)
        ...
        If NLOTE = "" Then
            With Cmd_SQL
                .CommandType = CommandType.StoredProcedure
                .CommandText = "IRIS_WEBF_CMVM_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO_POR_FECHA_2_RECEP"
                .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
            End With
        ...
        Else
            With Cmd_SQL
                .CommandType = CommandType.StoredProcedure
                .CommandText = "IRIS_WEBF_CMVM_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO_POR_NUM_LOTE_2_RECEP"
                .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
            End With
    ...
    Function IRIS_WEBF_BUSCA_IF_UPDATE_LOTE_RECEPCIONADO_ENVIO_POR_RECEP(ByVal NLOTE As String) As List(Of E_IRIS_WEBF_BUSCA_CANTIDAD_LOTE_RECEPCIONADO_ENVIO)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_IF_UPDATE_LOTE_RECEPCIONADO_ENVIO_POR_RECEP"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
