...
<asp:Content ID="Content1" ContentPlaceHolderID="Cph_Head" runat="server">
    ...
    <script>
        ...
        function Ajax_Agendar(NUM, fecha_ac) {
            ...
            //$('#AVIS').attr("onclick", "window.location.href='/Agenda_Med/IN_PAC_SAYDEX.aspx?kl=" + NUM + "&FF=" + fecha_ac + "'");
            $('#eModal').modal('show');
        }
        var Mx_Detalle_ate = {
            "proparra1": [{
    ...
    <script>
        ...
        function llenarmodal() {
            ...
            $("#FNAC").val(moment(Mx_Detalle_ate.proparra1[0].PAC_FNAC).format("DD-MM-YYYY"));
...
<%--                        <div class="col-md-6" style="text-align: center;">
                            <button type="button" id="AVIS" class="btn btn-info" style="height: 120px; width: 75%;"><b>PACIENTE RAYEN</b></button>
                        </div>--%>
                    </div>
                </div>
            </div>
