    ...
    Public Shared Function Excel(ByVal DOMAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String, ByVal ID_TM As Integer, ByVal ID_CF As Integer) As String
        ...
        If (data.Count > 0) Then
            ...
            For y = 0 To (data.Count - 1)
                ...
                Mx_Data(5, y) = Format(CDate(data(y).PAC_FNAC), "dd/MM/yyyy")
                Mx_Data(6, y) = data(y).ATE_AÑO & " " & "Años"
                If (data(y).PAC_RUT = "") Then
                    Mx_Data(7, y) = data(y).PAC_DNI
                Else
                ...
                Mx_Data(12, y) = data(y).DOC_NOMBRE + " " + data(y).DOC_APELLIDO
            Next y
        Else
            Return "null"
        End If
        ...
        sl.SetCellValue("H8", "Rut o D.N.I")
