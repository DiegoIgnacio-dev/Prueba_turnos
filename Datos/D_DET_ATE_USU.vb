...
Public Class D_DET_ATE_USU
    ...
    Function IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR45_6_RENDICION_PREVE(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_CF As Long, ByVal ID_FP As Long, ByVal ID_PREV As Long, ByVal E_DESDE As Long, ByVal E_HASTA As Long, ByVal USU As Long) As List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR45_6_RENDICION_PREVE)
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_ESTADOS_INFORMAR45_6_RENDICION_PREVE"
    ...
    Function IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR45_6_RENDICION(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_CF As Long, ByVal ID_FP As Long, ByVal ID_PREV As Long, ByVal E_DESDE As Long, ByVal E_HASTA As Long, ByVal USU As Long) As List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR45_6_RENDICION_PREVE)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_ESTADOS_INFORMAR45_6_RENDICION"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
    ...
    Function IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR46_RENDICION_PREVE(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_CF As Long, ByVal ID_FP As Long, ByVal ID_PREV As Long, ByVal E_DESDE As Long, ByVal E_HASTA As Long, ByVal USU As Long) As List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR45_6_RENDICION_PREVE)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_ESTADOS_INFORMAR46_RENDICION_PREVE"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
    ...
    Function IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR46_RENDICION(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_CF As Long, ByVal ID_FP As Long, ByVal ID_PREV As Long, ByVal E_DESDE As Long, ByVal E_HASTA As Long, ByVal USU As Long) As List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR45_6_RENDICION_PREVE)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_EST_ESTADOS_INFORMAR46_RENDICION"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
    ...
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_FORMA_PAGO_LTM(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_FP As Long, ByVal USU As Long) As List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR45_6_RENDICION_PREVE)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_LIS_ADM_RESU_FORMA_PAGO_LTM"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@DESDE", OleDbType.Date).Value = DESDE
            .Add("@HASTA", OleDbType.Date).Value = HASTA
            .Add("@ID_TP_PAGO", OleDbType.Numeric).Value = ID_FP
            .Add("@ID_USUARIO", OleDbType.Numeric).Value = USU
        End With
        'Conectar con la Base de Datos
        Select Case CC_ConnBD.Oledbconexion.State
            Case ConnectionState.Open
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.TP_PAGO_DESC = DD_GEN.DB_NULL(Obj_Reader, 6, Nothing)
            E_Proc_Item.ID_TP_PAGO = DD_GEN.DB_NULL(Obj_Reader, 7, Nothing)
    ...
    Function IRIS_WEBF_BUSCA_LIS_ADM_RESU_FORMA_PAGO_LTM_PREVE(ByVal DESDE As Date, ByVal HASTA As Date, ByVal ID_FP As Long, ByVal USU As Long) As List(Of E_IRIS_WEBF_BUSCA_EST_ESTADOS_INFORMAR45_6_RENDICION_PREVE)
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_BUSCA_LIS_ADM_RESU_FORMA_PAGO_LTM_PREVE"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            .Add("@DESDE", OleDbType.Date).Value = DESDE
            .Add("@HASTA", OleDbType.Date).Value = HASTA
            .Add("@ID_PREVE", OleDbType.Numeric).Value = ID_FP
            .Add("@ID_USUARIO", OleDbType.Numeric).Value = USU
        End With
        'Conectar con la Base de Datos
        Select Case CC_ConnBD.Oledbconexion.State
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.TP_PAGO_DESC = DD_GEN.DB_NULL(Obj_Reader, 6, Nothing)
            E_Proc_Item.ID_TP_PAGO = DD_GEN.DB_NULL(Obj_Reader, 7, Nothing)
            E_Proc_Item.PREVE_DESC = DD_GEN.DB_NULL(Obj_Reader, 8, Nothing)
            E_Proc_Item.USU_NIC = DD_GEN.DB_NULL(Obj_Reader, 9, Nothing)
            'Agregar items a la lista
            E_Proc_List.Add(E_Proc_Item)
        End While
        CC_ConnBD.Oledbconexion.Close()
