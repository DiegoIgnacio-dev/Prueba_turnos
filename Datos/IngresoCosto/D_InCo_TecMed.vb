...
Public Class D_InCO_TecMed
    Function IRIS_WEBF_BUSCA_LIS_ADM_TECMED(ByVal DESDE As String, ByVal HASTA As String, ByVal ID_USUARIO As Integer) As List(Of E_InCO_TecMed)
        ...
        Dim Obj_Read_Dt As E_InCO_TecMed
        Dim List_Reader As New List(Of E_InCO_TecMed)
        Dim Reader_Comm As OleDbDataReader
        Dim DD_GEN As New D_General_Functions
        'definiendo tipo de consulta a la BD
        Cmd_command.CommandType = CommandType.StoredProcedure
        Cmd_command.CommandText = "IRIS_WEBF_BUSCA_LIS_ADM_TECMED"
        ...
        While Reader_Comm.Read
            ...
            Obj_Read_Dt.USU_NOMBRE = DD_GEN.DB_NULL(Reader_Comm, 13, Nothing)
            Obj_Read_Dt.USU_APELLIDO = DD_GEN.DB_NULL(Reader_Comm, 14, Nothing)
