Imports Entidades
Imports Negocio
Public Class Resumen_Prev_Prog_Subp_Scr_3
    ...
    Public Shared Function Llenar_DataTable(ByVal DESDE As String,
        ...
        Data_DTT = NN_DTT.IRIS_WEBF_BUSCA_RESUMEN_PREVE_PROG_SUBP_278_2_SCR_2_DUAL_COPAGO_DUAL_PARTICULAR_DESCUENTOS(DESDE, HASTA, PROC, PREV, 0, 0, ID_USER)
