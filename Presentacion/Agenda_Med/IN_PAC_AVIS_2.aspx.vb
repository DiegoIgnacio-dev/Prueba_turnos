            ...
            Else
                ...
                Else
                    ...
                    PREINGRESO2_PRO_SEC = cc.IRIS_WEBF_GRABA_PREINGRESO3_PRO_SEC_AVIS_NEW(correlativo,
                                                                                 ...
                                                                                 Sector, ATE_SAYDEX, DIAG1, DIAG2, sub_atencion, vih,
                                                                                xHora)
                    Rpaciente = vv.IRIS_WEBF_UPDATE_PACIENTE_ATENCION(data_paciente(0).ID_PACIENTE, RUT_PAC, NOMBRE_PAC.ToUpper, APE_PAC.ToUpper, CDate(FNAC_PAC), ID_SEXO, ID_NACIONALIDAD, FONO1, MOVIL1, ID_CIU_COM, DIR_PAC.ToUpper, EMAIL_PAC, 1, OB.ToUpper, 1)
                End If
