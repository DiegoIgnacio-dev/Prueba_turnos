...
function ddl_Change_onTable(index, idcodfona, idtppago) {
    ...
    if (Mx_Dtt_examcof.length == 0) {
        ...
        else if (fuck2 == 18 || fuck2 == 5 || fuck2 == 2 || fuck2 == 19 || fuck2 == 19 || fuck2 == 6) {
            for (i = 0; i < Mx_Dtt_examcof.length; i++) {
                for (x = 0; x < Mx_Dtt_Resp_valAmbulatorio.length; x++) {
...
$(document).ready(function () {
    ...
    $("input[name=inlineMaterialRadiosExample]").change(function () {
        ...
        if (Mx_Dtt_examcof.length == 0) {
            ...
            } else if (fuck == 18 || fuck == 5 || fuck == 2 || fuck == 19 || fuck == 6) {
                for (i = 0; i < Mx_Dtt_examcof.length; i++) {
...
function Ajax_guardar() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol.aspx/Guardar_TodoByVal",
        //"url": "Ingreso_Ate_Caja4_Bol.aspx/TEST_GUARDAR",  
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen02() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol.aspx/Llenar_tabla_exam2",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen02_Particular() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol.aspx/Llenar_tabla_exam2_particular",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3_preve(xxid_preve, select_id_3, Xid_cod_01, pos_01) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol.aspx/Llenar_tabla_exam",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3(cod_fonasa, id, cod, txis) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol.aspx/IRIS_WEBF_CMVM_BUSCA_ATENCION_CODIGO_FONASA_NO_ESTADO_AGENDA_BONIFICACION",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3_Desc(cod_fonasa, id, cod, txis) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol.aspx/IRIS_WEBF_CMVM_BUSCA_ATENCION_CODIGO_FONASA_NO_ESTADO_AGENDA_DESC",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Ajax_DataTable_examen3_PACK(cod_fonasa_2, id_2, cod_2, txis_2) {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol.aspx/Llenar_tabla_exam_pack",
        "data": Data_Par,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function Call_AJAX_Ddl() {
    ...
    $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol.aspx/IRIS_WEBF_CMVM_BUSCA_PROCEDENCIA_ACTIVO_BY_REL_USU_PROC_TABLE",
        //"data": '{}',
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": function (response) {
...
function fn_Req_Pago() {
    objAJAX_Prev = $.ajax({
        "type": "POST",
        "url": "Ingreso_Ate_Caja4_Bol.aspx/tipo_pago",          //"2do PA, que excluye el Tp pago efecto, y mantiene "particular"
        //"data": objParam,
        "contentType": "application/json;  charset=utf-8",
        "dataType": "json",
        "success": (resp) => {
