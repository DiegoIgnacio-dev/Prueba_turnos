...
Public Class D_IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP
    Function IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP(ByVal NUM_ATE As String, ByVal CB As String) As List(Of E_IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP)
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP"
    ...
    Function IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP_2(ByVal NUM_ATE As String, ByVal CB As String) As List(Of E_IRIS_WEBF_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP)
        'Declaraciones Generales
        Dim CC_ConnBD As Conexion.ConexionBD
        Dim DD_GEN As New D_General_Functions
        'Declaraciones
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_BUSCA_ETIQUETA_BARRA_PACIENTE_RECEP_2"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.ATE_EST_RECEP = DD_GEN.DB_NULL(Obj_Reader, 10, Nothing)
            E_Proc_Item.ID_ATENCION = DD_GEN.DB_NULL(Obj_Reader, 11, Nothing)
            E_Proc_Item.ATE_RES_ID_ESTADO = DD_GEN.DB_NULL(Obj_Reader, 12, Nothing)
