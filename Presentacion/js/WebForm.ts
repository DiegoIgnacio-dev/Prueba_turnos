...
namespace WEBFORM {
    ...
    export class class_Button {
        //Propiedades
        public id: string
        private bol_active: boolean = true
        ...
        */
        ...
        get active() {
            return this.bol_active
        }
        set active(value: boolean) {
            this.bol_active = value
        }
    ...
    export class class_Input {
        ...
        private click_number() {
            $(document).ready(() => {
                ...
                let fn_Length = (Me: JQueryEventObject) => {
                    if (this.numeric.value == true) {
                ...
                $(`#${this.id}`).keypress((Me: JQueryEventObject) => {
                    //if (Me.which == 13) {
                    fn_Length(Me)
                    //}
                })
                $(`#${this.id}`).focusout(fn_Length)
            })
        }
...
namespace TOOL {
    ...
    export class class_AJAX {
         ...
         */
        public requestNow(param?: Object, callback?: () => void) {
            if (param != null) {
