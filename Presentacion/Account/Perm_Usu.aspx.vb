...
Public Class Perm_Usu
    ...
    Public Shared Function IRIS_WEBF_GRABA_USUARIO(ByVal USU_RUT As String,
                                                   ...
                                                   ByVal ID_EST_USU As Integer,
                                                    ...
                                                    ByVal USU_ID_PROC As Integer) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        ...
        Usu_Creado = NN_LugarTM.IRIS_WEBF_GRABA_USUARIO(USU_RUT, NOMBRE_USU, APE_USU, CDate(FNAC_USU), DIR_USU, EMAIL_USU, ID_EST_USU, ID_CIU_COM, ID_PRO_USU, ID_CAR_USU, USUARIO, PASS, FONO, MOVIL, USU_ADMIN, USU_ID_PROC)
