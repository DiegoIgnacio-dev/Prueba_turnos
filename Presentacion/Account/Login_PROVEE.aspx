<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login_PROVEE.aspx.vb" Inherits="Presentacion.Login_PROVEE" %>
...
<%--            <div class="col-md-4 text-center">
            ...
            <div class="col-md-8 text-center centerx">
                <img src="../Imagenes/00_logo_holanda_full.png" style="height: auto; max-width: 270px;" class="img-fluid" alt="Responsive image" />
            </div>
        </div>
        <div class="container">
            <div class="card card-login mx-auto mt-3 border-bar">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <button id="Btn_Login" type="button" class="btn btn-block btn-info"> <i class="fa fa-sign-in fa-fw"></i>Ingresar</button>
                    </form>
                    <!--
    ...
    <script src="/Account/Login_PROVEE.js"></script>
