...
Public Class D_IRIS_WEBF_HOST_BUSCA_CODIGO_FONSA_POR_COD_AVIS
    ...
    Function IRIS_WEBF_HOST_BUSCA_CODIGO_FONSA_POR_COD_AVIS(ByVal HOST As String) As List(Of E_IRIS_WEBF_HOST_BUSCA_CODIGO_FONSA_POR_COD_AVIS)
        ...
        With Cmd_SQL
            ...
            .CommandText = "IRIS_WEBF_CMVM_HOST_BUSCA_CODIGO_FONSA_POR_COD_AVIS"
    ...
    Function IRIS_WEBF_HOST_BUSCA_CODIGO_FONSA_POR_COD_OMI(ByVal HOST As String) As List(Of E_IRIS_WEBF_HOST_BUSCA_CODIGO_FONSA_POR_COD_AVIS)
        'Declaraciones
        CC_ConnBD = New Conexion.ConexionBD
        Dim Cmd_SQL As New OleDb.OleDbCommand
        CC_ConnBD = New Conexion.ConexionBD
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_HOST_BUSCA_CODIGO_FONSA_POR_COD_OMI"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
    ...
    Function IRIS_WEBF_HOST_BUSCA_CODIGO_FONSA_POR_COD_OMI_PER(ByVal HOST As String) As List(Of E_IRIS_WEBF_HOST_BUSCA_CODIGO_FONSA_POR_COD_AVIS)
        ...
        Return E_Proc_List
    End Function
    Function IRIS_WEBF_HOST_BUSCA_CODIGO_FONSA_POR_COD_SAYDEX_2(ByVal HOST As String, ByVal ANO As String, ByVal ID_PREVE As Integer) As List(Of E_IRIS_WEBF_HOST_BUSCA_CODIGO_FONSA_POR_COD_AVIS)
        'Declaraciones
        CC_ConnBD = New Conexion.ConexionBD
        Dim Cmd_SQL As New OleDb.OleDbCommand
        CC_ConnBD = New Conexion.ConexionBD
        ...
        With Cmd_SQL
            .CommandType = CommandType.StoredProcedure
            .CommandText = "IRIS_WEBF_CMVM_HOST_BUSCA_CODIGO_FONSA_POR_COD_SAYDEX_2_NEW"
            .Connection = CC_ConnBD.Connect_to_IrisLab_LoBarnechea
        End With
        'Enviar parámetros
        With Cmd_SQL.Parameters
            ...
            .Add("@ID_PREVI", OleDbType.Numeric).Value = ID_PREVE
        End With
        'Conectar con la Base de Datos
        Select Case CC_ConnBD.Oledbconexion.State
            Case ConnectionState.Open
        ...
        While Obj_Reader.Read
            ...
            E_Proc_Item.CF_AVIS = DD_GEN.DB_NULL(Obj_Reader, 4, Nothing)
            E_Proc_Item.CF_DIAS = DD_GEN.DB_NULL(Obj_Reader, 5, Nothing)
            E_Proc_Item.CF_PRECIO_AMB = DD_GEN.DB_NULL(Obj_Reader, 6, Nothing)
            E_Proc_Item.CF_PRECIO_HOS = DD_GEN.DB_NULL(Obj_Reader, 7, Nothing)
