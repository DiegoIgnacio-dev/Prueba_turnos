...
Public Class REP_LAB_CANT_MINDS_EXA_TOT
    ...
    Public Shared Function Llenar_DataTable(ByVal ID_CODIGO_FONASA As Long, ByVal DATE_str01 As String,
                                                                      ByVal DATE_str02 As String, ByVal PROCEDENCIA As Integer, ByVal VALOR As Integer) As String
        'Declaraciones del Serializador
        Dim Serializer As New JavaScriptSerializer
        Dim str_Builder As New StringBuilder
        Dim datos As String = ""
        ...
        If (VALOR = 0) Then
            Data_Prev = NN_Exam.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS(ID_CODIGO_FONASA, Date_01, Date_02, PROCEDENCIA)

        ElseIf VALOR = 1 Then
            Data_Prev = NN_Exam.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_VALIDADOS_REVISADOS(ID_CODIGO_FONASA, Date_01, Date_02, PROCEDENCIA)
        ElseIf VALOR = 2 Then
            Data_Prev = NN_Exam.IRIS_WEBF_CMVM_BUSCA_LIS_ADM_RESU_CANT_EXAMENES_MINDS_TODOS(ID_CODIGO_FONASA, Date_01, Date_02, PROCEDENCIA)
        End If
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function Gen_Excel(ByVal DOMAIN_URL As String, ByVal DATE_str01 As String, ByVal DATE_str02 As String, ByVal ID_CODIGO_FONASA As Long, ByVal PROCEDENCIA As Integer, ByVal VALOR As Integer) As String
        Dim NN_Exam As New N_REP_LAB_CANT_EXA_TOT
        Return NN_Exam.Gen_Excel_Minds(DOMAIN_URL, ID_CODIGO_FONASA, DATE_str01, DATE_str02, PROCEDENCIA, VALOR)
    End Function
