...
Public Class Ingreso_Ate_Caja5
    ...
    Public Shared Function VtaBonInterfaz(ByVal CodUsuario As String,
                                   ...
                                   ByVal S_Id_User As Integer,
                                    ...
                                    ByVal ID_PREVISION As Integer) As VtaBonInterfaz.VtaBonInterfazResponse
        ...
        Try
            ...
            loguito = NN_IMED_LOG.IRIS_WEBF_CMVM_GRABA_LOG_IMED_VTABONINTERFAZ(S_Id_User, ID_PROCEDENCIA, ID_PREVISION, RutBenef, "SE INICIA SOLICITUD DE BONO - CodAuditoria: " & VtaBonInt.CodAuditoria & " - CodError: " & VtaBonInt.CodError & " - Gloerror: " & VtaBonInt.GloError & " - NumTransac: " & VtaBonInt.NumTransac)
            Return VtaBonInt
            'Return "ok"
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function VerResulEmi(ByVal CodUsuario As String,
                                       ByVal CodClave As String,
                                       ByVal NumTransac As Integer,
                                       ByVal CodAuditoria As String,
                                       ByVal Browser As String) As VerResulEmi.VerResulEmiResponse
        'Declaraciones
        Dim Request As HttpWebRequest
        Dim DataStream As Stream
        Dim SoapByte() As Byte
        ...
        Dim envio As String = ""
        envio = "http://186.67.178.5:9997/transaccion.aspx?NumTransac=" & NumTransac & "&NroAuditoria=" & CodAuditoria & ""
        'envio = "http://interfaz4pre.bonoelectronico.cl/transaccion.aspx?NumTransac=" & NumAuditoria & "&NroAuditoria=" & CodAuditoriaRESP & ""
        'envio = "http://interfaz4pre.bonoelectronico.cl/login.php?NumTransac=" & NumAuditoria & "&NroAuditoria=" & CodAuditoriaRESP & ""

        'System.Diagnostics.Process.Start("IExplore.exe", envio)
        System.Diagnostics.Process.Start(Browser, envio)
    ...
    End Function
    <Services.WebMethod()>
    Public Shared Function ObtBonInterfaz(ByVal CodUsuario As String,
                                          ByVal CodClave As String,
                                          ByVal NumTransac As Integer,
                                          ByVal CodAuditoria As String,
                                          ByVal S_Id_User As Integer,
                                        ByVal ID_PROCEDENCIA As Integer,
                                        ByVal ID_PREVISION As Integer) As ObtBonInterfaz.ObtBonInterfazResponse
        'Declaraciones
        Dim Request As HttpWebRequest
        Dim DataStream As Stream
        Dim SoapByte() As Byte
        ...
        Dim envio As String = ""
        Dim NumAuditoria As String = NumTransac
        Dim CodAuditoriaRESP As String = CodAuditoria
        ...
        'envio = "http://186.67.178.5:9997/transaccion.aspx?NumTransac=" & NumAuditoria & "&NroAuditoria=" & CodAuditoriaRESP & ""
        ''envio = "http://interfaz4pre.bonoelectronico.cl/transaccion.aspx?NumTransac=" & NumAuditoria & "&NroAuditoria=" & CodAuditoriaRESP & ""
        ''envio = "http://interfaz4pre.bonoelectronico.cl/login.php?NumTransac=" & NumAuditoria & "&NroAuditoria=" & CodAuditoriaRESP & ""
            ...
            If (ObtBon.CodError = 0) Then
                For i = 0 To ObtBon.ListaBonos.Count - 1
                    If (i = 0) Then
                        ...
                        est_bon = NN_IMED_LOG.IRIS_WEBF_CMVM_ESTADO_BONO_IMED(S_Id_User, "BONO EMITIDO: " & ObtBon.ListaBonos(0).FolioBono, ObtBon.ListaBonos(i).FolioBono)
                    Else
                        If (ObtBon.ListaBonos(i).FolioBono <> ObtBon.ListaBonos(i - 1).FolioBono) Then
                            FOLIO_BONOS += "," & ObtBon.ListaBonos(i).FolioBono
                            est_bon = NN_IMED_LOG.IRIS_WEBF_CMVM_ESTADO_BONO_IMED(S_Id_User, "BONO EMITIDO: " & ObtBon.ListaBonos(i).FolioBono, ObtBon.ListaBonos(i).FolioBono)
                        End If
    ...
    Public Shared Function Llenar_tabla_exam2(ByVal ID_PREVE As Integer, ByVal Fecha As String) As String
        ...
        data_paciente = NN.IRIS_WEBF_CMVM_BUSCA_CODIGO_FONASA_PARA_CARGA_ATENCION_HOMO_IMED(Format(ANO, "yyyy"), ID_PREVE)
        If (data_paciente.Count > 0) Then
            'Serializar con JSON
            Serializer.MaxJsonLength = 999999999
            Serializer.Serialize(data_paciente, str_Builder)
    ...
    Public Shared Function Guardar_TodoByVal(ByVal RUT_PAC As String,
                                            ...
                                            ByVal ATE_V_SEG_COMP As String,                     '9  SEGURO COMPLEMENTARIO
                                             ...
                                             ByVal GLOBAL_BONO_NUM As String) As String
        ...
        Else
            ...
            id_atencion = ddx.IRIS_WEBF_CMVM_GRABA_ATENCION_PROGRA2_PRO_SECTOR_AVIS_3_NEW_CAJA_MAS_SC_MAS_BONOS_IMED(correlativo2,
