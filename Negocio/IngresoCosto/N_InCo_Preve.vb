...
Public Class N_InCo_Preve


    'Declaraciones Generales
    Dim DD_Data As D_InCo_Preve
    Sub New()
        DD_Data = New D_InCo_Preve
    End Sub
    Function IRIS_WEBF_BUSCA_LIS_ADM_PREVE(ByVal DESDE As String, ByVal HASTA As String, ByVal ID_PREVE As Integer) As List(Of E_InCo_Preve)
        ...
        Dim List_in As New List(Of E_InCo_Preve)
        List_in = DD_Data.IRIS_WEBF_BUSCA_LIS_ADM_PREVE(DESDE, HASTA, ID_PREVE)

        Return List_in
    End Function
    Function Gen_Excel(ByVal MAIN_URL As String, ByVal DESDE As String, ByVal HASTA As String, ByVal ID_PREVE As Integer, ByVal PREVE_DESC As String) As String
        'Declaraciones Generales
        Dim NN_Aten As New N_InCo_Preve
        Dim Data_Aten As New List(Of E_InCo_Preve)
        Dim Mx_Data(10, 0) As Object
        'Obtener parámetros para la consulta
        'Realizar Consulta
        Data_Aten = NN_Aten.IRIS_WEBF_BUSCA_LIS_ADM_PREVE(DESDE, HASTA, ID_PREVE)
        ...
        'nombrar hoja 
        sl.RenameWorksheet("Sheet1", "Ing vs Cos Prev")
        'titulo de la tabla
        sl.SetCellValue("B2", "Ingreso vs Costos por Previsión ")
